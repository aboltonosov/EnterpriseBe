...
Процедура СуммаПриИзменении(Элемент)
	...
	ТекущаяСтрока.СуммаПредставления = РасчитатьСуммуПредставления(ТекущаяСтрока.Сумма, ТекущаяСтрока.Период);
...
Процедура ПолучитьСостояниеОтраженияДокумента()
	...
	Элементы.РучнаяКорректировкаПроводок.Видимость = Истина;
