...
Функция СписокСсылокПоВыбраннымСтрокамДинамическогоСписка(ВыделенныеСтрокиСписка, ДинамическийСписокФормы)
	...
	Группировка = ФинансоваяОтчетностьСервер.НоваяГруппировка(КомпоновщикНастроек.Настройки.Структура, "Ссылка");
	ФинансоваяОтчетностьСервер.НовоеПолеГруппировки(Группировка, "ВариантРаспределенияРасходов");
	ФинансоваяОтчетностьСервер.НовоеПолеГруппировки(Группировка, "ВидДеятельностиДляНалоговогоУчетаЗатрат");
	...
	// Если СтатьяРасходов имеет варианты распределения "На внеоборотные активы", "На себестоимость товаров" или относится к ЕНВД, то значение реквизита признания изменять нельзя.
	...
	Для каждого СтрокаИзменяемогоОбъекта из ТаблицаИзменяемыхОбъектов Цикл
		Если СтрокаИзменяемогоОбъекта.ВариантРаспределенияРасходов = Перечисления.ВариантыРаспределенияРасходов.НаВнеоборотныеАктивы
			ИЛИ СтрокаИзменяемогоОбъекта.ВариантРаспределенияРасходов = Перечисления.ВариантыРаспределенияРасходов.НаСебестоимостьТоваров
