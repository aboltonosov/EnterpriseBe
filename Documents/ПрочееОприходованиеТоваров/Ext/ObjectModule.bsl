...
Процедура СообщитьОбОшибкахЗаполненияВидовЗапасов(ТаблицаОшибок, МенеджерВременныхТаблиц, Отказ)
	...
	Если ТаблицаОшибок.Количество() > 0 Тогда
		...
		ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Сторнирование превышает остаток списанного товара организации %1 на складе %2'"),
			Организация,
			Склад);
...
Функция ВременныеТаблицыДанныхДокумента() Экспорт
	...
	|		Справочник.ВидыЗапасов КАК ВидыЗапасов
	|	ПО
	|		ЗаказДавальца.Партнер = ВидыЗапасов.Комитент
	|		И ЗаказДавальца.Контрагент = ВидыЗапасов.Контрагент
