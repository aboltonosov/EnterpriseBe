...
Процедура ПриКопировании(ОбъектКопирования)
	...
	Если ЗначениеЗаполнено(ОбъектКопирования.СрокДействия) Тогда
		...
		Если ЗначениеЗаполнено(ОсновнойКалендарьПредприятия) Тогда
			ДатаОкончанияДействия = КалендарныеГрафики.ДатаПоКалендарю(ОсновнойКалендарьПредприятия, ТекущаяДата(), ОбъектКопирования.СрокДействия, Ложь);
		Иначе
...
Процедура ИнициализироватьДокумент(ДанныеЗаполнения = Неопределено)
	...
	Если Не ЗначениеЗаполнено(СрокДействия) Тогда
		...
		Если ЗначениеЗаполнено(ОсновнойКалендарьПредприятия) Тогда
			Попытка
				ДатаОкончанияДействия = КалендарныеГрафики.ДатаПоКалендарю(ОсновнойКалендарьПредприятия,  ТекущаяДата(), СрокДействия);
			Исключение
	...
	Если Выборка.Следующий() Тогда
		...
		Если ВыборкаПоРасчетам.Следующий() Тогда
			...
			Коэффициенты = РаботаСКурсамивалютУТ.ПолучитьКоэффициентыПересчетаВалюты(ДанныеЗаполнения.Валюта,
				ВыборкаПоРасчетам.ВалютаВзаиморасчетов, ТекущаяДата());
