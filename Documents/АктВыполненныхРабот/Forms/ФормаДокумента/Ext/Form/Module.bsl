...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// {
	СкидкиНаценкиВызовСервера.ПриСозданииФормыДокументаАктВыполненныхРаботФормаДокумента(ЭтаФорма);
	// }
	// 4D
...
Процедура УслугиВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	// 4D:ERP для Беларуси, Екатерина, 18.04.2016 13:22:33 
	// Расчет скидки к цене, №10910
	// {
	ИначеЕсли Поле = Элементы.УслугиЦена ИЛИ Поле = Элементы.УслугиЦенаСоСкидкой Тогда
	// }
	// 4D
...
// 4D:ERP для Беларуси, Екатерина, 12.04.2016 16:43:52 
// Расчет скидки к цене, №10910
// {
&НаКлиенте
Процедура УслугиЦенаСоСкидкойПриИзменении(Элемент)
