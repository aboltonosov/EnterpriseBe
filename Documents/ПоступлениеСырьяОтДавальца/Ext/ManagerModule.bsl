...
Процедура УстановитьПараметрыЗапросаКоэффициентыВалют(Запрос)
	...
	// 4D:ERP для Беларуси, Михаил, 28.02.2018 11:05:56 
	// При проведении документа Поступление сырья от давальца в регистр накопления СебестоимостьТоваров в ресурс СтоимостьЗабалансовая пишется сумма не в валюте упр. учета, № 18091
	// {
...
Функция ТекстЗапросаВтТаблицаТовары(Запрос, ТекстыЗапроса)
	...
	// При проведении документа Поступление сырья от давальца в регистр накопления СебестоимостьТоваров в ресурс СтоимостьЗабалансовая пишется сумма не в валюте упр. учета, № 18091
	// {
	|	ТаблицаТовары.Сумма * &КоэффициентПересчетаВВалютуУПР КАК СуммаУпр,	 	
	// }
	// 4D
	|
	|	ВЫБОР
