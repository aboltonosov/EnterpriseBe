...
Процедура РазделУчетаПриИзменении(Элемент)
	...
	Элементы.РасчетыПоРеализацииЗаполнитьПоОстаткам.Видимость = НачОстаткиРеглУчета;
	Элементы.РасчетыПоАвансамЗаполнитьПоОстаткам.Видимость = НачОстаткиРеглУчета;
