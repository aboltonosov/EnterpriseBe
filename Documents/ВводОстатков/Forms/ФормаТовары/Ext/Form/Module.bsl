...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// 4D:ERP для Беларуси, Петр, 16.02.2018 16:26:03 
	// Механизм ввода остатков, № 17856
	// {
	КоэффициентПересчетаИзВалютыРеглВУпр = КоэффициентПересчета(ВалютаРегламентированногоУчета, ВалютаУправленческогоУчета, Объект.Дата);
	// }
	// 4D
...
&НаКлиенте
Процедура СобственныеТоварыРазделУчетаПриИзменении(Элемент)
	Элементы.СобственныеТоварыЗаполнитьПоОстаткам.Видимость = 
...
Процедура СобственныеТоварыСуммаРеглПриИзменении(Элемент)
	...
	// 4D:ERP для Беларуси, Петр, 16.02.2018 14:32:47 
	// Механизм ввода остатков, № 17856
	// {
	СуммаРеглПриИзменении()
	// }
	// 4D
	
КонецПроцедуры

// 4D:ERP для Беларуси, Петр, 16.02.2018 11:09:00 
// Добавление выбора валюты, № 17834
// {
&НаКлиенте
Процедура СобственныеТоварыЦенаРеглПриИзменении(Элемент)
	
	ЦенаРеглПриИзменении();
...
&НаКлиенте
Процедура ПринятаяТараРазделУчетаПриИзменении(Элемент)
	Элементы.ПринятаяТараЗаполнитьПоОстаткам.Видимость = 
			Объект.РазделУчета = ПредопределенноеЗначение("Перечисление.РазделыВводаНачальныхОстатков.РегламентированныйУчет");
КонецПроцедуры
...
// 4D:ERP для Беларуси, Петр, 20.02.2018 15:22:47 
// Механизм ввода остатков, № 17856
// {
&НаКлиенте
Процедура ПринятаяТараЦенаРеглПриИзменении(Элемент)
	
	ВозвратнаяТараЦенаРеглПриИзменении(Элементы.ПринятаяТара);
	
КонецПроцедуры

&НаКлиенте
Процедура ПринятаяТараСуммаРеглПриИзменении(Элемент)
	
	ВозвратнаяТараСуммаРеглПриИзменении(Элементы.ПринятаяТара);
...
&НаКлиенте
Процедура ПереданнаяТараРазделУчетаПриИзменении(Элемент)
	Элементы.ПереданнаяТараЗаполнитьПоОстаткам.Видимость = 
		Объект.РазделУчета = ПредопределенноеЗначение("Перечисление.РазделыВводаНачальныхОстатков.РегламентированныйУчет");
КонецПроцедуры
...
// 4D:ERP для Беларуси, Петр, 20.02.2018 15:57:11 
// Механизм ввода остатков, № 17856
// {
&НаКлиенте
Процедура ПереданнаяТараЦенаРеглПриИзменении(Элемент)
	
	ВозвратнаяТараЦенаРеглПриИзменении(Элементы.ПереданнаяТара);
	
КонецПроцедуры

&НаКлиенте
Процедура ПереданнаяТараСуммаРеглПриИзменении(Элемент)
	
	ВозвратнаяТараСуммаРеглПриИзменении(Элементы.ПереданнаяТара);
...
&НаКлиенте
Процедура ПолученныеНаКомиссиюРазделУчетаПриИзменении(Элемент)
	Элементы.ПолученныеНаКомиссиюЗаполнитьПоОстаткам.Видимость = 
			Объект.РазделУчета = ПредопределенноеЗначение("Перечисление.РазделыВводаНачальныхОстатков.РегламентированныйУчет");
КонецПроцедуры
...
// 4D:ERP для Беларуси, Петр, 20.02.2018 13:02:32 
// Механизм ввода остатков, № 17856
// {
&НаКлиенте
Процедура ПолученныеНаКомиссиюЦенаРеглПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПолученныеНаКомиссиюСуммаРеглПриИзменении(Элемент)
...
Процедура ПолученныеНаКомиссиюКоличествоУпаковокПриИзменении(Элемент)
	...
	// 4D:ERP для Беларуси, Петр, 20.02.2018 12:43:34 
	// Механизм ввода остатков, № 17856
	// {
	СтруктураДействий.Вставить("ПересчитатьСуммуРеглПоЦенеРегл");
	
	Если НЕ (ЭтоОстаткиПринятойТары ИЛИ ЭтоОстаткиПереданнойТары) Тогда
		СтруктураДействий.Вставить("ПересчитатьСуммуНДСРегл", СтруктураПересчетаСуммы);
	КонецЕсли;
	
	СтруктураДействий.Вставить("ПересчитатьСуммуРеглБезНДС", СтруктураПересчетаСуммы);
...
Процедура ПолученныеНаКомиссиюУпаковкаПриИзменении(Элемент)
	...
	// 4D:ERP для Беларуси, Петр, 20.02.2018 12:44:33 
	// Механизм ввода остатков, № 17856
	// {
	СтруктураДействий.Вставить("ПересчитатьСуммуРеглПоЦенеРегл");
...
&НаКлиенте
Процедура ПереданныеНаКомиссиюРазделУчетаПриИзменении(Элемент)
	Элементы.ПереданныеНаКомиссиюЗаполнитьПоОстаткам.Видимость = 
			Объект.РазделУчета = ПредопределенноеЗначение("Перечисление.РазделыВводаНачальныхОстатков.РегламентированныйУчет");
КонецПроцедуры
...
// 4D:ERP для Беларуси, Петр, 20.02.2018 15:18:02 
// Механизм ввода остатков, № 17856
// {
&НаКлиенте
Процедура ПереданныеНаКомиссиюЦенаРеглПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПереданныеНаКомиссиюСуммаРеглПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПереданныеПереработчикамТоварыРазделУчетаПриИзменении(Элемент)
	Элементы.ПереданныеПереработчикамТоварыЗаполнитьПоОстаткам.Видимость = 
		Объект.РазделУчета = ПредопределенноеЗначение("Перечисление.РазделыВводаНачальныхОстатков.РегламентированныйУчет");
КонецПроцедуры
...
// 4D:ERP для Беларуси, Петр, 20.02.2018 16:04:05 
// Механизм ввода остатков, № 17856
// {
&НаКлиенте
Процедура ПереданныеПереработчикамТоварыЦенаРеглПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПереданныеПереработчикамТоварыСуммаРеглПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПереданныеВПроизводствоТоварыРазделУчетаПриИзменении(Элемент)
	Элементы.ПереданныеВПроизводствоТоварыЗаполнитьПоОстаткам.Видимость = 
		Объект.РазделУчета = ПредопределенноеЗначение("Перечисление.РазделыВводаНачальныхОстатков.РегламентированныйУчет");
КонецПроцедуры
...
// 4D:ERP для Беларуси, Петр, 20.02.2018 16:47:14 
// Механизм ввода остатков, № 17856
// {
&НаКлиенте
Процедура ПереданныеВПроизводствоТоварыЦенаРеглПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПереданныеВПроизводствоТоварыСуммаРеглПриИзменении(Элемент)
...
Процедура КоличествоПриИзменении()
	...
	// 4D:ERP для Беларуси, Петр, 20.02.2018 12:37:25 
	// Механизм ввода остатков, № 17856
	// {
	СтруктураДействий.Вставить("ПересчитатьСуммуРеглПоЦенеРегл");
...
Процедура УпаковкаПриИзменении(ИдентификаторТекущейСтроки = Неопределено)
	...
	// 4D:ERP для Беларуси, Петр, 20.02.2018 12:37:55 
	// Механизм ввода остатков, № 17856
	// {
	Если ТекущаяСтрока.Количество > 0 Тогда
		СтруктураДействий.Вставить("ПересчитатьЦенуРеглЗаУпаковку", ТекущаяСтрока.Количество);
	КонецЕсли;
...
Процедура ЦенаПриИзменении()
	...
	// 4D:ERP для Беларуси, Петр, 19.02.2018 17:22:28 
	// Механизм ввода остатков, № 17856
	// {
	Если Не Объект.ЦенаВключаетНДС Тогда
		ТекущаяСтрока.СуммаБезНДС = ТекущаяСтрока.Сумма;
...
// 4D:ERP для Беларуси, Петр, 16.02.2018 17:45:52 
// Механизм ввода остатков, № 17856
// {
&НаКлиенте
Процедура ЦенаРеглПриИзменении()
...
&НаКлиенте
Процедура СуммаРеглПриИзменении()
	...
	СтруктураДействий.Вставить("ПересчитатьЦенуРеглПоСуммеРегл", "Количество");
	ОбработкаТабличнойЧастиКлиент.ОбработатьСтрокуТЧ(ТекущаяСтрока, СтруктураДействий, КэшированныеЗначения);
...
Процедура СтавкаНДСПриИзменении()
	...
	// 4D:ERP для Беларуси, Петр, 20.02.2018 14:58:32 
	// Механизм ввода остатков, № 17856
	// {
	СтруктураДействий = Новый Структура;
	СтруктураДействий.Вставить("ПересчитатьСуммуРеглПоЦенеРегл");
...
Процедура ВозвратнаяТараКоличествоПриИзменении(ТаблЧасть)
	...
	// 4D:ERP для Беларуси, Петр, 20.02.2018 16:56:30 
	// Механизм ввода остатков, № 17856
	// {
	СтруктураДействий.Вставить("ПересчитатьСуммуРеглПоЦенеРегл");
...
Процедура ВозвратнаяТараУпаковкаПриИзменении(ТаблЧасть)
	...
	// 4D:ERP для Беларуси, Петр, 20.02.2018 17:05:07 
	// Механизм ввода остатков, № 17856
	// {
	Если ТекущаяСтрока.Количество > 0 Тогда
		СтруктураДействий.Вставить("ПересчитатьЦенуРеглЗаУпаковку", ТекущаяСтрока.Количество);
...
// {
&НаКлиенте
Процедура ВозвратнаяТараЦенаРеглПриИзменении(ТаблЧасть)
...
&НаКлиенте
Процедура ВозвратнаяТараСуммаРеглПриИзменении(ТаблЧасть)
...
Процедура ДатаПриИзмененииСервер()
	...
	// 4D:ERP для Беларуси, Петр, 16.02.2018 16:26:43 
	// Механизм ввода остатков, № 17856
	// {
	КоэффициентПересчетаИзВалютыРеглВУпр = КоэффициентПересчета(ВалютаРегламентированногоУчета, ВалютаУправленческогоУчета, Объект.Дата);
	// }
...
Процедура ЦенаВключаетНДСПриИзмененииСервер(КэшированныеЗначения)
	...
	// 4D:ERP для Беларуси, Петр, 20.02.2018 9:53:29 
	// Механизм ввода остатков, № 17856
	// {
	СтруктураДействий.Вставить("ПересчитатьСуммуРеглПоЦенеРегл");
	СтруктураДействий.Вставить("ПересчитатьСуммуНДСРегл", СтруктураПересчетаСуммы);
...
Процедура УстановитьВидимость()
	...
	Элементы.ПереданныеВПроизводствоТоварыНалогообложениеНДС.Видимость = ВедетсяРаздельныйУчетПоВидамНалогообложенияНДС;
	Элементы.ПереданныеПереработчикамТоварыНалогообложениеНДС.Видимость = ВедетсяРаздельныйУчетПоВидамНалогообложенияНДС;
	...
	Элементы.СобственныеТоварыЗаполнитьПоОстаткам.Видимость = НачОстаткиРеглУчета;
	Элементы.ПолученныеНаКомиссиюЗаполнитьПоОстаткам.Видимость = НачОстаткиРеглУчета;
	Элементы.ПереданныеНаКомиссиюЗаполнитьПоОстаткам.Видимость = НачОстаткиРеглУчета;
	Элементы.ПринятаяТараЗаполнитьПоОстаткам.Видимость = НачОстаткиРеглУчета;
	Элементы.ПереданныеПереработчикамТоварыЗаполнитьПоОстаткам.Видимость = НачОстаткиРеглУчета;
	Элементы.ПереданныеВПроизводствоТоварыЗаполнитьПоОстаткам.Видимость = НачОстаткиРеглУчета;
...
Процедура ДобавитьВСтруктуруДействияПриИзмененииКоличестваУпаковок(СтруктураДействий, Форма)
	...
	// 4D:ERP для Беларуси, Петр, 20.02.2018 17:20:49 
	// Механизм ввода остатков, № 17856
	// {
	СтруктураДействий.Вставить("ПересчитатьСуммуРеглПоЦенеРегл");
	...
	СтруктураДействий.Вставить("ПересчитатьСуммуУпрПоСуммеРегл", Форма.КоэффициентПересчетаИзВалютыРеглВУпр);
	СтруктураДействий.Вставить("ПересчитатьСуммуНДС", СтруктураПересчетаСуммы);
	СтруктураДействий.Вставить("ПересчитатьСуммуСНДС", СтруктураПересчетаСуммы);
	СтруктураДействий.Вставить("ПересчитатьСуммуБезНДС");
	СтруктураДействий.Вставить("ПересчитатьЦенуПоСумме", "Количество");
...
Процедура ПолучитьЗагруженныеТоварыИзХранилища(АдресТоваровВХранилище, КэшированныеЗначения)
	...
	Для Каждого СтрокаТоваров Из ТоварыИзХранилища Цикл
		...
		// 4D:ERP для Беларуси, Петр, 20.02.2018 17:14:42 
		// Механизм ввода остатков, № 17856
		// {
		СтруктураДействий.Вставить("ПересчитатьСуммуРеглПоЦенеРегл");
...
Процедура РазбитьСтрокуЗавершение(НоваяСтрока, ДополнительныеПараметры) Экспорт
	...
	Если НоваяСтрока <> Неопределено Тогда
		...
		// 4D:ERP для Беларуси, Петр, 20.02.2018 18:55:56 
		// Механизм ввода остатков, № 17856
		// {
		СтруктураДействий.Вставить("ПересчитатьСуммуРеглПоЦенеРегл");
...
&НаСервере
Процедура СобственныеТоварыРежимИспользованияБСОПриИзмененииНаСервере()
	УчетБланковСтрогойОтчетностиСервер.ДобавитьГруппуБСО(ЭтаФорма);
КонецПроцедуры

&НаКлиенте
Процедура СобственныеТоварыРежимИспользованияБСОПриИзменении(Элемент)
	СобственныеТоварыРежимИспользованияБСОПриИзмененииНаСервере();
КонецПроцедуры
