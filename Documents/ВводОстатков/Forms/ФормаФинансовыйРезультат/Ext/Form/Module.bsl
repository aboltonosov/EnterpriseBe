...
Процедура УстановитьПараметрыВыбораСтатьи()
	...
	ПараметрыВыбораСтатьи.Добавить(Новый ПараметрВыбора("ДоступнаСебестоимостьПродаж", Истина));
	Элементы.ФинансовыйРезультатРасходыСтатьяРасходов.ПараметрыВыбора = Новый ФиксированныйМассив(ПараметрыВыбораСтатьи)
