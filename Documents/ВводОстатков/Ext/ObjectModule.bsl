...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Иначе
		...
		// {
		Если РежимИспользованияБСО И ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиТМЦВЭксплуатации Тогда
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	// Учет бланков строгой отчетности, №10038
	// {
	Если Не (РежимИспользованияБСО И ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиТМЦВЭксплуатации) Тогда
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	//++ НЕ УТ
	Если Не Документы.ВводОстатков.ТипыОперацийНеОтражаемыеВРеглУчете().Найти(ТипОперации) = Неопределено
		И Не РазделУчета = Перечисления.РазделыВводаНачальныхОстатков.ОперативныйУчет Тогда
		Текст = НСтр("ru = 'Операция %1 может отражаться только в оперативном учете'");
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			СтрШаблон(Текст, ТипОперации),
			ЭтотОбъект,
			"РазделУчета",
			,
			Отказ);
	...
	Если (ТипОперации <> Перечисления.ТипыОперацийВводаОстатков.ОстаткиСобственныхТоваров
		...
		Или РазделУчета = Перечисления.РазделыВводаНачальныхОстатков.РегламентированныйУчет Тогда
	...
	Если ((ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиСобственныхТоваров 
				...
				ИЛИ ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиВозвратнойТарыПринятойОтПоставщиков)
			И ИспользоватьАдресноеХранение
			И Не РазделУчета = Перечисления.РазделыВводаНачальныхОстатков.РегламентированныйУчет)
	...
	Если РазделУчета = Перечисления.РазделыВводаНачальныхОстатков.РегламентированныйУчет
		Или ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиВозвратнойТарыПереданнойКлиентам
		Или ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиВозвратнойТарыПринятойОтПоставщиков
		Или ТипОперации = Перечисления.ТипыОперацийВводаОстатков.УдалитьОстаткиВозвратнойТарыПринятойОтПоставщиковНаАдресномСкладе
		Или ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиТоваровПолученныхНаКомиссию
	...
	Если Не РазделУчета = Перечисления.РазделыВводаНачальныхОстатков.РегламентированныйУчет
	...
	Если ТипОперации <> Перечисления.ТипыОперацийВводаОстатков.ОстаткиТоваровПереданныхНаКомиссию
		И ТипОперации <> Перечисления.ТипыОперацийВводаОстатков.УдалитьОстаткиТоваровПолученныхНаКомиссиюНаАдресномСкладе
		И (ТипОперации <> Перечисления.ТипыОперацийВводаОстатков.ОстаткиТоваровПолученныхНаКомиссию
			ИЛИ РазделУчета = Перечисления.РазделыВводаНачальныхОстатков.РегламентированныйУчет)
		И ТипОперации <> Перечисления.ТипыОперацийВводаОстатков.ОстаткиВозвратнойТарыПереданнойКлиентам
		И ТипОперации <> Перечисления.ТипыОперацийВводаОстатков.ОстаткиВозвратнойТарыПринятойОтПоставщиков
		И ТипОперации <> Перечисления.ТипыОперацийВводаОстатков.УдалитьОстаткиВозвратнойТарыПринятойОтПоставщиковНаАдресномСкладе 
		И ТипОперации <> Перечисления.ТипыОперацийВводаОстатков.ОстаткиМатериаловПереданныхПереработчикам
	...
	Если РежимИспользованияБСО Тогда
		Если ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиТМЦВЭксплуатации Тогда
			УчетБланковСтрогойОтчетностиКлиентСервер.НепроверяемыеРеквизиты(МассивНепроверяемыхРеквизитов, Ссылка, "ТМЦВЭксплуатации");
		ИначеЕсли ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиСобственныхТоваров Тогда
			УчетБланковСтрогойОтчетностиКлиентСервер.НепроверяемыеРеквизиты(МассивНепроверяемыхРеквизитов, Ссылка, "Товары");
		КонецЕсли;
	Иначе
		УчетБланковСтрогойОтчетностиКлиентСервер.НепроверяемыеРеквизитыБСО(МассивНепроверяемыхРеквизитов, "ТМЦВЭксплуатации");
		УчетБланковСтрогойОтчетностиКлиентСервер.НепроверяемыеРеквизитыБСО(МассивНепроверяемыхРеквизитов, "Товары");
	КонецЕсли;
	// }
	// 4D
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ДанныеЗаполнения <> Неопределено И ДанныеЗаполнения.Свойство("ТипОперации") Тогда
		...
		Если НЕ ДействующаяОперация = Неопределено Тогда
			ТекстСообщения = НСтр("ru='Операция ввода остатков ""%АрхивнаяОперация%"" является архивной. Для ввода остатков можно воспользоваться операцией ""%ДействующаяОперация%"".'");
...
Процедура ИнициализироватьДокумент(ДанныеЗаполнения = Неопределено)
	...
	КонецЕсли;
	РазделУчета = ?(ПолучитьФункциональнуюОпцию("ИспользоватьРеглУчет"), 
		Перечисления.РазделыВводаНачальныхОстатков.ОперативныйИРегламентированныйУчет, Перечисления.РазделыВводаНачальныхОстатков.ОперативныйУчет);
	Если ДанныеЗаполнения <> Неопределено Тогда
		Если ДанныеЗаполнения.Свойство("ТипОперации") Тогда
			ТипОперации = ДанныеЗаполнения.ТипОперации;
		КонецЕсли;
		Если ДанныеЗаполнения.Свойство("РазделУчета") Тогда
			РазделУчета = ДанныеЗаполнения.РазделУчета;
		КонецЕсли;
	...
	//++ НЕ УТ
	Если Не Документы.ВводОстатков.ТипыОперацийНеОтражаемыеВРеглУчете().Найти(ТипОперации) = Неопределено Тогда
		РазделУчета = Перечисления.РазделыВводаНачальныхОстатков.ОперативныйУчет;
	КонецЕсли;
	//-- НЕ УТ
