...
Функция ПолучитьРезультатЗапросаПоОстаткамЗаказов(ДанныеОтбора,
	...
	Запрос.УстановитьПараметр("ХозяйственнаяОперация", ПолучитьСписокДопустимыхОпераций());
...
&НаСервере
Функция ПолучитьСписокДопустимыхОпераций()
...
КонецФункции // ПолучитьСписокДопустимыхОперацийДокументовОснований()
