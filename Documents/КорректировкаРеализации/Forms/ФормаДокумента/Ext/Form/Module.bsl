...
Процедура ПриЧтенииСозданииНаСервере()
	...
	ВидимостьЭлемента = ТипЗнч(Объект.ДокументОснование) <> Тип("ДокументСсылка.РеализацияУслугПрочихАктивов")
		И ТипЗнч(Объект.ДокументОснование) <> Тип("ДокументСсылка.АктВыполненныхРабот");
...
Процедура НастроитьОтображениеЭлементовПоИтогамРасхождений(Форма)
	...
	Форма.ТекстНаПрочиеРасходы = СтрШаблон(НСтр("ru = 'На прочие расходы: %1 %2'"), 
		Формат(Форма.СуммаНаПрочиеРасходы, "ЧДЦ=2; ЧН="), 
		Форма.Объект.Валюта);
		
	Форма.ТекстНаПрочиеДоходы = СтрШаблон(НСтр("ru = 'На прочие доходы:  %1 %2'"), 
	...
	Форма.Элементы.СтатьяРасходовДополнительно.Доступность = ЗначениеЗаполнено(Форма.СуммаНаПрочиеРасходы);
	Форма.Элементы.АналитикаРасходов.Доступность = ЗначениеЗаполнено(Форма.СуммаНаПрочиеРасходы);
	Форма.Элементы.АналитикаРасходовДополнительно.Доступность = ЗначениеЗаполнено(Форма.СуммаНаПрочиеРасходы);

	Форма.Элементы.СтатьяДоходов.Доступность  = ЗначениеЗаполнено(Форма.СуммаНаПрочиеДоходы);
	Форма.Элементы.СтатьяДоходовДополнительно.Доступность  = ЗначениеЗаполнено(Форма.СуммаНаПрочиеДоходы);
	Форма.Элементы.АналитикаДоходов.Доступность  = ЗначениеЗаполнено(Форма.СуммаНаПрочиеДоходы);
	Форма.Элементы.АналитикаДоходовДополнительно.Доступность  = ЗначениеЗаполнено(Форма.СуммаНаПрочиеДоходы);
...
Процедура УстановитьВидимостьПоОперации()
	...
	Элементы.ТекстСчетФактура.Видимость = ВидимостьЭлемента;
	// }
	// 4D
