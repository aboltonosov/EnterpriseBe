...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	// 4D:ERP для Беларуси, Екатерина, 02.12.2015 10:31:59 
	// , №10675
	// {
	...
	// 4D:ERP для Беларуси, Екатерина, 02.12.2015 10:32:36 
	// , №10675
	// {
	// Действие не требуется
	// }
	...
	// 4D:ERP для Беларуси, Екатерина, 02.12.2015 10:35:26 
	// , №10675
	// {
	// Действие не требуется
	// }
	...
	// 4D:ERP для Беларуси, Екатерина, 02.12.2015 10:29:20 
	// , №10675
	// {
	// Действие не требуется
	// }
...
#Область УменьшениеНДС // (Дт 90.03 :: Кт 68.02 / 19.09)
	...
	|	ЗНАЧЕНИЕ(Справочник.НаправленияДеятельности.ПустаяСсылка) КАК НаправлениеДеятельностиКт,
	|
	// 4D:ERP для Беларуси, Екатерина, 02.12.2015 10:44:23 
	// , №10675
	// {
	|	ЗНАЧЕНИЕ(ПланСчетов.Хозрасчетный.НДС) КАК СчетКт,
	// }
...
Функция ТекстПереносУменьшенияНДС()
	...
	|	ЗНАЧЕНИЕ(Справочник.НаправленияДеятельности.ПустаяСсылка) КАК НаправлениеДеятельностиКт,
	|
	// 4D:ERP для Беларуси, Екатерина, 02.12.2015 10:45:15 
	// , №10675
	// {
	|	ЗНАЧЕНИЕ(ПланСчетов.Хозрасчетный.НДС) КАК СчетКт,
	// }
...
Функция ПолучитьДанныеДляПечатнойФормыТОРГ12(ПараметрыПечати, МассивОбъектов) Экспорт 
	...
	// Локализация печатных форм, №7762
	// {
	|	КорректировкаРеализации.НомерИсходящегоДокумента КАК НомерИсходящегоДокумента,
	|	КорректировкаРеализации.СерияИсходящегоДокумента КАК СерияИсходящегоДокумента,
	|	КорректировкаРеализации.Отпустил КАК Отпустил,
	|	КорректировкаРеализации.ОтпустилДолжность КАК ОтпустилДолжность,
	|	КорректировкаРеализации.Руководитель.Наименование КАК Разрешил,
	|	КорректировкаРеализации.Руководитель.Должность КАК РазрешилДолжность,
	|	КорректировкаРеализации.Принял КАК Принял,
	|	КорректировкаРеализации.ПереданыДокументы КАК ПереданыДокументы,
	// }
	// 4D
...
Процедура ПоместитьВременнуюТаблицуТоваров(МенеджерВременныхТаблиц, ПараметрыЗаполнения = Неопределено) Экспорт
	...
	// Печать наборов в ТТН, №11591
	// {
	|	СтрокиТоваров.НоменклатураНабора,
	|	СтрокиТоваров.ХарактеристикаНабора,
	// }
	// 4D
	|	ТаблицаДокумента.Ссылка                                 КАК Ссылка,
	...
	// Печать наборов в ТТН, №11591
	// {
	|		И Услуги.НоменклатураНабора = СтрокиТоваров.НоменклатураНабора
	|		И Услуги.ХарактеристикаНабора = СтрокиТоваров.ХарактеристикаНабора
	// }
	// 4D
	|СГРУППИРОВАТЬ ПО
	// 4D:ERP для Беларуси, ВладимирР, 07.06.2016 11:07:41
