...
Процедура ЗаполнитьПараметрыИнициализации(Запрос, ДокументСсылка)
	...
	// 4D:ERP для Беларуси, Дмитрий, 07.10.2017 14:46:03 
	// Серия в реестре документов
	// {
	|	ДанныеДокумента.СерияИсходящегоДокумента КАК СерияИсходящегоДокумента,
	|	ДанныеДокумента.НомерИсходящегоДокумента КАК НомерИсходящегоДокумента,
	// }
	// 4D
	...
	// Серия в реестре документов
	// {
	Запрос.УстановитьПараметр("НомерИсходящегоДокумента",  		  		  Реквизиты.НомерИсходящегоДокумента);
	Запрос.УстановитьПараметр("СерияИсходящегоДокумента", 		  		  Реквизиты.СерияИсходящегоДокумента);
	// }
	// 4D
...
Функция ПолучитьДанныеДляПечатнойФормыТОРГ12(ПараметрыПечати, МассивОбъектов) Экспорт 
	...
	// Локализация печатных форм, №7762
	// {
	|	ПередачаСырьяПереработчику.НомерИсходящегоДокумента КАК НомерИсходящегоДокумента,
	|	ПередачаСырьяПереработчику.СерияИсходящегоДокумента КАК СерияИсходящегоДокумента,
...
Функция ТекстЗапросаТаблицаРеестрДокументов(Запрос, ТекстыЗапроса, Регистры)
	...
	// Серия в реестре документов
	// {
	|	&СерияИсходящегоДокумента                КАК СерияПервичногоДокумента,
	|	&НомерИсходящегоДокумента                КАК НомерПервичногоДокумента";
	// }
	// 4D
