...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// 4D:ERP для Беларуси, Яна, 24.07.2017 9:38:38 
	// Документ "Работа в выходные и праздники", №15542 
	// {
	// МенюОтчеты
...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если ПараметрыЗаписи.РежимЗаписи = РежимЗаписиДокумента.Проведение Тогда
		...
		ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина, "ПроведениеДокументаРаботаВВыходныеИПраздничныеДни");
...
// 4D:ERP для Беларуси, Яна, 24.07.2017 9:46:16 
// Работа в выходные и праздники, №15542 
// {
// МенюОтчеты
&НаКлиенте
