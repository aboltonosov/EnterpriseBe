...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// {
	СкидкиНаценкиВызовСервера.ПриСозданииФормыДокументаЗаявкаНаВозвратТоваровОтКлиента(ЭтаФорма);
	// }
	// 4D
...
Процедура ЗаменяющиеТоварыВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	// 4D:ERP для Беларуси, Екатерина, 18.04.2016 12:23:52 
	// Расчет скидки к цене, №10910
	// {
	ИначеЕсли Поле = Элементы.ЗаменяющиеТоварыЦена или Поле = Элементы.ЗаменяющиеТоварыЦенаСоСкидкой Тогда
	// }
	// 4D
...
// 4D:ERP для Беларуси, Екатерина, 12.04.2016 16:50:50 
// Расчет скидки к цене, №10910
// {
&НаКлиенте
Процедура ЗаменяющиеТоварыЦенаСоСкидкойПриИзменении(Элемент)
	...
	СтруктураДействий.Вставить("ПересчитатьСумму");
	СтруктураДействий.Вставить("ЗаполнитьДубликатыЗависимыхРеквизитов", ЗависимыеРеквизитыЗаменяющиеТовары());
	СтруктураДействий.Вставить("ПересчитатьПроцентРучнойСкидкиВПродажах", СтруктураПересчетаЦены);
...
Процедура НастроитьЭлементыФормы()
	...
	// 4D:ERP для Беларуси, Екатерина, 18.04.2016 12:14:28 
	// Расчет скидки к цене, №10910
	// {
	...
	// Расчет скидки к цене, №10910
	// {
	Элементы.ЗаменяющиеТоварыСуммаРучнойСкидки.Видимость = ВидимостьЭлемента И НЕ ПрименятьСкидкиКЦене;
	// }
	// 4D
	...
	// Расчет скидки к цене, №10910
	// {
	Элементы.ЗаменяющиеТоварыСуммаАвтоматическойСкидки.Видимость = ВидимостьЭлемента И ПрименятьУсловияПродаж И НЕ ПрименятьСкидкиКЦене;
	// }
	// 4D
