...
Процедура ЗаполнитьПараметрыИнициализации(Запрос, ДокументСсылка, ДополнительныеСвойства)
	...
	КонецЦикла;
	Запрос.УстановитьПараметр("НазваниеДокумента", НСтр("ru='Модернизация ОС'"));
...
Функция ПрочиеРасходы(ТекстыЗапроса)
	...
	|	0 КАК СуммаБезНДС,
	|	0 КАК СуммаРегл,
	|	-ОсновныеСредства.СуммаКапитальныхВложенийВключаемыхВРасходыНУ КАК ПостояннаяРазница,
...
Функция ТекстЗапросаВТОтраженияВРеглУчете() Экспорт
	...
	Возврат УчетОСВызовСервера.ТекстЗапросаВТОтраженияВРеглУчетеНачисленнойАмортизации("МодернизацияОС")
		...
		+ ВременнаяТаблицаЦелевоеФинансирование();
...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	Возврат УчетОСВызовСервера.ТекстОтраженияВРеглУчетеНачисленнойАмортизации()
		...
		+ Разделитель + УвеличениеСтоимостиОСЦелевыеСредства()
		+ Разделитель + УвеличениеСтоимостиОСЧастичныеЦелевыеСредства()
		+ Разделитель + ПеремещениеВосстановительнойСтоимостиЦФ()
		+ Разделитель + ПеремещениеНакопленнойАмортизацииЦФ()
		+ Разделитель + АмортизационнаяПремияДтКВ()
		+ Разделитель + АмортизационнаяПремияКтКВ()
		+ Разделитель + АмортизационнаяПремияМодернизации()
