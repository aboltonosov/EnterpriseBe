...
Процедура УстановитьВидимостьДокументаНаПроживание(Форма)
	...
	// 4D:ERP для Беларуси, Дмитрий, 11.09.2017 5:53:59 
	// Страна Беларусь
	// {
	Видимость = ЗначениеЗаполнено(Форма.Объект.Гражданство) И Форма.Объект.Гражданство <> Справочники.СтраныМира.Беларусь;
