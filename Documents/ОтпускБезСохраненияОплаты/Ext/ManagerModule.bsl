...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	// 4D:ERP для Беларуси, Юлия, 05.02.2018 12:17:23 
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьОтпускаБезОплаты") Тогда
		...
		КомандаПечати.Идентификатор = "ПФ_MXL_ОПредоставленииОтпускаБезОплаты";
		КомандаПечати.Представление = НСтр("ru = 'Приказ о предоставлении кратковременного отпуска без сохранения заработной платы'");
...
Функция ВидРасчетаПоВидуОтпускаОбъекта(Объект) Экспорт
	...
	// 4D:ERP для Беларуси, Юлия, 29.01.2018 16:48:52 
	// Добавить предопределенный элемент в справочник "Виды отпусков", № 17596
	// {
