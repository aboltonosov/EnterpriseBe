...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// 4D:ERP для Беларуси, Петр, 14.02.2018 16:18:01 
	...
	ВалютаСтр = Строка(Объект.Валюта);
	// }
	// 4D
...
Процедура ПриЧтенииСозданииНаСервере()
	...
	// 4D:ERP для Беларуси, Петр, 14.02.2018 16:18:29 
	// Добавление выбора валюты, № 17834
	// {
...
// 4D:ERP для Беларуси, Петр, 14.02.2018 16:17:36 
// Добавление выбора валюты, № 17834
// {
&НаСервере
...
Процедура ВалютаПриИзменении(Элемент)
	...
	ЗаголовокЦены = НСтр("ru='Цена'");
	Если ЗначениеЗаполнено(Объект.Валюта) Тогда
		ЗаголовокСуммы = СтрШаблон(НСтр("ru='Сумма (%1)'"), Объект.Валюта);
		ЗаголовокЦены = СтрШаблон(НСтр("ru='Цена (%1)'"), Объект.Валюта);
	КонецЕсли;
	
	Элементы.ТоварыЦена.Заголовок = ЗаголовокЦены;
	Элементы.ТоварыСумма.Заголовок = ЗаголовокСуммы;
