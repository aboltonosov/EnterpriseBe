...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ТипДанныхЗаполнения = Тип("ДокументСсылка.ПоступлениеУслугПрочихАктивов") Тогда
		ЗаполнитьДокументНаОснованииПоступлениеУслугПрочихАктивов(ДанныеЗаполнения);
...
Процедура ЗаполнитьДокументНаОснованииПоступлениеУслугПрочихАктивов(Знач Основание)
	
	Запрос = Новый Запрос(
		"ВЫБРАТЬ
		|	ПоступлениеУслугПрочихАктивов.Организация    КАК Организация,
		|	ПоступлениеУслугПрочихАктивов.Контрагент     КАК Контрагент,
		|	ПоступлениеУслугПрочихАктивов.Валюта         КАК Валюта,
		|	ПоступлениеУслугПрочихАктивов.СуммаДокумента КАК СуммаДокумента,
		|	ПоступлениеУслугПрочихАктивов.Подразделение  КАК Подразделение,
		...
		|ГДЕ
		|	ПоступлениеУслугПрочихАктивов.Ссылка = &Основание
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		...
		|	ПоступлениеУслугПрочихАктивовРасходы.СтавкаНДС                  КАК СтавкаНДС,
		|	СУММА(ПоступлениеУслугПрочихАктивовРасходы.СуммаНДС)            КАК СуммаНДС,
		|	СУММА(ПоступлениеУслугПрочихАктивовРасходы.СуммаСНДС)           КАК Сумма
		|ИЗ
		|	Документ.ПоступлениеУслугПрочихАктивов.Расходы КАК ПоступлениеУслугПрочихАктивовРасходы
		|ГДЕ
		|	ПоступлениеУслугПрочихАктивовРасходы.Ссылка = &Основание
		|
		|СГРУППИРОВАТЬ ПО
		|	ПоступлениеУслугПрочихАктивовРасходы.СтавкаНДС");
