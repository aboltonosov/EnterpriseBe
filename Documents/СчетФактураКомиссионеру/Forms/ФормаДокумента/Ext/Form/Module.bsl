...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	// 4D:ERP для Беларуси, ВалентинМ, 12.07.2017 16:25:07 
	// ЭСЧФ
	// {
...
Процедура ВыставленПриИзменении(Элемент)
	...
	// 4D:ERP для Беларуси, ВалентинМ, 12.07.2017 16:54:03 
	// ЭСЧФ
	// {
...
&НаСервере
Процедура УправлениеЭлементамиФормы_()
...
Процедура УстановитьДоступностьИзмененийПоФлагуВыставлен()
	...
	МассивИменЭлементов.Добавить("Комиссионер");
...
Процедура ОпределитьСтатусыПолучателя() 
	...
	Если Объект.СтатусПоставщика = Справочники.СтатусыПоставщикаЭСЧФ.Комитент Тогда
