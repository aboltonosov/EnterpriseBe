...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВводНаОсновании.ПриСозданииНаСервере(ЭтаФорма, Элементы.СписокСчетФактураВыданныйПодменюСоздатьНаОсновании);
...
Процедура Подключаемый_ВыполнитьКомандуСоздатьНаОсновании(Команда)
	...
	ВводНаОснованииКлиент.ВыполнитьПодключаемуюКомандуСоздатьНаОсновании(Команда, ЭтаФорма, Элементы.СписокСчетФактураВыданный);
		...
		Пока ВыборкаКонтрагент.Следующий() Цикл
			...
			Если ИспользоватьЗаказыКлиентов Тогда
				...
				Если Товары.Количество() <> 0 Тогда
					...
					Документы.СчетФактураВыданныйАванс.РаспределитьАвасыПоТоварам(ТаблицаАвансы, Товары, СчетФактураОбъект.ДокументОснование);
