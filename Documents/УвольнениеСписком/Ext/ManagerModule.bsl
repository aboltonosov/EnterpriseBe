...
Функция ДанныеДокументовДляПечатиРасчетаСреднегоЗаработка(МассивСсылок, ИмяМакета = "") Экспорт
	...
	|	Документ.ПризнакКомпенсацииУдержанияОтпуска
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВТВидыОтпусков.Ссылка КАК Ссылка,
	|	ВТВидыОтпусков.Сотрудник КАК Сотрудник,
	|	ВТВидыОтпусков.ВидОтпуска,
	|	ВТВидыОтпусков.ПризнакКомпенсацииУдержанияОтпуска
	|ИЗ
	|	ВТВидыОтпусков КАК ВТВидыОтпусков
	|
	|УПОРЯДОЧИТЬ ПО
	|	Ссылка,
	|	Сотрудник";
