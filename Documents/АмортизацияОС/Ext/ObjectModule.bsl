...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	УчетОСВызовСервера.ЗарегистрироватьЗаданиеПризнаниеВНУЛизинговыхПлатежейКЗакрытиюМесяца(ЭтотОбъект, Истина);
...
Процедура СформироватьЗаданиеАмортизацияОСПриОтменеПроведения()
	...
	Если НЕ УчетОСВызовСервера.ТребуетсяАмортизацияОС(Организация, Дата) Тогда
		Возврат;
	КонецЕсли;
	...
	РегистрыСведений.ЗаданияКЗакрытиюМесяца.СоздатьЗаписьРегистра(
		...
		Ссылка, 
		Организация, 
		Перечисления.ОперацииЗакрытияМесяца.АмортизацияОС);
