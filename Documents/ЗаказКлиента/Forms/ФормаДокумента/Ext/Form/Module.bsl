...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// {
	СкидкиНаценкиВызовСервера.ПриСозданииФормыДокументаЗаказКлиентаФормаДокумента(ЭтаФорма);
	// }
	// 4D
...
Процедура ТоварыВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	ИначеЕсли Элемент.ТекущийЭлемент = Элементы.ТоварыПроцентАвтоматическойСкидки
		...
		// 4D:ERP для Беларуси, Екатерина, 18.04.2016 13:24:44 
	// Расчет скидки к цене, №10910
	// {
...
// 4D:ERP для Беларуси, Екатерина, 12.04.2016 16:47:54 
// Расчет скидки к цене, №10910
// {
&НаКлиенте
