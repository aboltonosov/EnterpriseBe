...
Функция ФиксацияОписаниеФиксацииРеквизитов()
	...
	ОписаниеФиксацииРеквизитов.Вставить("СотрудникиСтраховойНомерПФР",					ФиксацияОписаниеФиксацииРеквизита("СтраховойНомерПФР", "ФизическоеЛицо"));
	...
	ОбменСБанкамиПоЗарплатнымПроектамВнутренний.ДополнитьОписаниеФиксацииРеквизитовЗаявкиНаОткрытиеЛицевыхСчетов(ОписаниеФиксацииРеквизитов);
...
Функция ФиксацияОписаниеФиксацииРеквизита(ИмяРеквизита, ИмяГруппы, ОснованиеЗаполнения = "Сотрудник", РеквизитСтроки = Истина,
	ФиксацияГруппы = Ложь, Путь = "Сотрудники", Используется = Истина, ОтображатьПредупреждение = Истина, СтрокаПредупреждения =  "") Экспорт
