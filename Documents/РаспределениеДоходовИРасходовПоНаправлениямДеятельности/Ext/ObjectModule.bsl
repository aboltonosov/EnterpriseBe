...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если ДополнительныеСвойства.Свойство("НетБазыРаспределения") Тогда
		Отказ = ДополнительныеСвойства.НетБазыРаспределения;
	КонецЕсли;
...
Процедура ЗаполнитьДоходыПоОстаткам() Экспорт
	...
	|	 ИЛИ ПрочиеДоходы.НаправлениеДеятельности <> ЗНАЧЕНИЕ(Справочник.НаправленияДеятельности.ПустаяСсылка) ТОГДА
	|		Ложь
	|	ИНАЧЕ
	|		Истина
...
Процедура ЗаполнитьРасходыПоОстаткам() Экспорт
	...
	|
	|	ВЫБОР КОГДА ПрочиеРасходы.АналитикаРасходов ССЫЛКА Справочник.НаправленияДеятельности
	|	 ИЛИ ПрочиеРасходы.НаправлениеДеятельности <> ЗНАЧЕНИЕ(Справочник.НаправленияДеятельности.ПустаяСсылка) ТОГДА
	|		Ложь
	|	ИНАЧЕ
	|		Истина
	|	КОНЕЦ КАК ТребуетсяСпособРаспределения
