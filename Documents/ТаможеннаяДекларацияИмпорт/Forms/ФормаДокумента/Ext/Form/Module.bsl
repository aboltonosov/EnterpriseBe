...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	// 4D:ERP для Беларуси, Дмитрий, 31.10.2017 22:51:37 
	// ЭСЧФ
	// {
...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	// 4D:ERP для Беларуси, Дмитрий, 31.10.2017 22:45:41 
	// ЭСЧФ
	// {
...
Процедура СтрокаДокументыОплатыНалогаНажатие(Элемент, СтандартнаяОбработка)
	...
	Оповещение = Новый ОписаниеОповещения("ДокументыОплатыНалогаПриИзмененииСервер", ЭтаФорма);
...
Процедура ПересчетКурсаВалютыСервер()
	...
	// {
	Запрос.УстановитьПараметр("КодВалюты", "933");
	// }
	// 4D
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |ГДЕ
	               |	НЕ ПоступлениеТоваровУслуг.Валюта.Код = &КодВалюты
	               |;
	               |
	               |////////////////////////////////////////////////////////////////////////////////
	               |ВЫБРАТЬ
...
Процедура УстановитьСтоимостьСервер(Знач ВидЦены = Неопределено, ОтборТоваров = Неопределено)
	...
	ПараметрыЗаполнения.Вставить("Дата",              ДатаДокумента(Объект.Дата));
...
&НаСервере
Процедура ДокументыОплатыНалогаПриИзмененииСервер(АдресВХранилище, ДополнительныеПараметры) Экспорт
