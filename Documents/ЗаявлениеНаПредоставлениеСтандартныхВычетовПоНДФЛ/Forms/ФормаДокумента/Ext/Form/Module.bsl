...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// {
	Элементы.КодВычетаЛичныйДополнительный.Доступность	= Объект.ИзменитьЛичныйВычетДополнительный;
	// }
	// 4D
...
// 4D:ERP для Беларуси, Яна, 05.06.2017 16:45:21 
// Спр. "Виды доходов подоходного налога" элементы на форме не доступны для редактирования, № 15051 
// {
&НаКлиенте
Процедура ИзменитьЛичныйВычетДополнительныйПриИзменении(Элемент)
	
	ПодключитьОбработчикОжидания("Подключаемый_ИзменитьЛичныйВычетДополнительныйПриИзменении", 0.3, Истина);

КонецПроцедуры

&НаКлиенте
Процедура КодВычетаЛичныйДополнительныйПриИзменении(Элемент)
	
	 ПодключитьОбработчикОжидания("Подключаемый_КодВычетаЛичныйДополнительныйПриИзменении", 0.3, Истина);
	 
КонецПроцедуры
 
 &НаКлиенте
Процедура Подключаемый_ИзменитьЛичныйВычетДополнительныйПриИзменении()
...
&НаКлиенте
Процедура Подключаемый_КодВычетаЛичныйДополнительныйПриИзменении()
	
	ОбновитьОписаниеЛичногоВычетаДополнительного();
...
// 4D:ERP для Беларуси, Яна, 05.06.2017 16:48:25 
// Спр. "Виды доходов подоходного налога" элементы на форме не доступны для редактирования, № 15051
// {
Процедура ОбновитьОписаниеЛичногоВычетаДополнительного()
	
	Элементы.КодВычетаЛичныйДополнительный.Подсказка = УчетНДФЛВызовСервера.ПолучитьОписаниеВычета(Объект.КодВычетаЛичныйДополнительный);
