...
Процедура ОбработкаУдаленияПроведения(Отказ)
	...
	// 4D:ERP для Беларуси, Дмитрий, 10.08.2016 17:57:09 
	// ЭСЧФ
	// {
	ДополнительныеСвойства.Вставить("Склад", Склад);	
	ДополнительныеСвойства.Вставить("СерияИсходящегоДокумента", СерияИсходящегоДокумента);	
	ДополнительныеСвойства.Вставить("НомерИсходящегоДокумента", НомерИсходящегоДокумента);	
	// }
	// 4D
