...
Процедура СформироватьДоступныеВидыЗапасов(МенеджерВременныхТаблиц) Экспорт
	...
	ОтборЗапапасов.Вставить("КонтролироватьНалогообложение", Ложь);
	ОтборЗапапасов.Вставить("Дата", Дата);
	ОтборЗапапасов.Вставить("МассивСделок", Неопределено);
	ОтборЗапапасов.Вставить("Менеджер", Ответственный);
