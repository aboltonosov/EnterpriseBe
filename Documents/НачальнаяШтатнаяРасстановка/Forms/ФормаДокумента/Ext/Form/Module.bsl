	...
	Если ТаблицаНачислений.Количество() > 0 Тогда
		...
		Для Каждого ТекущиеДанные Из КоллекцияСтрокСотрудников Цикл
			...
			Если СтрокиНачислений <> Неопределено Тогда
				...
				СтрокиТарифныхСтвок = ТарифныеСтавки.НайтиСтроки(ОтборТарифныхСтавок);
				
				ЗаполнитьЗначенияСовокупныхТарифныхСтавокСотрудников(ТекущиеДанные.Сотрудник, СтрокиТарифныхСтвок);
