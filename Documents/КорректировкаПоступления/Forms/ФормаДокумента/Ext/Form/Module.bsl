...
Процедура ТоварыПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	...
	Если НоваяСтрока И НЕ Копирование Тогда
		...
		Если ТипЗнч(Объект.ДокументОснование) = Тип("ДокументСсылка.ПоступлениеУслугПрочихАктивов") Тогда
...
Процедура УстановитьВариантыОтражения(Команда)
	...
	Если ЕстьУвеличениеКоличестваПоОрдерномуСкладу Тогда
		...
		ОткрытьФорму(
			...
			Новый Структура("Отбор", СтруктураОтбор),,,,, Новый ОписаниеОповещения("УстановитьВариантыОтраженияПослеВыбора", ЭтотОбъект, Новый Структура("ЕстьУвеличениеКоличестваБезИнвентаризации, ЕстьУменьшениеКоличестваБезИнвентаризации, ЕстьУменьшениеКоличестваПоОрдерномуСкладу, СтруктураОтбор", ЕстьУвеличениеКоличестваБезИнвентаризации, ЕстьУменьшениеКоличестваБезИнвентаризации, ЕстьУменьшениеКоличестваПоОрдерномуСкладу, СтруктураОтбор)), РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
        Возврат;
...
Процедура УстановитьВариантыОтраженияФрагментБезИнвентаризации(Знач ВариантОтраженияУвеличениеКоличестваПоОрдерномуСкладу, Знач ЕстьУвеличениеКоличестваБезИнвентаризации, Знач ЕстьУменьшениеКоличестваБезИнвентаризации, Знач ЕстьУменьшениеКоличестваПоОрдерномуСкладу)
    ...
    Если ЕстьУвеличениеКоличестваБезИнвентаризации Тогда
        ...
        ОткрытьФорму(
        	"Перечисление.ВариантыОтраженияКорректировокПоступлений.ФормаВыбора", 
        	Новый Структура("Отбор", СтруктураОтбор),,,,, Новый ОписаниеОповещения("УстановитьВариантыОтраженияПослеВыбораПоОрдерномуСкладу", ЭтотОбъект, Новый Структура("ВариантОтраженияУвеличениеКоличестваПоОрдерномуСкладу, ЕстьУменьшениеКоличестваБезИнвентаризации, ЕстьУменьшениеКоличестваПоОрдерномуСкладу, СтруктураОтбор", 
			ВариантОтраженияУвеличениеКоличестваПоОрдерномуСкладу, ЕстьУменьшениеКоличестваБезИнвентаризации, ЕстьУменьшениеКоличестваПоОрдерномуСкладу, СтруктураОтбор)), РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
        Возврат;
...
Процедура УстановитьВариантыОтраженияФрагментПоОрдерномуСкладу(Знач ВариантОтраженияУвеличениеКоличестваБезИнвентаризации, Знач ВариантОтраженияУвеличениеКоличестваПоОрдерномуСкладу, Знач ЕстьУменьшениеКоличестваБезИнвентаризации, Знач ЕстьУменьшениеКоличестваПоОрдерномуСкладу)
    ...
    Если ЕстьУменьшениеКоличестваПоОрдерномуСкладу Тогда
        ...
        ОткрытьФорму(
        "Перечисление.ВариантыОтраженияКорректировокПоступлений.ФормаВыбора", 
        Новый Структура("Отбор", СтруктураОтбор),,,,, Новый ОписаниеОповещения("УстановитьВариантыОтраженияПослеВыбораВарианта", ЭтотОбъект, 
		Новый Структура("ВариантОтраженияУвеличениеКоличестваБезИнвентаризации, ВариантОтраженияУвеличениеКоличестваПоОрдерномуСкладу, ЕстьУменьшениеКоличестваБезИнвентаризации, СтруктураОтбор", 
		ВариантОтраженияУвеличениеКоличестваБезИнвентаризации, ВариантОтраженияУвеличениеКоличестваПоОрдерномуСкладу, ЕстьУменьшениеКоличестваБезИнвентаризации, СтруктураОтбор)), РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
        Возврат;
...
Процедура УстановитьВариантыОтраженияБезИнвентаризации(Знач ВариантОтраженияУвеличениеКоличестваБезИнвентаризации, Знач ВариантОтраженияУвеличениеКоличестваПоОрдерномуСкладу, Знач ВариантОтраженияУменьшениеКоличестваПоОрдерномуСкладу, Знач ЕстьУменьшениеКоличестваБезИнвентаризации)
    ...
    Если ЕстьУменьшениеКоличестваБезИнвентаризации Тогда
        ...
        ОткрытьФорму(
        "Перечисление.ВариантыОтраженияКорректировокПоступлений.ФормаВыбора", 
        Новый Структура("Отбор", СтруктураОтбор),,,,, Новый ОписаниеОповещения("УстановитьВариантыОтраженияЗавершение", ЭтотОбъект, Новый Структура("ВариантОтраженияУвеличениеКоличестваБезИнвентаризации, ВариантОтраженияУвеличениеКоличестваПоОрдерномуСкладу, ВариантОтраженияУменьшениеКоличестваПоОрдерномуСкладу", ВариантОтраженияУвеличениеКоличестваБезИнвентаризации, ВариантОтраженияУвеличениеКоличестваПоОрдерномуСкладу, ВариантОтраженияУменьшениеКоличестваПоОрдерномуСкладу)), РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
        Возврат;
...
Процедура ПодобратьТовары(Команда)
	...
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина,
		"Документ.КорректировкаПоступления.ФормаДокумента.Команда.ПодобратьТовары");
...
Процедура ЗаполнитьПоАктуОРасхожденияхСервер()
	...
	Документы.КорректировкаПоступления.ЗаполнитьТоварыПоАктуОРасхождениях(Объект);
...
Процедура ПриЧтенииСозданииНаСервере()
	...
	ПараметрыУказанияСерий = НоменклатураСервер.ПараметрыУказанияСерий(Объект, Документы.КорректировкаПоступления);
	...
	КорректировкаПоступленияУслугПрочихАктивов = (ТипЗнч(Объект.ДокументОснование) = Тип("ДокументСсылка.ПоступлениеУслугПрочихАктивов"));
	...
	Если КорректировкаПоступленияУслугПрочихАктивов Тогда
	...
	//++ НЕ УТ
	Элементы.ТоварыГруппаСчетРеглУчета.Видимость = КорректировкаПоступленияУслугПрочихАктивов;
	Элементы.РасхожденияГруппаСчетРеглУчета.Видимость = КорректировкаПоступленияУслугПрочихАктивов;
	НастройкаОтраженияВРеглУчете = Новый Структура("СчетУчета, Субконто1, Субконто2, Субконто3",
		Объект.СчетУчетаАктивов, Объект.Субконто1Активов, Объект.Субконто2Активов, Объект.Субконто3Активов);
	...
	НастройкаОтраженияВРеглУчете = Новый Структура("СчетУчета, Субконто1, Субконто2, Субконто3",
		Объект.СчетУчетаПассивов, Объект.Субконто1Пассивов, Объект.Субконто2Пассивов, Объект.Субконто3Пассивов);
	...
	Если ЗначениеЗаполнено(Объект.ДокументОснование)
		И ТипЗнч(Объект.ДокументОснование) = Тип("ДокументСсылка.ПоступлениеТоваровУслуг") Тогда
...
Функция ХозяйственнаяОперацияДокументаОснования(ДокументОснование)
	...
	Если ЗначениеЗаполнено(ДокументОснование) И ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ПоступлениеТоваровУслуг") Тогда
