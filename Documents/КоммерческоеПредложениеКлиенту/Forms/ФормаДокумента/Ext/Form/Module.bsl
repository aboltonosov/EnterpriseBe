...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// {
	СкидкиНаценкиВызовСервера.ПриСозданииФормыДокументаКоммерческоеПредложениеКлиенту(ЭтаФорма);
	// }
	// 4D
...
Процедура ТоварыВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	// 4D:ERP для Беларуси, Екатерина, 18.04.2016 17:51:24 
	// Расчет скидки к цене, №10910
	// {
...
// 4D:ERP для Беларуси, Екатерина, 12.04.2016 16:52:17 
// Расчет скидки к цене, №10910
// {
&НаКлиенте
