...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылка, ДополнительныеСвойства, Регистры = Неопределено) Экспорт
	...
	ТекстЗапросаТаблицаПланыПродаж(Запрос, ТекстыЗапроса, Регистры, ДокументСсылка);
...
Функция ТекстЗапросаТаблицаПланыПродаж(Запрос, ТекстыЗапроса, Регистры, ДокументСсылка)
	...
	Если Замещающий и СтатусЗамещения <> Неопределено Тогда
		...
		|					И ПланПродаж <> &Ссылка) КАК ПланыПродажОбороты) КАК ВложенныйЗапрос
		|
		|СГРУППИРОВАТЬ ПО
		|	ВложенныйЗапрос.ПланПродаж,
		|	ВложенныйЗапрос.Период,
...
Функция ЗапросЗамещения(Параметры) Экспорт
	...
	Запрос.Текст = 
		...
		|	ПланыПродажОбороты.Партнер,
		|	ПланыПродажОбороты.Соглашение,
		|	ПланыПродажОбороты.ФорматМагазина,
		|	ПланыПродажОбороты.Менеджер,
		...
		|				И Статус В (&Статусы)
		|				И Сценарий = &Сценарий
		|				И ФорматМагазина = &ФорматМагазина) КАК ПланыПродажОбороты";
