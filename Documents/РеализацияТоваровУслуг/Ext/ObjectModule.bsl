...
Процедура ПриЗаписи(Отказ)
	...
	//++ НЕ УТ
	РеализацииЭкспорт = Новый Массив;
	РеализацииЭкспорт.Добавить(Ссылка);
...
Процедура УстановитьПараметрыВыборочнойРегистрацииКОтражениюВРеглУчете()
	...
	ИзменилсяТолькоСостояниеПереходаПраваСобственности = Истина;
	
	Если ИзмененияДокумента.Свойство("ТабличныеЧасти") Тогда
		ИзменилсяТолькоСостояниеПереходаПраваСобственности = Ложь;
	КонецЕсли;
	...
	Если Не ИзменилсяТолькоСостояниеПереходаПраваСобственности Тогда
		Возврат;
	КонецЕсли;
