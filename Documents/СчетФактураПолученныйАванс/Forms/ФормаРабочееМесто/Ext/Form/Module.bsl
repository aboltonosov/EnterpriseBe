...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВводНаОсновании.ПриСозданииНаСервере(ЭтаФорма, Элементы.СписокСчетФактураПолученныйАвансПодменюСоздатьНаОсновании);
...
Процедура Подключаемый_ВыполнитьКомандуСоздатьНаОсновании(Команда)
	...
	ВводНаОснованииКлиент.ВыполнитьПодключаемуюКомандуСоздатьНаОсновании(Команда, ЭтаФорма, Элементы.ТаблицаСписокСчетФактураПолученныйАванс);
...
Процедура УстановитьАктуальностьГраницыРасчетов()
	...
	АналитикиРасчета.АналитикиУчетаПоПартнерам = РаспределениеВзаиморасчетов.МассивКлючейПартнеровПоОтбору(ПоляОтбора);
	
	УстановитьПривилегированныйРежим(Истина);
	НачалоРасчета = РаспределениеВзаиморасчетов.НачалоРасчетов(ПериодРасчета, АналитикиРасчета, "РасчетыСПоставщиками");
...
Процедура АктуализироватьРасчетыСервер()
	...
	АналитикиРасчета = РаспределениеВзаиморасчетов.АналитикиРасчета();
	РаспределениеВзаиморасчетов.РаспределитьВсеРасчетыСПоставщиками(КонецМесяца(КонецПериода) + 1, АналитикиРасчета);
	ЗаполнитьВыданныеАвансы();
