...
Процедура ИнициализироватьДокумент(ДанныеЗаполнения = Неопределено)
	...
	// 4D:ERP для Беларуси, Петр, 14.02.2018 16:20:45 
...
Функция ВременныеТаблицыДанныхДокумента() Экспорт
	...
	|	(ВЫБОР КОГДА ТаблицаТоваров.АналитикаУчетаНоменклатурыОприходование <> ЗНАЧЕНИЕ(Справочник.КлючиАналитикиУчетаНоменклатуры.ПустаяСсылка) ТОГДА
	|		ТаблицаТоваров.АналитикаУчетаНоменклатурыОприходование
	|	ИНАЧЕ
	|		ЕСТЬNULL(АналитикаОприходование.КлючАналитики, ЗНАЧЕНИЕ(Справочник.КлючиАналитикиУчетаНоменклатуры.ПустаяСсылка))
	|	КОНЕЦ) КАК АналитикаУчетаНоменклатурыОприходование,
	...
	|		ПО АналитикаОприходование.Номенклатура = ТаблицаТоваров.НоменклатураОприходование
	|		И АналитикаОприходование.Характеристика = ТаблицаТоваров.ХарактеристикаОприходование
	|		И АналитикаОприходование.Серия = ТаблицаТоваров.СерияОприходование
	|		И АналитикаОприходование.Назначение = ТаблицаТоваров.НазначениеОприходование
	|		И АналитикаОприходование.Склад = &Склад
	//++ НЕ УТ 
	...
	|	ПО ТаблицаВидыЗапасов.АналитикаУчетаНоменклатуры = АналитикаОприходование.КлючАналитики
	|
	|ИНДЕКСИРОВАТЬ ПО
