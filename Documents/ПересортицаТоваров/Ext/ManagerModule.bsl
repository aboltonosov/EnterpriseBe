...
Функция ПечатьАктаПересортицыТоваров(МассивОбъектов, ОбъектыПечати)
	...
	// 4D:ERP для Беларуси, Петр, 23.02.2018 16:52:35 
	// Добавление выбора валюты, № 17834
	// {
	Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.ПересортицаТоваров.ПФ_MXL_АктОПересортицеТоваров_Локализация");
	// }
	// 4D
