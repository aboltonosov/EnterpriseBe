...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаголовокКолонкиВалюта = СтрЗаменить(ЗаголовокКолонкиВалюта,"%Валюта%",ВалютаСтр);
	// }
	// 4D
...
// 4D:ERP для Беларуси, Петр, 15.02.2018 15:33:42 
// Добавление выбора валюты, № 17834
// {
&НаСервере
...
Процедура ВалютаПриИзменении(Элемент)
	...
	Элементы.ТоварыЦенаОприходование.Заголовок = ЗаголовокЦены;
