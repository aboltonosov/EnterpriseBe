...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПроверкаКонтрагентов.ПриСозданииНаСервереСписокДокументов(СписокОтчетовДавальцам);
...
Процедура УстановитьУсловноеОформление()
	...
	СтандартныеПодсистемыСервер.УстановитьУсловноеОформлениеПоляДата(ЭтотОбъект, "СписокОтчетовДавальцам.Дата", Элементы.СписокОтчетовДавальцамДата.Имя);
