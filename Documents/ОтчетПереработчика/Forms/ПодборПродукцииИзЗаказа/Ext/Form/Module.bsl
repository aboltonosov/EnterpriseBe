...
Функция ПолучитьВыбраннуюПродукцию()
	...
	Для каждого ТекущиеДанные Из ТаблицаТоваров Цикл
		...
		ДанныеПродукции = Новый Структура("Номенклатура,Характеристика,Назначение,КодСтроки,Упаковка,ТипСтоимости,
											|НомерГруппыЗатрат,ЭтапПроизводства,Цена,Сумма");
...
Процедура ЗаполнитьТаблицуТоваров()
	...
	|		И ТоварыПолученныеОтПереработчикаОстатки.Активность
	|
