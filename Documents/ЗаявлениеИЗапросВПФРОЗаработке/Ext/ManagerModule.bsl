...
Функция ПечатьЗаявления(МассивОбъектов, ОбъектыПечати)
	...
	Если ВыборкаПоШапкеДокумента.Следующий() Тогда 
		...
		СтруктураТелефона = УправлениеКонтактнойИнформацией.ПредыдущаяСтруктураКонтактнойИнформацииXML(ВыборкаПоШапкеДокумента.Телефон,	ПредопределенноеЗначение("Справочник.ВидыКонтактнойИнформации.ТелефонМобильныйФизическиеЛица"));
...
Функция ПечатьЗапроса(МассивОбъектов, ОбъектыПечати)
	...
	Если ВыборкаПоШапкеДокумента.Следующий() Тогда 
		...
		СтруктураТелефона = УправлениеКонтактнойИнформацией.ПредыдущаяСтруктураКонтактнойИнформацииXML(ВыборкаПоШапкеДокумента.ТелефонОрганизации,	ПредопределенноеЗначение("Справочник.ВидыКонтактнойИнформации.ТелефонОрганизации"));
