...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(Список, "ПроизводствоПоРаспоряжениям", НСтр("ru = 'Производство (по распоряжениям)'"));
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(Список, "ПроизводствоБезРаспоряжений", НСтр("ru = 'Производство (без распоряжений)'"));
