...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	//++ НЕ УТ
	УчетНДСУТ.ПроверитьСтатьиРасходовПоВидуДеятельностиНДС(ЭтотОбъект, "ПрочиеРасходы", "ЗакупкаПодДеятельность", Отказ);
	УчетНДСУТ.ПроверитьСтатьиАктивовПассивовПоВидуДеятельностиНДС(ЭтотОбъект, "ПрочиеРасходы", "ЗакупкаПодДеятельность", Отказ);
	//-- НЕ УТ
