...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокПоступленияТоваровУслуг.ТекстЗапроса = Документы.ЗаявлениеОВвозеТоваров.ТекстЗапросаЗаявленияОВвозеТоваров();
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Запись_ЗаявкаНаРасходованиеДенежныхСредств"
		...
		ЭтаФорма.Элементы.СписокПоступленияТоваровУслуг.Обновить();
...
Процедура СформироватьЗаявлениеОВвозеТоваров(Команда)
	...
	Список = Элементы.СписокПоступленияТоваровУслуг;
...
Процедура УстановитьУсловноеОформление()
	...
	СтандартныеПодсистемыСервер.УстановитьУсловноеОформлениеПоляДата(ЭтотОбъект, "СписокПоступленияТоваровУслуг.Дата", "СписокПоступленияТоваровУслугДата");
...
Процедура УстановитьОтборыПоОрганизации()
	...
	Элементы.СписокПоступленияТоваровУслугОрганизация.Видимость = Не ЗначениеЗаполнено(Организация);
