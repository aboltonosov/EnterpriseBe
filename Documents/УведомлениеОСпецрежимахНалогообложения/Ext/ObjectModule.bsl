...
Функция СформироватьМакетФорма_С_09_1_ФНС()
	...
	ПечатнаяФорма.ПолеСлева = 0;
	ПечатнаяФорма.ПолеСправа = 0;
	ПечатнаяФорма.КлючПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_УведомлениеОСпецрежимах_"+ВидУведомления.Метаданные().Имя+"ФНС";
...
Функция СформироватьМакетФорма_С_09_1_ПФР()
	...
	ПечатнаяФорма.ПолеСлева = 0;
	ПечатнаяФорма.ПолеСправа = 0;
	ПечатнаяФорма.КлючПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_УведомлениеОСпецрежимах_"+ВидУведомления.Метаданные().Имя+"ПФР";
...
Функция СформироватьМакетФорма_С_09_1_ФСС()
	...
	ПечатнаяФорма.ПолеСлева = 0;
	ПечатнаяФорма.ПолеСправа = 0;
	ПечатнаяФорма.КлючПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_УведомлениеОСпецрежимах_"+ВидУведомления.Метаданные().Имя+"ФСС";
...
Функция ПечатьСразуФорма_С_09_1(ПФР_ФСС = 0)
	...
	ПечатнаяФорма.ПолеСлева = 0;
	ПечатнаяФорма.ПолеСправа = 0;
	ПечатнаяФорма.КлючПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_УведомлениеОСпецрежимах_" + ВидУведомления.Метаданные().Имя;
	ПечатнаяФорма.ОбластьПечати = ПечатнаяФорма.Область();
