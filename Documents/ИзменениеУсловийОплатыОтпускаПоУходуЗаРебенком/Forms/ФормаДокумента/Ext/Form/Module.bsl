...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(Параметры.Ключ) Тогда
		...
		// 4D:ERP для Беларуси, Яна, 28.06.2017 14:51:46 
...
// 4D:ERP для Беларуси, Яна, 16.08.2017 14:36:22 
// Документ "Изменение условий оплаты отпуска по уходу за ребенком", №15091 
// {
&НаКлиенте
...
// 4D:ERP для Беларуси, Яна, 28.06.2017 14:53:05 
// Документ "Изменение условий оплаты отпуска по уходу за ребенком", №15091
...
Процедура УстановитьВидимостьРасчетныхПолей(ОбновлятьПоляНесколькихРабочихМест = Истина)
	...
	// 4D:ERP для Беларуси, Яна, 16.08.2017 14:41:32 
	// Документ "Изменение условий оплаты отпуска по уходу за ребенком", №15091
	// {
	ИменаЭлементов.Добавить("ПособиеДоТрехЛетНаВторогоРебенка");
	// }
	// 4D
...
Функция ОписаниеТаблицыНачислений() 
	...
	// 4D:ERP для Беларуси, Яна, 28.06.2017 15:05:45 
	// Документ "Изменение условий оплаты отпуска по уходу за ребенком", №15091 
	// {
	ОписаниеТаблицыВидовРасчета.ИмяПоляДляВставкиПоказателей = "НачисленияДействие";
...
Процедура ОбновитьТекущиеДанныеПособияПоУходуЗаРебенком(РеквизитыОснования = Неопределено)
	...
	// 4D:ERP для Беларуси, Яна, 16.08.2017 13:03:05 
	// Документ "Изменение условий оплаты отпуска по уходу за ребенком", №15091 
	// {
	ВыплачиватьПособиеДоТрехЛетНаВторогоРебенкаТекущее = РеквизитыОснования.ВыплачиватьПособиеДоТрехЛетНаВторогоРебенка;
	ДатаОкончанияПособияДоТрехЛетНаВторогоРебенкаТекущая = РеквизитыОснования.ДатаОкончанияПособияДоТрехЛетНаВторогоРебенка;
	ПроцентПособияДоТрехЛетТекущее = РеквизитыОснования.ПроцентПособияДоТрехЛет;
	ПроцентПособияДоТрехЛетНаВторогоРебенкаТекущее = РеквизитыОснования.ПроцентПособияДоТрехЛетНаВторогоРебенка;
	// }
	// 4D
...
Процедура ОбновитьКомментарийДанныеПособияПоУходуЗаРебенком(Форма)
	...
	// 4D:ERP для Беларуси, Яна, 16.08.2017 14:34:18 
	// Документ "Изменение условий оплаты отпуска по уходу за ребенком", №15091 
	// {
	Форма.ВыплачиватьПособиеДоТрехЛетНаВторогоРебенкаКомментарий = "";
	// }
	// 4D
	...
	// 4D:ERP для Беларуси, Яна, 16.08.2017 14:24:26 
	// Документ "Изменение условий оплаты отпуска по уходу за ребенком", №15091 
	// {
	Если Форма.Объект.ВыплачиватьПособиеДоТрехЛетНаВторогоРебенка И  
		Форма.Объект.ВыплачиватьПособиеДоТрехЛетНаВторогоРебенка <> Форма.ВыплачиватьПособиеДоТрехЛетНаВторогоРебенкаТекущее Тогда
		Форма.ВыплачиватьПособиеДоТрехЛетНаВторогоРебенкаКомментарий = Нстр("ru = 'Ранее пособие по уходу за ребенком до 3 лет на второго ребенка не выплачивалось.'");
	ИначеЕсли НЕ Форма.Объект.ВыплачиватьПособиеДоТрехЛет И
		Форма.Объект.ВыплачиватьПособиеДоТрехЛет <> Форма.ВыплачиватьПособиеДоТрехЛетТекущее Тогда
		Форма.ВыплачиватьПособиеДоТрехЛетНаВторогоРебенкаКомментарий = Нстр("ru = 'Ранее пособие по уходу за ребенком до 3 лет на второго ребенка выплачивалось.'");
	ИначеЕсли Форма.Объект.ВыплачиватьПособиеДоТрехЛетНаВторогоРебенка И
		Форма.Объект.ВыплачиватьПособиеДоТрехЛетНаВторогоРебенка = Форма.ВыплачиватьПособиеДоТрехЛетНаВторогоРебенкаТекущее Тогда	
		Если Форма.Объект.ДатаОкончанияПособияДоТрехЛетНаВторогоРебенка <> Форма.ДатаОкончанияПособияДоТрехЛетНаВторогоРебенкаТекущая Тогда
			ВыплачиватьПособиеДоТрехЛетНаВторогоРебенкаКомментарий = Нстр("ru = 'Предыдущая дата окончания выплаты пособия до 3 лет на второго ребенка - %1'");
			Форма.ВыплачиватьПособиеДоТрехЛетНаВторогоРебенкаКомментарий = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ВыплачиватьПособиеДоТрехЛетНаВторогоРебенкаКомментарий, Формат(Форма.ДатаОкончанияПособияДоТрехЛетНаВторогоРебенкаТекущая,"ДЛФ=D"));
		КонецЕсли;
	КонецЕсли;
	// }
	// 4D
