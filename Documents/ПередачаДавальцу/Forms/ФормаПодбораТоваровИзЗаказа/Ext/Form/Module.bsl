...
Процедура ПеренестиТоварыВДокумент()
	...
	ПоместитьТаблицуВыбранныхТоваровВоВременноеХранилище(Отказ, АдресТоваровВХранилище);
...
&НаСервере
Процедура ПоместитьТаблицуВыбранныхТоваровВоВременноеХранилище(Отказ, АдресТоваровВХранилище = "")
...
Процедура ОбновитьИнформациюПоЗаказам(ТоварыРеализации)
	...
	ПараметрыОбновления.ПутьЗаказаВШапке                  = "ЗаказДавальца";
