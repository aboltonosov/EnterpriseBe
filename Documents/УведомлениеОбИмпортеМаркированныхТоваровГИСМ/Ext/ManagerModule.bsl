...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|	УведомлениеОбИмпортеМаркированныхТоваровГИСМТовары.НомерСтроки         КАК НомерСтроки
	|ИЗ
	...
	Пока ВыборкаИтоги.Следующий() Цикл
		...
		ВыборкаВерсияДанных = ВыборкаИтоги.Выбрать();
		Пока ВыборкаВерсияДанных.Следующий() Цикл
			...
			Попытка
				...
				ВыборкаДетали = ВыборкаВерсияДанных.Выбрать();
				...
				Если ЕстьИзменения Тогда
					ОбновлениеИнформационнойБазы.ЗаписатьОбъект(УведомлениеОбИмпортеОбъект,,,РежимЗаписиДокумента.Запись);
				Иначе
					ОтменитьТранзакцию();
					СоответствиеОбработанныхОбъектов.Вставить(ВыборкаИтоги.Ссылка);
					Продолжить;
