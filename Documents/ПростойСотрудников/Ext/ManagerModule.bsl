...
Функция РеквизитыДляПроведения(ДокументСсылка)
	...
	|	ПростойСотрудников.ЧасыПростоя,
	|	ПростойСотрудников.ИсправленныйДокумент
	|ИЗ
	|	Документ.ПростойСотрудников КАК ПростойСотрудников
	|ГДЕ
	...
	|	ПростойСотрудниковНачисления.ПериодРегистрацииНормыВремени,
	|	ПростойСотрудниковНачисления.ГрафикРаботыНорма,
	|	ПростойСотрудниковНачисления.ОбщийГрафик,
...
Функция РеквизитыДляПроведенияПустаяСтруктура()
	...
	| ПланируемаяДатаВыплаты, Начисление, ВидПростоя, ДатаПростоя, ВидВремениЗамещаемый, ЧасыПростоя, РаспределениеПоТерриториямУсловиямТруда, Начисления, ИсправленныйДокумент");	
...
Процедура ЗарегистрироватьВнутрисменныеОтклонения(Движения, РеквизитыДляПроведения)
	...
	ЗарегистрироватьСторноЗаписиУчетаВремени(Движения, Сотрудники, РеквизитыДляПроведения.ПериодРегистрации, РеквизитыДляПроведения.ИсправленныйДокумент);
