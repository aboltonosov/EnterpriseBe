...
Процедура НачисленияПерерасчетНачислениеПриИзменении(Элемент)
	...
	// 4D:ERP для Беларуси, Яна, 17.07.2017 17:02:03 
	// Ошибка документа "Простой сотрудников", №15213 
	// {
	ЗарплатаКадрыРасширенныйКлиент.ПериодНачисленияОбработкаПериодаПриИзмененииНачисления(ЭтаФорма, ТекущийЭлемент.ТекущиеДанные, ОписаниеДокумента(ЭтаФорма), ОписаниеТаблицыВидовРасчета);
	// }
	// 4D
...
Процедура ДополнитьФорму()
	...
	// Ошибка документа "Простой сотрудников", №15213 
	// {
	ЗарплатаКадрыРасширенный.ПериодНачисленияДополнитьФорму(ЭтаФорма, МассивОписанийТаблицФормы(РегистрацияНачисленийДоступна));
	// }
	// 4D
...
Процедура ЗарегистрироватьДанныеОВремени(Знач Сотрудники = Неопределено)
	...
	// 4D:ERP для Беларуси, Яна, 17.07.2017 17:00:59 
	// Ошибка документа "Простой сотрудников", №15213 
	// {
	УстановитьПривилегированныйРежим(Истина);
	
	Движения.РабочееВремяСотрудников.Записать();
