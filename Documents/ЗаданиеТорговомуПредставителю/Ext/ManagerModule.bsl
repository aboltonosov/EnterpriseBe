...
//	 КомандыСоздатьНаОсновании - Команда, которая была добавлена.
//
...
Функция ЗаполнитьИменаРеквизитовПоХозяйственнойОперации(ХозяйственнаяОперация, МассивВсехРеквизитов, МассивРеквизитовОперации) Экспорт
	...
	// 4D:ERP для Беларуси, Екатерина, 21.04.2016 11:21:58 
	// Расчет скидки к цене, №10910
	// {
	Если Не ПолучитьФункциональнуюОпцию("ПрименятьСкидкиКЦене") Тогда 
