...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// {
	СкидкиНаценкиВызовСервера.ПриСозданииФормыДокументаЗаданиеТорговомуПредставителю(ЭтаФорма);
	// }
	// 4D
...
Процедура ТоварыВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	// 4D:ERP для Беларуси, Екатерина, 18.04.2016 13:23:46 
	// Расчет скидки к цене, №10910
	// {
	Если Поле = Элементы.ТоварыЦена ИЛИ Поле = Элементы.ТоварыЦенаСоСкидкой Тогда
	// }
	// 4D
...
// 4D:ERP для Беларуси, Екатерина, 12.04.2016 17:02:59 
// Расчет скидки к цене, №10910
// {
&НаКлиенте
Процедура ТоварыЦенаСоСкидкойПриИзменении(Элемент)
	...
	СтруктураДействий.Вставить("ПересчитатьСумму");
	СтруктураДействий.Вставить("ЗаполнитьДубликатыЗависимыхРеквизитов", ЗависимыеРеквизиты());
	СтруктураДействий.Вставить("ПересчитатьПроцентРучнойСкидкиВПродажах", СтруктураПараметров);
