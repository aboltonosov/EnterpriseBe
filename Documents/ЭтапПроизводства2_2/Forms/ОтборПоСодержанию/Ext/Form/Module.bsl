...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Подразделение", Подразделение)
		...
		УстановитьСвязьПараметраВыбора("Бригада", "Отбор.Подразделение", "Подразделение");
	...
	Если Параметры.Свойство("СтруктураОтбораПоДаннымЭтапа", СтруктураОтбораПоДаннымЭтапа)
		...
		СтруктураОтбораПоДаннымЭтапа.Свойство("Бригада", Бригада);
...
Функция УстановленныеОтборы()
	...
	Результат.Вставить("ИспользуетсяОтборПоБригаде", НЕ Бригада.Пустая());
	Результат.Вставить("Бригада", Бригада);
