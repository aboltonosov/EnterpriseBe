...
#Область ЗакупкаЦенности                    // (Дт 10, 41 :: Кт 60, 71, 76)
	...
	|
	// Сумма
	|	ВЫБОР КОГДА Операция.ЗакупкаПодДеятельность В (ЗНАЧЕНИЕ(Перечисление.ТипыНалогообложенияНДС.ПродажаОблагаетсяНДС),
	...
	|												   ЗНАЧЕНИЕ(Перечисление.ТипыНалогообложенияНДС.ВводОСВЭксплуатацию)) ТОГДА
...
#КонецОбласти
	...
	+ " ОБЪЕДИНИТЬ ВСЕ " + ЗакупкаЦенностиСкладПроизводства
...
Процедура ЗаполнитьПараметрыИнициализации(Запрос, ДокументСсылка)
	...
	// 4D:ERP для Беларуси, Дмитрий, 07.10.2017 13:37:08 
...
Функция ТекстЗапросаТаблицаРеестрДокументов(Запрос, ТекстыЗапроса, Регистры)
	...
	// 4D:ERP для Беларуси, Дмитрий, 07.10.2017 13:33:35 
	// Серия в реестре документов
	// {
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	// 4D:ERP для Беларуси, Михаил, 12.12.2017 8:44:59 
	// Печать Авансового отчета из документа ПТиУ, №17080
	// {
