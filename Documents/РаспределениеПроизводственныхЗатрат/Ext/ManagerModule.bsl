...
#Область ТекстСписаниеМатериаловНаРасходы          // (Дт 08, 25, 26, 44, 91.02 :: Кт 20, 23)
	...
	|	ЗНАЧЕНИЕ(ПланСчетов.Хозрасчетный.ПустаяСсылка) КАК СчетДт,
	|
	|	ВЫБОР // 4D:ERP для Беларуси, Алексей, Временная замена до обновления на 2.4 релиз
	...
	|ГДЕ // 4D:ERP для Беларуси, Алексей, Временная замена до обновления на 2.4 релиз 
