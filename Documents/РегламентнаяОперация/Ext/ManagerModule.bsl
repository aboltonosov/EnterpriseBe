...
#КонецОбласти
	...
	Возврат 
		ТекстСписаниеКосвенныхРасходовОСНО
		+ " ОБЪЕДИНИТЬ ВСЕ " + ТекстСписаниеКосвенныхРасходовЕНВД
		+ " ОБЪЕДИНИТЬ ВСЕ " + ТекстНачислениеИмущественныхНалогов
		+ " ОБЪЕДИНИТЬ ВСЕ " + ТекстНачислениеТорговогоСбора
		+ " ОБЪЕДИНИТЬ ВСЕ " + ТекстРегистрацияПрочихРасходов
		+ " ОБЪЕДИНИТЬ ВСЕ " + ТекстКорректировкиАмортизацииПоАренднымПлатежамНУ;
