...
Функция ТаблицыДанныхДокументаДляПечати(Ссылка)
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	СправкаНДФЛУведомленияНОоПравеНаВычеты.Ссылка,
	|	СправкаНДФЛУведомленияНОоПравеНаВычеты.НомерСтроки,
	|	СправкаНДФЛУведомленияНОоПравеНаВычеты.Ссылка.Номер КАК НомерСправки,
	|	СправкаНДФЛУведомленияНОоПравеНаВычеты.Ссылка.Сотрудник,
	|	СправкаНДФЛУведомленияНОоПравеНаВычеты.ДатаУведомления,
	|	СправкаНДФЛУведомленияНОоПравеНаВычеты.НомерУведомления,
	|	СправкаНДФЛУведомленияНОоПравеНаВычеты.КодНалоговогоОрганаУведомления,
	|	СправкаНДФЛУведомленияНОоПравеНаВычеты.ГруппаВычета
	|ИЗ
