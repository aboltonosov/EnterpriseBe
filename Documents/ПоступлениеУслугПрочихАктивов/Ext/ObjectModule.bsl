...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	//++ НЕ УТ
	УчетНДСУТ.ПроверитьСтатьиРасходовПоНалогообложениюНДС(ЭтотОбъект, "Расходы", "НалогообложениеНДС", Отказ);
	УчетНДСУТ.ПроверитьСтатьиРасходовПоВидуДеятельностиНДС(ЭтотОбъект, "Расходы", "ЗакупкаПодДеятельность", Отказ);
	УчетНДСУТ.ПроверитьСтатьиАктивовПассивовПоВидуДеятельностиНДС(ЭтотОбъект, "Расходы", "ЗакупкаПодДеятельность", Отказ);
	//-- НЕ УТ
...
Процедура ЗаполнитьДокументНаОснованииДанныхПереработчика(ДокументОснование)
	...
	|	ЗаказПереработчику.Менеджер,
	|	ЗаказПереработчику.Контрагент,
	|	ЗаказПереработчику.Партнер,
	|	ЗаказПереработчику.Договор,
