...
Процедура ЗаполнитьПараметрыИнициализации(Запрос, ДокументСсылка)
	...
	Если ЗначениеЗаполнено(Реквизиты.СкладОтправитель) Тогда
		...
		ИнформацияПоСкладуОтправителю = СтрЗаменить(ИнформацияПоСкладуОтправителю, "%СкладОтправитель", Реквизиты.СкладОтправитель);
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(Реквизиты.СкладПолучатель) Тогда
		...
		ИнформацияПоСкладуПолучателю = СтрЗаменить(ИнформацияПоСкладуПолучателю, "%СкладПолучатель", Реквизиты.СкладПолучатель);
	КонецЕсли;
...
Функция ТекстЗапросаТаблицаРеестрДокументов(Запрос, ТекстыЗапроса, Регистры)
	...
	|			ЛЕВОЕ СОЕДИНЕНИЕ Документ.АктОРасхожденияхПослеПеремещения.Товары КАК ТоварыДокумента
