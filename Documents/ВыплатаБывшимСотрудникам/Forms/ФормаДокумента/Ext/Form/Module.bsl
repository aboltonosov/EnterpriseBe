...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	КодДоходаНДФЛ = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ТекущийОбъект.ВидВыплаты, "КодДоходаНДФЛ");
...
Функция НДФЛиВзносыБывшегоСотрудника(Знач Объект, Знач НомерСтроки)
...
Процедура РассчитатьНДФЛиВзносыВСтроке(ИдентификаторСтроки)
	...
	Иначе
		...
		Иначе
			...
			Результат = НДФЛиВзносыБывшегоСотрудника(Объект, ДанныеСтроки.НомерСтроки);
			ЗаполнитьЗначенияСвойств(ДанныеСтроки, Результат.Получить(ДанныеСтроки.ФизическоеЛицо));
