...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Идентификатор = "ПФ_MXL_Т9_Локализация"; 	
	...
	// 4D:ERP для Беларуси, Юлия, 30.11.2017 10:38:43 
	// Редактировать форму списка док-та Командировка, № 16915
	// {
	// Командировочное удостоверение (Т-10).
	КомандаПечати = КомандыПечати.Добавить();
	КомандаПечати.Обработчик = "ЗарплатаКадрыКлиент.ВыполнитьКомандуПечати";
	КомандаПечати.МенеджерПечати = "Обработка.ПечатьКадровыхПриказовРасширенная";
	КомандаПечати.Идентификатор = "ПФ_MXL_Т10_Локализация";
	...
	КомандаПечати.Обработчик = "ЗарплатаКадрыКлиент.ВыполнитьКомандуПечати";
	КомандаПечати.МенеджерПечати = "Обработка.ПечатьКадровыхПриказовРасширенная";
	КомандаПечати.Идентификатор = "ПФ_MXL_Т10а_Локализация";
...
Функция РеквизитыДляПроведения(ДокументСсылка)
	...
	|	Командировка.РасчетДенежногоСодержания,
