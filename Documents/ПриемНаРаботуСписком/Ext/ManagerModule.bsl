...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	Если Пользователи.РолиДоступны("ДобавлениеИзменениеДанныхДляНачисленияЗарплаты,ЧтениеДанныхДляНачисленияЗарплаты", , Ложь) Тогда
		...
		// 4D:ERP для Беларуси, Юлия, 08.09.2017 14:14:51 
		...
		КомандаПечати.Представление = НСтр("ru = 'Приказ о приеме на работу (списком)'");
	...
	Если Пользователи.РолиДоступны("ДобавлениеИзменениеКадровогоСостоянияРасширенная,ЧтениеКадровогоСостоянияРасширенная", , Ложь) Тогда
		...
		// 4D:ERP для Беларуси, Юлия, 08.09.2017 14:15:04 
		// Изменить список печатных форм, доступных в док-те "Прием на работу списком", № 15984
		// {		
		// Трудовой договор
		КомандаПечати = КомандыПечати.Добавить();
	...
	// 4D:ERP для Беларуси, Юлия, 08.09.2017 14:15:25 
	// Изменить список печатных форм, доступных в док-те "Прием на работу списком", № 15984
	// {	
