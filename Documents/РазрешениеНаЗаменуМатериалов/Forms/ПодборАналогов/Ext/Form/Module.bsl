...
Процедура УстановитьТекстЗапросаДинамическихСписков()
	...
	ТекстЗапросаДляПолученияСклада = ПроизводствоСервер.ТекстЗапросаНастройкиПередачиМатериалов(
										"РазрешениеНаЗаменуМатериалы", 
										"&Подразделение",
										Параметры.ИспользоватьПроизводство2_2);
										
	Материалы.ТекстЗапроса = СтрЗаменить(
								Материалы.ТекстЗапроса, 
								"&ТекстПолеСклад", 
	...
	ТекстЗапросаДляПолученияСклада = ПроизводствоСервер.ТекстЗапросаНастройкиПередачиМатериалов(
										"РазрешениеНаЗаменуАналоги", 
										"&Подразделение",
										Параметры.ИспользоватьПроизводство2_2);
										
	Аналоги.ТекстЗапроса = СтрЗаменить(
								Аналоги.ТекстЗапроса, 
								"&ТекстПолеСклад", 
								ТекстЗапросаДляПолученияСклада.ТекстПолеСклад);
