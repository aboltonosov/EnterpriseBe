...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не ВнеоборотныеАктивыПовтИсп.ТребуетсяНастройкаОтраженияРасходовПоНалогам(ГруппаОС) Тогда
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Документы.ПринятиеКУчетуОС.СформироватьЗаданияКЗакрытиюМесяца(
...
Процедура ЗаполнитьНаОснованииОбъектаЭксплуатации(Основание)
	...
	|	ОбъектыЭксплуатации.Код КАК ИнвентарныйНомер,
	|	ОбъектыЭксплуатации.ГруппаОС,
	|	ОбъектыЭксплуатации.АмортизационнаяГруппа
	|ИЗ
