...
Процедура ОбработатьПодборБСО(Адрес)
	...
	УчетБланковСтрогойОтчетностиСервер.НайтиДобавитьСтрокиБСО(ПолныйОбъект, Адрес, "Товары", Ложь);
...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если ПараметрыЗаписи.РежимЗаписи = РежимЗаписиДокумента.Проведение Тогда
		...
		Если Объект.РежимИспользованияБСО Тогда
			...
			СтруктураВозврата = УчетБланковСтрогойОтчетностиСервер.ПроверитьВозможностьСписанияБСО(Объект.Склад, Объект.Товары, Объект.Дата, ИмяФормы);
