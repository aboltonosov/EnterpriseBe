...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	+ " ОБЪЕДИНИТЬ ВСЕ " + ТекстВозвратСебестоимостиПретензии()
	+ " ОБЪЕДИНИТЬ ВСЕ " + ТекстВозвратСебестоимостиПретензииПоСкладуПроизводства()
	+ " ОБЪЕДИНИТЬ ВСЕ " + ТекстВозвратНДСПретензии()
	+ " ОБЪЕДИНИТЬ ВСЕ " + ТекстПереносПретензииНаРасчеты()
	+ " ОБЪЕДИНИТЬ ВСЕ " + ТекстОтклонениеВСтоимостиРасходы()
	+ " ОБЪЕДИНИТЬ ВСЕ " + ТекстОтклонениеВСтоимостиРасходыНаСкладеПроизводства()
	+ " ОБЪЕДИНИТЬ ВСЕ " + ТекстОтклонениеВСтоимостиДоходы()
	+ " ОБЪЕДИНИТЬ ВСЕ " + ТекстОтклонениеВСтоимостиДоходыНаСкладеПроизводства()
...
Функция ТекстВозвратНДСПретензии()
	...
	|	ЗНАЧЕНИЕ(Справочник.НаправленияДеятельности.ПустаяСсылка) КАК НаправлениеДеятельностиКт,
	|
	// 4D:ERP для Беларуси, ВладимирР, 08.09.2016 10:27:03 
	// Проводки по возврату товаров поставщику, №12449
	// {
...
Функция ПолучитьДанныеДляПечатнойФормыТОРГ12(ПараметрыПечати, МассивОбъектов) Экспорт
	...
	// {
	|	ВозвратТоваровПоставщику.НомерИсходящегоДокумента КАК НомерИсходящегоДокумента,
	|	ВозвратТоваровПоставщику.СерияИсходящегоДокумента КАК СерияИсходящегоДокумента,
	|	ВозвратТоваровПоставщику.Отпустил КАК Отпустил,
	|	ВозвратТоваровПоставщику.ОтпустилДолжность КАК ОтпустилДолжность,
	|	ВозвратТоваровПоставщику.Руководитель.Наименование КАК Разрешил,
	|	ВозвратТоваровПоставщику.Руководитель.Должность КАК РазрешилДолжность,
	|	ВозвратТоваровПоставщику.Принял КАК Принял,
	|	ВозвратТоваровПоставщику.ПереданыДокументы КАК ПереданыДокументы,
	// }
	// 4D
	|	ВозвратТоваровПоставщику.Ссылка КАК Ссылка,
	|	ВозвратТоваровПоставщику.Номер КАК Номер,
...
// - заполняет реквизит "Порядок оплаты" документа "ВозвратТоваровПоставщику";
...
// заполняет реквизит "Порядок оплаты" в документе.
