...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	// 4D:ERP для Беларуси, Дмитрий, 06.04.2017 10:07:37 
	// ЭСЧФ
	// {
	// Отключаем формирование ЭСЧФ для этого документа
	// }
	// 4D
...
Процедура ЗаполнитьДокументНаОснованииПоступленияТоваровИУслуг(Знач ДокументОснование)
	...
	Запрос = Новый Запрос(
		...
		// Учет бланков строгой отчетности, №10038
		// {
		|	ПоступлениеТоваровУслуг.РежимИспользованияБСО КАК РежимИспользованияБСО,
		// }
		// 4D
		...
		|	ПоступлениеТоваровУслуг.ПорядокОплаты КАК ПорядокОплаты
		|ИЗ
		|	Документ.ПоступлениеТоваровУслуг КАК ПоступлениеТоваровУслуг
		|ГДЕ
		|	ПоступлениеТоваровУслуг.Ссылка = &ДокументОснование
