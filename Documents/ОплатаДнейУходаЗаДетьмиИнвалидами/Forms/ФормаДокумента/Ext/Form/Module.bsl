...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	Оповестить("Запись_ОплатаДнейУходаЗаДетьмиИнвалидами", Объект.Ссылка);
...
Процедура ЗаполнитьНастройкиМенеджераРасчета(МенеджерРасчета, СохранятьИсправления = Истина)
	...
	МенеджерРасчета.НастройкиРасчета.РассчитыватьНачисления = Ложь;
...
Процедура УстановитьВидимостьУдержаний(Форма)
	...
	// 4D:ERP для Беларуси, Юлия, 12.12.2017 14:43:52 
