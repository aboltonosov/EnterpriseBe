...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// 4D:ERP для Беларуси, Яна, 16.06.2017 11:03:27 
...
// 4D:ERP для Беларуси, Яна, 16.06.2017 12:40:55 
// Документ "Назначение подработки" добавить возможность просмотра движений по регистрам, №15166 
// {
...
Функция ДанныеДолжности(Перезаполнить = Ложь)
	...
	Если Перезаполнить Или ДанныеДолжности = Неопределено Тогда
		...
		КадровыйУчетФормыРасширенный.УстановитьДанныеДолжностиВФорме(
			ЭтаФорма, ВремяРегистрации, Объект.Должность, Объект.ДолжностьПоШтатномуРасписанию);
