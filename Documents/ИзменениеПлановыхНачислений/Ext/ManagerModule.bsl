...
Функция НачисленияПоказателиСотрудниковПоОбъекту(ДокументОбъект, ФильтрСотрудников = Неопределено, ИспользоватьФильтрПоНачислениям = Истина) Экспорт
	...
	Если НЕ ДокументОбъект.ЭтоОтражениеИзмененияШтатногоРасписания 
		...
		ПараметрыПолучения.Вставить("ИспользоватьФильтрПоНачислениям", ИспользоватьФильтрПоНачислениям);
