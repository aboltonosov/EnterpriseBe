...
Процедура ЗаполнитьПараметрыИнициализации(Запрос, ДокументСсылка, ДополнительныеСвойства)
	...
	|			ИСТИНА КАК Поле1
	|		ИЗ
	|			Документ.ИзменениеПараметровОС.ОтражениеАмортизационныхРасходов КАК ИзменениеПараметровОСОтражениеАмортизационныхРасходов
	|		ГДЕ
	|			ИзменениеПараметровОСОтражениеАмортизационныхРасходов.Ссылка = &Ссылка
	|			И ИзменениеПараметровОСОтражениеАмортизационныхРасходов.СтатьяРасходовНалог <> ЗНАЧЕНИЕ(ПланВидовХарактеристик.СтатьиРасходов.ПустаяСсылка)) КАК ЗаполнитьСпособыОтраженияРасходовПоИмущественнымНалогам
	|ИЗ
	...
	Запрос.УстановитьПараметр("НазваниеДокумента", НСтр("ru='Изменение параметров ОС'"));
...
Процедура СпособыОтраженияРасходовПоИмущественнымНалогам(ТекстыЗапроса, Регистры)
	...
	|					ТаблицаОС.ОсновноеСредство
	|				ИЗ
	|					ТаблицаОС КАК ТаблицаОС)) КАК ПервоначальныеСведенияОС
	|	ПО
	|		ТаблицаОС.ОсновноеСредство = ПервоначальныеСведенияОС.ОсновноеСредство
	|ГДЕ
	|	&ОтражениеАмортизационныхРасходовФлаг
	|	И &ЗаполнитьСпособыОтраженияРасходовПоИмущественнымНалогам
	|	И НЕ ПервоначальныеСведенияОС.АмортизационнаяГруппа В (
...
Функция ТекстЗапросаВТОтраженияВРеглУчете() Экспорт
	...
	Возврат УчетОСВызовСервера.ТекстЗапросаВТОтраженияВРеглУчетеНачисленнойАмортизации("ИзменениеПараметровОС")
