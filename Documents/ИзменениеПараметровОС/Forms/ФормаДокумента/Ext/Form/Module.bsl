...
Процедура ЗаполнитьТекущиеЗначенияРеквизитов(ЗаполнитьДоступность=Ложь)
	...
	Запрос = Новый Запрос(
		...
		|			ТОГДА ИСТИНА
		|		ИНАЧЕ ЛОЖЬ
		|	КОНЕЦ КАК ЗапрещеноЗаполнениеРеквизитовНалог,
		...
		|	МАКСИМУМ(ТекущиеДанные.ЗапрещеноЗаполнениеРеквизитовНалог) КАК ЗапрещеноЗаполнениеРеквизитовНалог,
	...
	Если Не Результат[3].Пустой() Тогда
		...
		ТребуетсяЗаполнениеРеквизитовНалог = Выборка.ТребуетсяЗаполнениеРеквизитовНалог = Истина И Выборка.ЗапрещеноЗаполнениеРеквизитовНалог = Ложь;
		ЗапрещеноЗаполнениеРеквизитовНалог = Выборка.ЗапрещеноЗаполнениеРеквизитовНалог;
...
Процедура УстановитьВидимостьРеквизитовОтраженияРасходов()
	...
	Элементы.ГруппаАмортизация.ОтображатьВШапке = ТребуетсяЗаполнениеРеквизитовПремии Или НЕ ЗапрещеноЗаполнениеРеквизитовНалог;
	Элементы.ГруппаПремия.Видимость = ТребуетсяЗаполнениеРеквизитовПремии;
	Элементы.ГруппаНалог.Видимость = НЕ ЗапрещеноЗаполнениеРеквизитовНалог;
