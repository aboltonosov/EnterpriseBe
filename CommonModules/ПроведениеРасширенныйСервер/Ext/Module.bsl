...
Процедура ПодготовитьНаборыЗаписейКРегистрацииДвиженийПоВидамУчета(РежимПроведения, ДокументСсылка, СтруктураВидовУчета, ВидыУчетов = Неопределено, Движения = Неопределено, Объект = Неопределено, Отказ = Ложь, ПризнакИсправлениеПериодическихСведений = Ложь) Экспорт
	...
	Если Объект <> Неопределено И ВидыУчетов = Неопределено Тогда
		...
		Если ПризнакИсправлениеПериодическихСведений Тогда
