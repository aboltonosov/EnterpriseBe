...
Функция ОписаниеСпособовВыплатыЗарплатыПоУмолчанию() Экспорт
	...
	НаименованияМежрасчетныхВыплат.Вставить(Перечисления.ВидыДокументовМежрасчетныхНачислений.ВозвратНДФЛ,						НСтр("ru = 'Возврат НДФЛ'"));
	НаименованияМежрасчетныхВыплат.Вставить(Перечисления.ВидыДокументовМежрасчетныхНачислений.ЕдиновременноеПособиеЗаСчетФСС,	НСтр("ru = 'Единовременные пособия за счет ФСС'"));
