...
// Возвращает тип сообщения {http://www.1c.ru/1cFresh/Tariff/App/a.b.c.d}ServiceProvider.
//
// Параметры:
//  ИспользуемыйПакет - строка, пространство имен версии интерфейса сообщений, для которой
//    получается тип сообщения.
...
// Возвращает тип сообщения {http://www.1c.ru/1cFresh/Tariff/App/a.b.c.d}Service.
//
// Параметры:
//  ИспользуемыйПакет - строка, пространство имен версии интерфейса сообщений, для которой
//    получается тип сообщения.
