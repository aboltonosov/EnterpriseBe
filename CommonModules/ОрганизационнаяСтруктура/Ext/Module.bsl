...
// Записывает для указанной позиции штатного расписания принадлежность к структуре предприятия.
//
...
Процедура УстановитьПараметрыВыбораУправленческойОрганизацииПоЭлементу(Форма, ИмяЭлемента, ЭлементФормы = Неопределено) Экспорт
...
Процедура УстановитьПараметрыВыбораУправленческойОрганизации(Форма, СоздатьЭлементы = Истина) Экспорт
	...
	Если ЭлементФормы <> Неопределено Тогда
		УстановитьПараметрыВыбораУправленческойОрганизацииПоЭлементу(Форма, ЭлементФормы.Имя, ЭлементФормы);
	КонецЕсли;
...
Процедура ОбработкаПолученияДанныхВыбораОрганизаций(ДанныеВыбора, Параметры, СтандартнаяОбработка) Экспорт 
	...
	Если Параметры.Свойство("ПоказыватьУправленческуюОрганизацию") Тогда
		ПоказыватьУправленческуюОрганизацию = Параметры.ПоказыватьУправленческуюОрганизацию;
	КонецЕсли;
...
Процедура ДополнитьФормуДокументаОтражениеЗарплатыВБухучете(Форма) Экспорт 
	...
	Если Не ИспользуетсяОбменУправлениеПредприятием2() Тогда 
		Возврат;
	КонецЕсли;
...
Процедура УточнитьТипСтруктураПредприятия(ТипСтруктураПредприятия) Экспорт
