...
Процедура ОбновитьДеревоСохраненныхЭлементов(Форма, Параметры) Экспорт
	...
	ФинОтчеты.НовоеПолеВыбора(НастройкиКД,"СвязанныйЭлемент.[Счет плана счетов]", НСтр("ru = 'Счет плана счетов'"));
	ФинОтчеты.НовоеПолеВыбора(НастройкиКД,"СвязанныйЭлемент.[Тип итога]", НСтр("ru = 'Тип итога'"));
	ФинОтчеты.НовоеПолеВыбора(НастройкиКД,"СвязанныйЭлемент.[Начальное сальдо]", НСтр("ru = 'Начальное сальдо'"));
	ФинОтчеты.НовоеПолеВыбора(НастройкиКД,"СвязанныйЭлемент.[Немонетарный показатель]", НСтр("ru = 'Немонетарный показатель'"));
	ФинОтчеты.НовоеПолеВыбора(НастройкиКД,"СвязанныйЭлемент.[Выводить заголовок элемента]", НСтр("ru = 'Выводить заголовок элемента'"));
...
Процедура ДобавитьИзмеренияВДеревоНовыхЭлементов(ДеревоЭлементов, ВидПоказателей, БыстрыйПоиск)
	...
	Если Справочники.НаправленияДеятельности.ИспользуетсяУчетПоНаправлениям() Тогда
		ДобавитьСтрокуИзмерения(СтрокаИзмерения, "Направление деятельности",,"Направление деятельности");
	КонецЕсли;
