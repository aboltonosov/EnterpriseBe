...
//  НеСоздаватьWSПрокси - Булево - не создавать объект доступа к веб-сервису.
//
// Возвращаемое значение:
//  Структура:
...
//                                     Неопределено - если НеСоздаватьWSПрокси равно Истина.
//  Неопределено                   - ошибка или недостаточно прав.
//
Функция НастройкиОбменаФССЭЛН(Организация, НеСоздаватьWSПрокси = Ложь) Экспорт
	...
	Возврат КонтекстЭДОСервер.СерверПриемаОтчетностиФССЭЛН(ИспользоватьТестовыйСервер, НеСоздаватьWSПрокси);
