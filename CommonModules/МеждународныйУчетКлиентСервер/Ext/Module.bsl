...
//
// Параметры:
//  Приемник - ДанныеФормыДерево - дерево приеник.
//  Источник - ДанныеФормыДерево - дерево истоничк.
//  ВключатьПодчиненные - Булево - Истина, если необходимо рекурсивно копирвать элементы низлежащих уровней дерева.
//
...
// Ищет в дререве значений заданное значение в заданой колонке дерева.
//
// Параметры:
//  ДанныеФормыДерево - ДанныеФормыДерево - дерево значений.
//  ЗначениеРеквизита - Произвольный - искомое значение.
//  ИмяРеквизита - Строка - имя реквизита дерева значение котороо необходимо найти.
