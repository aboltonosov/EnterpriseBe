...
Процедура ПроверитьФИО(ДанныеФизическогоЛица, ПравилоПроверки, Ошибки, Отказ, НомерСтроки)
	...
	Иначе
		...
		// 4D:ERP для Беларуси, Дмитрий, 11.09.2017 5:49:13 
		// Страна Беларусь
		// {
		Если СтранаГражданства = Справочники.СтраныМира.Россия ИЛИ СтранаГражданства = Справочники.СтраныМира.Беларусь Тогда
		// }
		// 4D
