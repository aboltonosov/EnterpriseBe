...
Процедура ПроверитьФоновыеЗадания() Экспорт
	...
	ИмяЗаданияРасчетовСКлиентами = РаспределениеВзаиморасчетов.ИмяФоновогоЗаданияРасчетовСКлиентами();
	ИмяЗаданияРасчетовСПоставщиками = РаспределениеВзаиморасчетов.ИмяФоновогоЗаданияРасчетовСПоставщиками();
