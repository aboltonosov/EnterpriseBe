...
//
// Параметры:
//  ИмяПеречисления - Строка - Имя перечисления, для которого требуется получить структуру со значениями.
//
// Возвращаемое значение:
...
Процедура ПолучитьСведенияОПоказателяхОтчетаТранспортныйНалогФормаОтчета2016Кв1(ПоказателиОтчета) Экспорт
	...
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П000020026003_Ставка", Истина, Ложь);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П000020028003", Ложь, Ложь);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П000020029003", Ложь, Ложь);
...
Функция ОписаниеПутиВИнтерфейсеКРегистрацииТранспортныхСредств()
	...
	Результат = НСтр("ru = '(меню ""Регламентированный учет"" - ""Регистрация транспортных средств"")'");
...
Функция ОписаниеПутиВИнтерфейсеКРегистрацииЗемельныхУчастков()
	...
	Результат = НСтр("ru = '(меню ""Регламентированный учет"" - ""Регистрация земельных участков"")'");
