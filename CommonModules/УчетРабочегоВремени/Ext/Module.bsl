...
Процедура СоздатьВТРабочееСотрудниковВремяПоИнтервалам(МенеджерВременныхТаблиц, ДатаАктуальности) Экспорт
	...
	УчетРабочегоВремениВнутренний.СоздатьВТРабочееСотрудниковВремяПоИнтервалам(МенеджерВременныхТаблиц, ДатаАктуальности);
...
Процедура ОбработкаПолученияДанныхВыбораСправочникаВидыИспользованияРабочегоВремени(ДанныеВыбора, Параметры, СтандартнаяОбработка) Экспорт
	...
	УчетРабочегоВремениВнутренний.ОбработкаПолученияДанныхВыбораСправочникаВидыИспользованияРабочегоВремени(ДанныеВыбора, Параметры, СтандартнаяОбработка);
...
Функция ДанныеОбОрганизацииПодразделенииДляТ13() Экспорт
	...
	ДанныеОбОрганизации.Вставить("ДатаДокумента", ОбщегоНазначения.РабочаяДатаПользователя());
