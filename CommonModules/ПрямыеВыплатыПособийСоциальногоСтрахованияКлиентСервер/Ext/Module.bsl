...
// Процедура заполняет список значений датами вступления в пилотный проект
// Используется для организации выбора из списка даты вступления
//	Параметры 
//		СписокВыбора - список значений, список выбора элемента управления формы
//
