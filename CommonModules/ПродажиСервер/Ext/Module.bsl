...
Функция ПараметрыЗаполненияВременнойТаблицыТоваров() Экспорт
	...
	СтруктураПараметров.Вставить("ВключаяНомераГТД", Истина);
	// }
	// 4D
...
Функция ТипыСсылокДокументыРеализации() Экспорт
	...
	Если ПравоДоступа("Чтение", Метаданные.Документы.ЗаказДавальца)
		...
		ТипыСсылок.Добавить(СтандартныеПодсистемыПовтИсп.ИдентификаторОбъектаМетаданныхПоПолномуИмени(Метаданные.Документы.ЗаказДавальца.ПолноеИмя()));
	КонецЕсли;
	//-- НЕ УТКА
