...
Функция ПолучитьЗначенияКонстантПоУмолчанию() Экспорт
	...
	//++ НЕ УТ
	Результат.Вставить("ИспользоватьПроизводство", Истина);
	Результат.Вставить("ИспользоватьУправлениеПроизводством",    Истина);
	Результат.Вставить("ИспользоватьУправлениеПроизводством2_2", Ложь);
	//-- НЕ УТ

	//++ НЕ УТКА
	Результат.Вставить("ИспользоватьУправлениеПроизводством",    Ложь);
	Результат.Вставить("ИспользоватьУправлениеПроизводством2_2", Истина);
	Результат.Вставить("ИспользоватьОбособленноеОбеспечениеЗаказов", Истина);
	
	Результат.Вставить("МетодикаУправленияПроизводством", Перечисления.МетодикаУправленияПроизводством.БезПланирования);
	Результат.Вставить("ВариантОбособленияМатериаловВПроизводстве", Перечисления.ВариантыОбособленияМатериаловВПроизводстве.ЭтапПроизводства);
	//-- НЕ УТКА
	...
	//++ НЕ УТ
	Результат.Вставить("ИспользуетсяЕНВД", 						Ложь);
	//-- НЕ УТ
	...
	// 4D:ERP для Беларуси, Дмитрий, 04.08.2017 7:53:12 
	// Наши настройки
	// {
	//Наша константа - должна быть включена
	Результат.Вставить("ПрименятьСкидкиКЦене", Истина);
	
	//Отключаем
	Результат.Вставить("ВестиСведенияДляДекларацийАлкоВРознице", Ложь);
	Результат.Вставить("ВестиСведенияДляДекларацийПоАлкогольнойПродукции", Ложь);
	Результат.Вставить("ВестиУчетМаркировкиПродукцииВГИСМ", Ложь);
	Результат.Вставить("УплачиваетсяТорговыйСбор", Ложь);
	Результат.Вставить("ИспользоватьУведомленияОКонтролируемыхСделках", Ложь);
	Результат.Вставить("ИспользоватьОбменСБанками", Ложь);
	Результат.Вставить("ИспользоватьОбменЭД", Ложь);
	Результат.Вставить("ИспользоватьОбменЭДМеждуОрганизациями", Ложь);
	Результат.Вставить("ВестиУчетТаможенныхДекларацийНаЭкспорт", Ложь);
	
	//Включаем
	Результат.Вставить("ИспользоватьПродажиНаЭкспортСырьевыхТоваровУслуг", Истина);
	Результат.Вставить("ИспользоватьПродажиНаЭкспортНесырьевыхТоваров", Истина);
	Результат.Вставить("ИспользоватьТТН", Истина);
	
	//ЭСЧФ
	Результат.Вставить("АдресВебСервисаЭСЧФ", "https://ws.vat.gov.by:443/InvoicesWS/services/InvoicesPort");
	// }
	// 4D
...
Функция КонстантыДоступныеВБазовойВерсии() Экспорт 
	...
	Результат.Вставить(Метаданные.Константы.ИспользоватьИнтеграцию1СБухфон.Имя);
	...
	Результат.Вставить(Метаданные.Константы.ИспользоватьКорректировкиПоступлений.Имя);
...
Функция ПолучитьТаблицуЗависимостиКонстант() Экспорт
	...
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ОграничиватьДоступНаУровнеЗаписей", Ложь, "ИспользоватьГруппыДоступаВидовСтатейИПоказателейБюджетов", Ложь);
	//-- НЕ УТ	
	...
	// 4D:ERP для Беларуси, Екатерина, 07.04.2016 15:06:34 
	// Расчет скидки к цене, №10910
	// {
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьАвтоматическиеСкидкиВПродажах", Ложь, "ПрименятьСкидкиКЦене", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьРучныеСкидкиВПродажах", Ложь, "ПрименятьСкидкиКЦене", 		   Ложь);
	// }
	// 4D
	...
	// 4D:ERP для Беларуси, Дмитрий, 11.08.2017 17:11:05 
	// Розничные продажи
	// {
		
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьРозничныеПродажи", 				Ложь, "ИспользоватьТорговыеНадбавки", Ложь);
	// }
	// 4D
	...
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьПроизводствоНаСтороне", 			Истина, "ИспользоватьПодразделения", Истина);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
	...
	//++ НЕ УТКА
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьУправлениеПроизводством",	 		Истина, "ИспользоватьПроизводство", Истина);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьУправлениеПроизводством2_2",	 	Истина, "ИспользоватьПроизводство", Истина);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьУправлениеПроизводством2_2",	 	Ложь, "ИспользоватьСтатусыДвиженийПродукцииИМатериалов", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьПроизводство",	 					Ложь, "ИспользоватьСтатусыДвиженийПродукцииИМатериалов", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьПроизводство", 					Истина, "МетодикаУправленияПроизводством", Перечисления.МетодикаУправленияПроизводством.БезПланирования);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьПроизводство", 					Истина, "ВариантОбособленияМатериаловВПроизводстве", Перечисления.ВариантыОбособленияМатериаловВПроизводстве.ЭтапПроизводства);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
	...
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьПроизводство", 					Истина, "ИспользоватьОбособленноеОбеспечениеЗаказов", Истина);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
	...
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат, 
		...
		"АктуализироватьФактБюджетированияПриПроведенииДокументов", Ложь);
	
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат, 
		"ИспользоватьБюджетирование", Ложь, 
		"АктуализироватьФактБюджетированияПриФормированииОтчетов", Ложь);
	...
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат, 
		"ИспользоватьБюджетныйПроцесс", Ложь, 
		"ИспользоватьОповещенияДляЗадачБюджетирования", Ложь);
	//-- НЕ УТКА
	//-- НЕ УТ
	...
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьУведомленияОКонтролируемыхСделках", Истина, "ИспользованиеКлассификаторовНоменклатуры", Истина);
	...
	// Регламентированный учет
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьРеглУчет", Ложь, "ИспользоватьЛизинг", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьРеглУчет", Ложь, "ИспользоватьУведомленияОКонтролируемыхСделках", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьРеглУчет", Ложь, "УплачиваетсяТорговыйСбор", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьРеглУчет", Ложь, "ИспользоватьРучнуюКорректировкуПроводокПоРеглУчету", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьРеглУчет", Ложь, "ИспользоватьПроверкуДокументовПоРегламентированномуУчету", Ложь);
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьРеглУчет", Ложь, "ИспользоватьАмортизациюБухгалтерскогоУчетаВУправленческомУчете", Ложь);
	//++ НЕ УТКА
	ДобавитьСтрокуТаблицыЗависимостиКонстант(Результат,
		"ИспользоватьРеглУчет", Ложь, "ФормироватьПроводкиМеждународногоУчетаПоДаннымРегламентированного", Ложь);
	//-- НЕ УТКА
	//-- НЕ УТ
