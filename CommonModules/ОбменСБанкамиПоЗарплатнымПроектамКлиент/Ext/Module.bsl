...
Процедура ОбновитьКомандыОбмена(Форма, Источник) Экспорт
	...
	Если ТипЗнч(Источник) = Тип("ТаблицаФормы") Тогда
		...
		Для Каждого ВыделеннаяСтрока Из ВыделенныеСтроки Цикл
			...
			КонецЕсли;
		КонецЦикла;
		ОбновитьКомандыОбменаСпискаФормы(Форма, ВыбранныеОбъекты);
	Иначе
		ОбновитьКомандыОбменаСпискаФормы(Форма, Источник);
	КонецЕсли;
...
Процедура ОбновитьКомандыОбменаСпискаФормы(Форма, ВыбранныеОбъекты)
	
	Для Каждого КомандаОбмена Из Форма.КомандыОбмена Цикл
		ПоказыватьКоманду = Истина;
		Если ТипЗнч(ВыбранныеОбъекты) = Тип("Массив") Тогда
			Для Каждого Объект Из ВыбранныеОбъекты Цикл
				Если КомандаОбмена.Значение.Найти(Объект.ЗарплатныйПроект) = Неопределено Тогда
					ПоказыватьКоманду = Ложь;
					Прервать;
				КонецЕсли;
			КонецЦикла;
		Иначе
			Если КомандаОбмена.Значение.Найти(ВыбранныеОбъекты) = Неопределено Тогда
				ПоказыватьКоманду = Ложь;
			КонецЕсли;
		КонецЕсли;
