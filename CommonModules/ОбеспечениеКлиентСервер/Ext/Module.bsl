...
//
Функция ПараметрыДействияПроверитьЗаполнитьОбеспечениеВЭтапеПроизводства(ЗаказНаПроизводство, Подразделение, ЖелаемаяДатаОтгрузки, ИмяПоляСклад = "Склад") Экспорт
	
	ПараметрыДействия = Новый Структура("ЗаказНаПроизводство, Подразделение, ЖелаемаяДатаОтгрузки, ПроизводствоНаСтороне, ИмяПоляСклад");
	
	ПараметрыДействия.ЗаказНаПроизводство = ЗаказНаПроизводство;
	ПараметрыДействия.Подразделение = Подразделение;
	ПараметрыДействия.ЖелаемаяДатаОтгрузки = ЖелаемаяДатаОтгрузки;
	ПараметрыДействия.ИмяПоляСклад = ИмяПоляСклад;
