...
// {
#Область РегистрацияТорговыхНадбавок

Функция РегистрацияТорговыхНадбавокСоздатьНаОснованииПоступленияТоваровУслуг(ОписаниеКоманды) Экспорт
	...
	ПараметрыОткрытия = РегистрацияТорговыхНадбавокПараметрыОткрытияФормы(ПараметрКоманды);
	Если ПараметрыОткрытия = Неопределено Тогда
		Возврат Неопределено;
	КонецЕсли;
		
	ОткрытьФорму(
		"Документ.РегистрацияТорговыхНадбавок.Форма.ФормаДокумента",
			ПараметрыОткрытия,
			ПараметрыВыполненияКоманды.Источник,
			ПараметрыВыполненияКоманды.Уникальность,
			ПараметрыВыполненияКоманды.Окно,
...
Функция РегистрацияТорговыхНадбавокПараметрыОткрытияФормы(ПараметрКоманды) Экспорт
