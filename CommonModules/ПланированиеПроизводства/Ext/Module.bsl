...
Функция ПолучитьДанныеПродукции(Ссылка, КлючСвязи) Экспорт
	...
	Возврат СтруктураДанныхПродукции(Выборка);
...
//
Функция СпособПолученияМатериалаПоУмолчанию(ДанныеЗаказа, ДанныеМатериала, МенеджерВременныхТаблиц = Неопределено, ИспользоватьПроизводство2_2 = Ложь) Экспорт
...
//       * Запланировать - Булево - признак, материал возможно 
//
Функция СпособыПолученияМатериаловПоУмолчанию(ДанныеЗаказа, ТаблицаМатериалов, МенеджерВременныхТаблиц = Неопределено, ИспользоватьПроизводство2_2 = Ложь) Экспорт
	...
	ТекстЗапросаПараметрыОбеспечения = ПроизводствоСервер.ТекстЗапросаПараметрыОбеспечения(
		"СпособПолученияМатериала",, ИспользоватьПроизводство2_2);
...
Функция ПараметрыОбеспеченияМатериалаЭтапа(Номенклатура, Характеристика, Производится, Подразделение, ИсточникПолученияПолуфабриката, ЗаказНаПроизводство) Экспорт
	...
	ПараметрыОбеспеченияМатериала = Новый Структура("Склад, ВариантОбеспечения");
...
Функция ПараметрыОбеспеченияМатериаловЭтапа(ТаблицаМатериалов, ЗаказНаПроизводство) Экспорт
	...
	|
	|ГДЕ
	|	ЗаказыНаПроизводство.Ссылка = &Распоряжение
	...
	ТекстЗапросаПараметрыОбеспечения = ПроизводствоСервер.ТекстЗапросаПараметрыОбеспечения(,, Истина);
...
Функция ПараметрыОбеспеченияСпискаНоменклатуры(ТаблицаМатериалов, Подразделение) Экспорт
	...
	ТекстЗапросаДляПолученияСклада = ПроизводствоСервер.ТекстЗапросаНастройкиПередачиМатериалов(
										"ТаблицаМатериалов", "&Подразделение", Истина);	
...
//  ПоследовательностьЭтапов - ТаблицаЗначений	 - материца последовательности этапов
//
...
// 
// Возвращаемое значение:
//   - таблица - материца последовательности этапов
//
