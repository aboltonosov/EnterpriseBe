...
//
// Параметры:
//	Счет - ПланСчетовСсылка.Хозрасчтный - Счет, для которого получаются настройки.
//
...
//
// Возвращаемое значение:
//	Булево - Истина, если договор является договорм с поставщиком.
//
...
//
// Возвращаемое значение:
//	Булево - Истина, если договор является договорм с покупателем.
//
...
//
// Возвращаемое значение:
//	Булево - Истина, если договор является договорм с комитентом.
//
...
//
// Возвращаемое значение:
//	Булево - Истина, если договор является договорм с комиссионером.
//
...
//
// Параметры:
//	ПолеНоменклатура - Строка - Выражение для получения ссылки на номенлатуру.
//
// Возвращаемое значение:
...
//
// Возвращаемое значение:
//	СписокЗначений - Список головный организаций в справочнике.
//
...
// Возвращаемое значение:
//	Структура - Содержит ключи:
//		* Тип - Строка - Содержит значение "ОП", если организация является особленным подразделением
...
// 
// Параметры:
//	СтруктураШапкиДокумента - Cтруктура - Cодержит ключи:
...
Функция ПолучитьСчетаРасчетовСКонтрагентом(Знач Организация, Знач Контрагент, Знач Договор) Экспорт
	...
	// 4D:ERP для Беларуси, Екатерина, 23.07.2015 10:56:18 
	...
	Если РеквизитыДоговора.РасчетыВУсловныхЕдиницах Тогда
		...
		Результат.Вставить("СчетРасчетовПоПретензиям", 	ПланыСчетов.Хозрасчетный.РасчетыПоПретензиямУЕ); 			// 76.33
		Результат.Вставить("СчетРасчетовСКомитентом", 	ПланыСчетов.Хозрасчетный.ПрочиеРасчетыСРазнымиДебиторамиИКредиторамиУЕ);	// 76.39
		Результат.Вставить("СчетУчетаТары",				ПланыСчетов.Хозрасчетный.ПрочиеРасчетыСРазнымиДебиторамиИКредиторамиУЕ);	// 76.39
		Результат.Вставить("СчетУчетаТарыПокупателя", 	ПланыСчетов.Хозрасчетный.ПрочиеРасчетыСРазнымиДебиторамиИКредиторамиУЕ);	// 76.39
	...
	ИначеЕсли ЗначениеЗаполнено(РеквизитыДоговора.ВалютаВзаиморасчетов)
		...
		Результат.Вставить("СчетРасчетовПоПретензиям", 	ПланыСчетов.Хозрасчетный.РасчетыПоПретензиямВал); 			// 76.23
		Результат.Вставить("СчетРасчетовСКомитентом", 	ПланыСчетов.Хозрасчетный.ПрочиеРасчетыСРазнымиДебиторамиИКредиторамиВал);	// 76.29
		Результат.Вставить("СчетУчетаТары",				ПланыСчетов.Хозрасчетный.ПрочиеРасчетыСРазнымиДебиторамиИКредиторамиВал);		// 76.29
		Результат.Вставить("СчетУчетаТарыПокупателя", 	ПланыСчетов.Хозрасчетный.ПрочиеРасчетыСРазнымиДебиторамиИКредиторамиВал);		// 76.29
	...
	Иначе
		...
		Результат.Вставить("СчетРасчетовПоПретензиям", 	ПланыСчетов.Хозрасчетный.РасчетыПоПретензиям); 			// 76.03
		Результат.Вставить("СчетРасчетовСКомитентом", 	ПланыСчетов.Хозрасчетный.ПрочиеРасчетыСРазнымиДебиторамиИКредиторами);	// 76.09
		Результат.Вставить("СчетУчетаТары",				ПланыСчетов.Хозрасчетный.ПрочиеРасчетыСРазнымиДебиторамиИКредиторами);	// 76.09
		Результат.Вставить("СчетУчетаТарыПокупателя", 	ПланыСчетов.Хозрасчетный.ПрочиеРасчетыСРазнымиДебиторамиИКредиторами);	// 76.09
...
Функция ЭтоСчетКапитализацииРасходовПоВНА(Счет) Экспорт
	...
	// {
	Результат = 
		(Счет = ПланыСчетов.Хозрасчетный.СтроительствоОбъектовОсновныхСредств
		ИЛИ Счет = ПланыСчетов.Хозрасчетный.ПодготовкаКВводуВЭксплуатацию
