...
Функция КомандыПечатиФормы(Форма, ИсточникиКоманд = Неопределено) Экспорт
	...
	// 4D:ERP для Беларуси, Дмитрий, 10.04.2015 17:29:00 
	// Локализация печатных форм, №7762
	// {
	УправлениеПечатьюУППереопределяемый.ПослеДобавленияКомандПечати(ИмяФормы, КомандыПечати, СтандартнаяОбработка);
	// }
	// 4D
...
Функция МакетПечатнойФормы(ПолныйПутьКМакету) Экспорт
	...
	// 4D:ERP для Беларуси, Дмитрий, 10.04.2015 22:26:48 
	// Локализация печатных форм, №7762
	// {
	УправлениеПечатьюУППереопределяемый.МакетПечатнойФормы(ПутьКМетаданным, ПутьКОбъектуМетаданных); 
	// }
	// 4D
