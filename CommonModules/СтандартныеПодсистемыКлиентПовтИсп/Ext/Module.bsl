...
Функция ПараметрыРаботыКлиентаПриЗапуске() Экспорт
	...
	Если ПараметрыКлиента.Свойство("ЦентрМониторинга") Тогда
		ПараметрыПриложения["СтандартныеПодсистемы.ПараметрыПриЗапускеПрограммы"].Вставить("ЦентрМониторинга", ПараметрыКлиента.ЦентрМониторинга);
	КонецЕсли;
