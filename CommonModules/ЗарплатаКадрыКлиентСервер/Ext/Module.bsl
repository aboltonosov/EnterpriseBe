...
Функция ГражданствоПоУмолчанию(ИнформацияОГражданстве) Экспорт
	...
	// 4D:ERP для Беларуси, Дмитрий, 14.12.2014 20:39:50 
	// Локализация кадрового учета, №8703
	// {
	Возврат ИнформацияОГражданстве.Страна = ПредопределенноеЗначение("Справочник.СтраныМира.Беларусь");
	// }
	// 4D
...
Функция СтатусыЗастрахованныхФизическихЛицПоУмолчанию(СтатусЗастрахованногоЛица) Экспорт
	...
	// 4D:ERP для Беларуси, Дмитрий, 01.09.2017 19:42:42 
	// Локализация кадрового учета, №8703
	// {
	Возврат СтатусЗастрахованногоЛица.ВидЗастрахованногоЛица = ПредопределенноеЗначение("Перечисление.ВидыЗастрахованныхЛицОбязательногоСтрахования.ГражданеРБ");
	// }
	// 4D
...
Функция ПредставлениеРегистрацииВНалоговомОргане(Знач СтруктурнаяЕдиница, Знач РегистрацияВНалоговомОргане) Экспорт
	...
	// 4D:ERP для Беларуси, Петр, 15.08.2017 13:09:42 
	// Локализация кадрового учета, №8703
	// Представление для регистрации в налоговом органе РБ
	// {
	Представление = "";
