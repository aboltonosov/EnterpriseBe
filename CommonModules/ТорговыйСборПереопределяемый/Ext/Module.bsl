...
// Формирует движения по оперативным регистрам ПрочиеРасходы и ДвиженияДоходыРасходыПрочиеАктивыПассивы на основании проводки по начислению торгового сбора
//
// Параметры:
...
Процедура ОтразитьУменьшениеНалогаНаПрибыльНаСуммуТорговогоСбораВОператпивныхРегистрах(Организация, Период, СуммаУменьшения, Движения) Экспорт
	...
	РасчетПоСбору.Колонки.Добавить("СуммаСторно", ОбщегоНазначения.ОписаниеТипаЧисло(15, 2));
