...
// Функция-конструктор параметров создания реализации товаров и услуг по одному или нескольким заказам.
//
// Возвращаемое значение:
// 	Струкутура - Структура параметров.
...
//
Функция ПараметрыСозданияРеализацииТоваровНаОснованииЗаказа() Экспорт
	
	ПараметрыСоздания = Новый Структура;
	
	ПараметрыСоздания.Вставить("Список");
	ПараметрыСоздания.Вставить("ИспользоватьРеализациюПоНесколькимЗаказам");
	ПараметрыСоздания.Вставить("Склад", Неопределено);
	ПараметрыСоздания.Вставить("ДатаОтгрузки", Неопределено);
	ПараметрыСоздания.Вставить("ИмяДокумента", Неопределено);
	ПараметрыСоздания.Вставить("СоздаватьАктНаПередачуПрав", Ложь);
	ПараметрыСоздания.Вставить("ПараметрыОформления", Неопределено);
...
//
// Параметры:
//	ПараметрыСоздания - Структура - Структура параметров создания, конструктор ПродажиКлиент.ПараметрыСозданияРеализацииТоваровНаОснованииЗаказа
//
Процедура СоздатьРеализациюТоваровНаОснованииЗаказа(ПараметрыСоздания) Экспорт
	
	Список                                    = ПараметрыСоздания.Список;
	ИспользоватьРеализациюПоНесколькимЗаказам = ПараметрыСоздания.ИспользоватьРеализациюПоНесколькимЗаказам;
	Склад                                     = ПараметрыСоздания.Склад;
	ДатаОтгрузки                              = ПараметрыСоздания.ДатаОтгрузки;
	ИмяДокумента                              = ПараметрыСоздания.ИмяДокумента;
	СоздаватьАктНаПередачуПрав                = ПараметрыСоздания.СоздаватьАктНаПередачуПрав;
	ПараметрыОформления                       = ПараметрыСоздания.ПараметрыОформления;
