...
Функция ДоменРасположенияСерверовИПП() Экспорт
	...
	Если ИспользоватьПолучитьРежимВнешнихРесурсов() Тогда
		РежимИспользования = РаботаВБезопасномРежиме.ВычислитьВБезопасномРежиме("ПолучитьРежимВнешнихРесурсов()");
...
Функция ИспользоватьПолучитьРежимВнешнихРесурсов() Экспорт
	...
	КомпонентыВерсииПлатформы = СтроковыеФункцииКлиентСервер.РазложитьСтрокуВМассивПодстрок(
		СистемнаяИнформация.ВерсияПриложения,
		".");
	
	НомерРелизаПлатформы = КомпонентыВерсииПлатформы[2];
	Если НомерРелизаПлатформы = "8" Тогда
		НомерВерсии = НомерВерсииПлатформыПолучитьРежимВнешнихРесурсов_8_3_8();
	ИначеЕсли НомерРелизаПлатформы = "9" Тогда
		НомерВерсии = НомерВерсииПлатформыПолучитьРежимВнешнихРесурсов_8_3_9();
	ИначеЕсли НомерРелизаПлатформы = "10" Тогда
		НомерВерсии = НомерВерсииПлатформыПолучитьРежимВнешнихРесурсов_8_3_10();
	Иначе
		Возврат Ложь;
	КонецЕсли;
...
Функция НомерВерсииПлатформыПолучитьРежимВнешнихРесурсов_8_3_10()
	
	Возврат "8.3.10.2466";
	
КонецФункции

Функция НомерВерсииПлатформыПолучитьРежимВнешнихРесурсов_8_3_9()
	
	Возврат "8.3.9.2309";
	
КонецФункции

Функция НомерВерсииПлатформыПолучитьРежимВнешнихРесурсов_8_3_8()
