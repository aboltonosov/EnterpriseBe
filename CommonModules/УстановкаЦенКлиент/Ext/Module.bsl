	...
	Если ПозицияПодстроки <> 0 Тогда
		...
		ИначеЕсли ТекущиеДанные["СтараяЦена" + ИмяКолонки] <> 0 Тогда
			...
			Если ЗначениеЗаполнено(ДатаДействующихЦен) Тогда
				СтрокаДатаДействующихЦен = Формат(ДатаДействующихЦен, "ДФ=dd.MM.yyyy");
			Иначе
				СтрокаДатаДействующихЦен = Формат(НачалоДня(ТекущаяДата())-1, "ДФ=dd.MM.yyyy");
			КонецЕсли;
		...
		Если ТекущиеДанные[ИмяКолонки] <> 0 Тогда
			...
			Если ЦенаИзменена Тогда
				...
				#Если ВебКлиент Тогда
				ФорматированнаяСтрокаЦена = Новый ФорматированнаяСтрока(НСтр("ru=' | '"), СтрокаЦена, НаименованиеВалюты);
				#Иначе
				ФорматированнаяСтрокаЦена = Новый ФорматированнаяСтрока(НСтр("ru=' | '"), КартинкаЦенаИзменена, СтрокаЦена, НаименованиеВалюты);
				#КонецЕсли
			Иначе
				ФорматированнаяСтрокаЦена = Новый ФорматированнаяСтрока(НСтр("ru=' | '"), СтрокаЦена, НаименованиеВалюты);
			КонецЕсли;
