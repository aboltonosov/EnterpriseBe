...
// Выполняет открытие формы настройки счетов учета, для случая, когда счета учата задаются для строк табличной части
// Параметры:
...
// 	ПараметрыФормы - Строктура, Неопределено - Значения параметров открытия формы настройки (счета учета)
...
// Выполняет проверку вида деятельности НДС, выбранного в документе, отражению в регл. учете номенклатуры, статей расходов, статей прочих активов.
// В случае, если поступают компоненты ОС, ОС или НМА предлагает установить соответствующий вид деятельности НДС.
//
// Параметры:
...
// Процедура отрабатывает событие ОбработкаВыбора для отбора настроек комноновщика настроек, расположенного на форме
//
// Параметры:
