...
Функция ПолучитьНомерДатаДоговораДокументов(МассивСсылок) Экспорт
	...
	|
	|ВЫБРАТЬ
	|	КорректировкаПоступления.Договор.Номер,
	|	КорректировкаПоступления.Договор.Дата,
	...
	|
	|ВЫБРАТЬ
	|	ПоступлениеУслугПрочихАктивов.Договор.Номер,
	|	ПоступлениеУслугПрочихАктивов.Договор.Дата,
