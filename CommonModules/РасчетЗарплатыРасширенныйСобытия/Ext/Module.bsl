...
Процедура ЗаполнитьНачисленияВнутреннихСовместителейИПодработок(Источник, Отказ, Замещение) Экспорт
	...
	Для каждого Запись Из Источник Цикл
		...
		Если Запись.ВидЗанятости = Перечисления.ВидыЗанятости.ВнутреннееСовместительство Тогда
			
			СтруктураПоиска = Новый Структура("Период,ГоловнаяОрганизация", Запись.Период, Запись.ГоловнаяОрганизация);
			...
			НайденнаяСтрока.ФизическиеЛица.Вставить(Запись.ФизическоеЛицо, Истина);
			
		ИначеЕсли Запись.ВидЗанятости = Перечисления.ВидыЗанятости.Подработка Тогда
