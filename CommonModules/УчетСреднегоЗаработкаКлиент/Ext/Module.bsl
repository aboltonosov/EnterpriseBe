...
Процедура ОткрытьФормуВводаСреднегоЗаработкаОбщий(ПараметрыРедактирования, ВладелецФормы, ОповещениеЗавершения = Неопределено) Экспорт
	...
	// 4D:ERP для Беларуси, Яна, 26.06.2017 16:34:29 
	// Ошибка документа "Отпуск", №15211
	// Ошибка при вводе данных для расчета среднего заработка, №15832 
	// {
	ОткрытьФорму("ОбщаяФорма.ВводДанныхДляРасчетаСреднегоЗаработка", ПараметрыРедактирования, ВладелецФормы, , , , ОповещениеЗавершения, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
	// }
	// 4D
...
// 4D:ERP для Беларуси, Яна, 30.08.2017 16:12:23 
// Ошибка при вводе данных для расчета среднего заработка, №15832 
// {
// Процедура открывает форму ручного ввода данных среднего заработка 
// 
Процедура ОткрытьФормуВводаСреднегоЗаработкаЛокализация(ПараметрыРедактирования, ВладелецФормы, ОповещениеЗавершения = Неопределено) Экспорт
