...
Процедура СформироватьВТНачисленияСДаннымиУчета(Организация, ПериодРегистрации, МенеджерВременныхТаблиц, ИсключаемыйРегистратор = Неопределено) Экспорт
	...
	// 4D:ERP для Беларуси, Яна, 16.08.2017 16:44:33 
	// Ошибка документа "Простой сотрудников", "Прогул, неявка", №15213
	// {
	УчетСтраховыхВзносовРасширенный.СформироватьВТНачисленияСДаннымиУчета_Локализация(Организация, ПериодРегистрации, МенеджерВременныхТаблиц, ИсключаемыйРегистратор)
	// }
	// 4D		
