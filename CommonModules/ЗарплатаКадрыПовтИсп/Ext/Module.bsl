...
// 4D:ERP для Беларуси, Яна, 22.08.2017 12:45:42 
// Результат тестирования конфигурации, №15769
// Регистр сведений Бюджет прожиточного минимума в ERP, № 15052 
// {
Функция РазмерБПМ(ДатаАктуальности) Экспорт
	
	Возврат РегистрыСведений.ВеличинаПрожиточногоМинимума.ДанныеБюбджетаПрожиточногоМинимума(ДатаАктуальности)["Размер"];
