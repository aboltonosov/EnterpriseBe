...
Процедура УстановитьИспользованиеЭлектронногоОбменаСБанками(ИспользоватьНачислениеЗарплаты = Неопределено) Экспорт
	...
	// 4D:ERP для Беларуси, Петр, 13.10.2017 12:12:58 
	// Функционал "Обмен с банками", №16224
	// {
	Если ТекущееИспользование <> ИспользованиеЭлектронногоОбменаСБанками И ИспользованиеЭлектронногоОбменаСБанками = Ложь Тогда
