...
// Обработчик обновления БЭД 1.3.6.23
// Добавляет новые виды ЭД в справочники БЭД.
//
Процедура ДобавитьНовыеВидыЭД_КорректировочныйСФ() Экспорт
	
	ОбновитьНастройкиЭДО(Перечисления.ВидыЭД.КорректировочныйСчетФактура);
	УдалитьНовыеВидыЭДУПД_УКД();
	ЗаполнитьВходящиеДокументыНастроек();
