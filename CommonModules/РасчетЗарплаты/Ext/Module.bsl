...
Функция РекомендуемыеКорректировкиВыплаты(Налоги, ТекущиеКорректировкиВыплаты) Экспорт
	...
	Для Каждого СтрокаНалога Из Налоги Цикл
		...
		Для Каждого СтрокаКорректировки Из СтрокиКорректировок Цикл
			СуммаКорректировкиВыплаты = СтрокаКорректировки.СуммаВзаиморасчетов - СтрокаКорректировки.СуммаКВыплате;
			ТекущаяКорректировка = ТекущаяКорректировка + СуммаКорректировкиВыплаты;
		...
		ИначеЕсли СтрокаНалога.Налог < ТекущаяКорректировка Тогда
			...
			Для Каждого СтрокаКорректировки Из СтрокиКорректировок Цикл
				...
				НоваяСтрока.КорректировкаВыплаты = СуммаКорректировкиВыплаты * Коэффициент;
		...
		Иначе
			...
			Для Каждого СтрокаКорректировки Из СтрокиКорректировок Цикл
				НоваяСтрока = КорректировкиВыплаты.Добавить();
				ЗаполнитьЗначенияСвойств(НоваяСтрока, СтрокаКорректировки);
				НоваяСтрока.КорректировкаВыплаты = СтрокаКорректировки.СуммаВзаиморасчетов - СтрокаКорректировки.СуммаКВыплате;
			КонецЦикла;
		КонецЕсли;
