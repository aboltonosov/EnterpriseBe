...
Функция ТекстЗапросаСпискаЖурналаДокументов()
	...
	//++ НЕ УТ
	|	И ВЫБОР
	|			КОГДА &ВыводитьДокументыАмортизации
	|				ТОГДА ИСТИНА
	|			ИНАЧЕ НЕ РегламентныеДокументы.Ссылка ССЫЛКА Документ.АмортизацияНМА
	|					И НЕ РегламентныеДокументы.Ссылка ССЫЛКА Документ.АмортизацияОС
	|		КОНЕЦ
	//-- НЕ УТ
	|";
