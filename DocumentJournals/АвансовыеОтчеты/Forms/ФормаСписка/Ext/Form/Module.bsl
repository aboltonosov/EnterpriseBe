...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВидимостьСозданияПоступленияТоваров = ПравоДоступа("Добавление", Метаданные.Документы.ПоступлениеТоваровУслуг);
	//++ НЕ УТ
	...
	Элементы.СписокСоздатьПоступлениеТоваровУслуг.Видимость        = ВидимостьСозданияПоступленияТоваров;
	//++ НЕ УТ
	...
	Элементы.СписокКонтекстноеМенюСоздатьПоступлениеТоваровУслуг.Видимость        = ВидимостьСозданияПоступленияТоваров;
	//++ НЕ УТ
	...
	Если КнопокСоздания = 1 Тогда
		...
		ИначеЕсли ВидимостьСозданияПоступленияТоваров Тогда
			ЭлементСоздания = Элементы.СписокСоздатьПоступлениеТоваровУслуг;
		//++ НЕ УТ
