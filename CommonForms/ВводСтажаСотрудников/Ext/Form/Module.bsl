...
Процедура ДополнитьФорму()
	...
	Для Каждого ВидСтажа Из ВидыСтажа Цикл
		...
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("Период", Новый ОписаниеТипов("Дата"), "Набор" + Сч, , Истина));
		...
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("ДатаОтсчета", Новый ОписаниеТипов("Дата"), "Набор" + Сч, , Истина));
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("РазмерМесяцев", Новый ОписаниеТипов("Число"), "Набор" + Сч, , Истина));
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("РазмерДней", Новый ОписаниеТипов("Число"), "Набор" + Сч, , Истина));
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("ИсчисляетсяСДатыПриема", Новый ОписаниеТипов("Булево"), "Набор" + Сч, , Истина));
		
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("Лет", Новый ОписаниеТипов("Число"), "Набор" + Сч, , Истина));
...
Процедура ЗаполнитьДанныеОСтаже(ДанныеСтажей)
	...
	Для Каждого ВидСтажа Из ВидыСтажа Цикл
		...
		ЭтотОбъект["СпособИсчисленияСтажа" + Сч] = ?(ЭтотОбъект["ИсчисляетсяСДатыПриема" + Сч], 1, 0);
...
Процедура УстановитьПодсказкуСтажаПоНомеруСтажа(Форма, НомерСтажа)
	...
	Иначе
		...
		Подсказка = ПредставлениеПодсказкиСтажа(ДанныеСтажа, Форма.ДатаСведений, ИсчисляетсяСДатыПриема(Форма, НомерСтажа));
...
&НаКлиентеНаСервереБезКонтекста
Функция ПредставлениеПодсказкиСтажа(ДанныеСтажа, ДатаСведений, ИсчисляетсяСДатыПриема)
	
	ПродолжительностьСтажа = ЗарплатаКадрыРасширенныйКлиентСервер.ПродолжительностьСтажа(ДанныеСтажа, ДатаСведений);
