...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РеквизитыНоменклатуры = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(
		ОснованиеНоменклатура, "ИспользованиеХарактеристик,Наименование");
	...
	Если Параметры.Свойство("РежимСпецификацииИзделия") Тогда
		...
		Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Спецификации изделия %1'"),
	...
	Иначе
		...
		Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Производство (Номенклатура: ""%1"")'"),
			РеквизитыНоменклатуры.Наименование);
...
Процедура ОбновитьСоставПодразделений(СписокПодразделений)
	...
	Если СписокПодразделенийНаФорме.Количество() = 1 Тогда
		...
		Элементы.УправлениеСпецификациямиПодразделение1.Заголовок = НСтр("ru = 'Основная в любом подразделении'");
	Иначе
		Элементы.УправлениеСпецификациямиГруппаНастройкаОсновнойСпецификации.ОтображатьВШапке = Истина;
		Элементы.УправлениеСпецификациямиПодразделение1.Заголовок = НСтр("ru = 'В любом подразделении'");
	КонецЕсли;
