...
Процедура ПрочитатьДанные()
	...
	ПрямыеВыплатыПособийСоциальногоСтрахованияКлиентСервер.ЗаполнитьСписокВыбораДатыВступленияВПилотныйПроект(Элементы.ВыплатаПособийЗаСчетФСС.СписокВыбора);
