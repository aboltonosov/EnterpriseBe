	...
	Если Не РежимРаботы.МодельСервиса Тогда 
		...
		Если ЕстьИнтеграцияСЯндексКассой
			...
			ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
				...
				Не РежимРаботы.МодельСервиса); // В модели сервиса расписание настраивать запрещено
...
Процедура ДобавитьКомандыСозданияШаблона()
	...
	Для Каждого ТипОснованияПлатежа из ТипыОснованияПлатежа Цикл 
		...
		ОписаниеКоманды.Вставить("Представление", "Шаблон для """+ ПредставлениеОбъектаМетаданных +"""");
