...
Процедура ПоместитьПлатежиВХранилище()
	...
	Платежи = ТаблицаОстатковРасчетов.Выгрузить(, "Выбран, Сумма, Заказ, СтатьяДвиженияДенежныхСредств, ВалютаВзаиморасчетов, Партнер, Контрагент, Договор, ПлатежиПо275ФЗ, ТипРасчетов, Организация");
