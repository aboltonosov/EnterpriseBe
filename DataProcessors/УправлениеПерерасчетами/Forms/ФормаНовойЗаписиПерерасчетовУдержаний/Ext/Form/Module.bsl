...
Функция ЗаписатьПерерасчет()
	...
	ПерерасчитываемыеУдержания = УдержанияСотрудника.НайтиСтроки(Новый Структура("Перерасчитывать", Истина));
	Для каждого ПерерасчитываемоеУдержание Из ПерерасчитываемыеУдержания Цикл
		...
		Запись.Удержание = ПерерасчитываемоеУдержание.Удержание;
		Запись.ДокументОснование = ПерерасчитываемоеУдержание.ДокументОснование;
