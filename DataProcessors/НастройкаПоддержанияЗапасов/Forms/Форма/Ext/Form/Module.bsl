...
Процедура ПереместитьВГруппуНаСервере(МассивЗаписей, Группировка, Склад)
	...
	Исключение
		ОтменитьТранзакцию();
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Группировка настроек поддержания запаса'"), УровеньЖурналаРегистрации.Ошибка,,,
...
Процедура УдалитьПоддержаниеЗапасаНаСервере(МассивЗаписей, Склад)
	...
	Исключение
		ОтменитьТранзакцию();
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Удаление поддерживаемых запасов'"), УровеньЖурналаРегистрации.Ошибка,,,
			ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		ВызватьИсключение;
	КонецПопытки;
