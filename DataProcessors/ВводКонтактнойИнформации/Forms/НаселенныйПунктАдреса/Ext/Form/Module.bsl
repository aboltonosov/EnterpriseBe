...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// {
	Если Параметры.Свойство("Страна") И Параметры.Страна = Справочники.СтраныМира.Беларусь Тогда
		ЧастиАдреса.Регион.Идентификатор = АдресныйКлассификаторКлиентСервер_Локализация.GUIDСтранаБеларусь();
		ЧастиАдреса.Регион.Наименование = "Беларусь";
		ЧастиАдреса.Регион.Представление = "Беларусь Респ";
		ЧастиАдреса.Регион.Сокращение = "Респ";
		ЧастиАдреса.Регион.Уровень = 1;
	КонецЕсли;
	// }
	// 4D
	...
	// {
	Если Параметры.Свойство("Страна") И Параметры.Страна = Справочники.СтраныМира.Беларусь Тогда
		Элементы.ЧастьРегион.Видимость = Ложь;
	КонецЕсли;
	// }
	// 4D
