...
Процедура СформироватьМаршрутныеЛисты(Параметры, АдресХранилища) Экспорт
	...
	Производительность.ЗафиксироватьЗамерВремени(ОписаниеЗамера, ДанныеДляФормирования.Количество());
	
	Результат = СформироватьМаршрутныеЛистыВнутриЗамераВремени(Параметры, ДанныеДляФормирования);
	Производительность.ЗафиксироватьЗамерВремени(ОписаниеЗамера, Результат.КоличествоОбработанных);
