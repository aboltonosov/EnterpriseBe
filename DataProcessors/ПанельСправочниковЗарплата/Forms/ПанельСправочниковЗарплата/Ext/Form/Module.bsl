...
// 4D:ERP для Беларуси, Юлия, 18.12.2017 17:07:31 
// Редактировать форму рабочего места "Настройки и справочники по зарплате", № 17171
// {
&НаКлиенте
Процедура ОткрытьСправочникВидыДеятельности(Команда)
	ОткрытьФорму("Справочник.ВидыОбщественноПолезнойДеятельностиСЗВК.ФормаСписка", , ЭтаФорма);
КонецПроцедуры
// }
// 4D
