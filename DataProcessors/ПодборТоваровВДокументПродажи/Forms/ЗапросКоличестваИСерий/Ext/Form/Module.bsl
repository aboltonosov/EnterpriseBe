...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("СписокВыбора") 
		И Параметры.СписокВыбора <> Неопределено Тогда
		Если Параметры.СписокВыбора.НайтиПоЗначению(Перечисления.ВариантыОбеспечения.Отгрузить) = Неопределено Тогда
			СкрыватьВариантОбеспеченияОтгрузить = Истина;
		КонецЕсли;	
		Если Параметры.СписокВыбора.НайтиПоЗначению(Перечисления.ВариантыОбеспечения.ОтгрузитьОбособленно) = Неопределено Тогда
			СкрыватьВариантОбеспеченияОтгрузитьОбособленно = Истина;
		КонецЕсли;
	КонецЕсли;
