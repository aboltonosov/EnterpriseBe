...
Процедура НастроитьФормуПоПараметрамВидаРЦ()
	...
	Если НЕ ИтогиВыводятсяВПодвалеТаблицы Тогда
		...
		Элементы.ГрафикиРаботыРЦ.ВысотаПодвала = 1;
		Элементы.ГрафикиРаботыРЦРабочийЦентр.ТекстПодвала = НСтр("ru = 'Итого:'");
		...
		Если ВыделеннаяСтрока <> Неопределено Тогда
			...
			Если Не ЗначениеЗаполнено(ВыделеннаяСтрока.ГрафикРаботы) Тогда
				...
				ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
					ТекстОшибки,
					,
					ОбщегоНазначенияКлиентСервер.ПутьКТабличнойЧасти("ГрафикиРаботыРЦ", НомерСтроки, "ГрафикРаботы"),
					,
					Отказ);
			...
			Если Не ЗначениеЗаполнено(ВыделеннаяСтрока.РабочийЦентр) Тогда
				...
				ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
					ТекстОшибки,
					,
					ОбщегоНазначенияКлиентСервер.ПутьКТабличнойЧасти("ГрафикиРаботыРЦ", НомерСтроки, "РабочийЦентр")
					,
					Отказ);
			...
			Если НЕ Отказ Тогда
				...
				ЭлементДанных.Вставить("ГрафикРаботы", ВыделеннаяСтрока.ГрафикРаботы);
