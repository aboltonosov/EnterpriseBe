...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если Источник = "ПодключаемоеОборудование"
		...
		Если ИмяСобытия = "ScanData" Тогда
			...
			ОчиститьСообщения(); 
			РезультатОбработки = ОбработатьШтрихкодыСервер(ПодключаемоеОборудованиеУТКлиент.ПреобразоватьДанныеСоСканераВМассив(Параметр), КэшированныеЗначения, ИдентификаторТекущейСтроки);
