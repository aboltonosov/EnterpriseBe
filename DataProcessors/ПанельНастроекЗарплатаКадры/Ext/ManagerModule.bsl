...
Функция СтруктураПараметровНастроек() Экспорт
	...
	// 4D:ERP для Беларуси, Петр, 13.10.2017 11:16:57 
	// Функционал "Обмен с банками", №16224
	// {
	ПараметрыНастроек.Вставить("ИспользоватьЭлектронныйОбменСБанкамиПоЗарплатнымПроектам", Ложь);
	// }
	// 4D
	...
	// 4D:ERP для Беларуси, Петр, 13.10.2017 11:17:21 
	// Функционал "Обмен с банками", №16224
	// {
...
Процедура ЗаписатьНастройки(Параметры, АдресХранилища) Экспорт
	...
	// 4D:ERP для Беларуси, Петр, 13.10.2017 11:14:50 
	// Функционал "Обмен с банками", №16224 
	// {
	Если ПараметрыНастроек.ИспользоватьЭлектронныйОбменСБанкамиПоЗарплатнымПроектам Тогда
		Константы.ИспользоватьЭлектронныйОбменСБанкамиПоЗарплатнымПроектам.Установить(Параметры.ИспользоватьЭлектронныйОбменСБанкамиПоЗарплатнымПроектам);
	КонецЕсли;
	// }
	// 4D
...
Функция ОписаниеГруппНастроек() Экспорт
	...
	// 4D:ERP для Беларуси, Петр, 13.10.2017 11:15:52
	// Функционал "Обмен с банками", №16224
	// {
	ГруппыНастроек.Вставить("ИспользоватьЭлектронныйОбменСБанкамиПоЗарплатнымПроектам", Истина);
	// }
	// 4D
