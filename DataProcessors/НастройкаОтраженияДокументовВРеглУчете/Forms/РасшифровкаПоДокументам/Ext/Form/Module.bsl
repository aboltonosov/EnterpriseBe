...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ГруппаКомандПроверкаДокументов.Видимость = 
		Пользователи.РолиДоступны("ИзменениеРазрешатьИзменятьПроверенныеДокументыПоРеглУчету");
...
Процедура ОбновитьДанныеФормы()
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьПроверкуДокументовПоРегламентированномуУчету") Тогда
		...
		ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(Список, "СписокПроверяемыхТипов", ТипыПроверяемыхДокументов.Типы());
		
		ОбщегоНазначенияКлиентСервер.ДополнитьМассив(МассивТиповДокументов, ТипыПроверяемыхДокументов.Типы(), Истина);
...
Процедура ОтразитьДокументыВУчетеНаСервере(МассивДанных)
	...
	РеглУчетПроведениеСервер.ОтразитьДокументыВРеглУчете(МассивДокументовДляАвтоматическогоОтражения, Истина);
...
Процедура ЗаписатьНовыйСтатусОтражения(МассивДокументов, СтатусОтражения)
	...
	|		Документы КАК ОтборДокументы
	|	ПО
	|		ОтражениеДокументовВРеглУчете.Регистратор = ОтборДокументы.Ссылка
	|ИТОГИ ПО
	|	Регистратор";
