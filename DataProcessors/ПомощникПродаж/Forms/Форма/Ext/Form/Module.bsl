...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// {
	СкидкиНаценкиВызовСервера.ПриСозданииФормыОбработкиПомощникПродажФорма(ЭтаФорма);
	// }
	// 4D
...
Процедура ТоварыВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	// 4D:ERP для Беларуси, Екатерина, 22.04.2016 11:50:23 
	// Расчет скидки к цене, №10910
	// {
	ИначеЕсли Поле = Элементы.ТоварыЦена ИЛИ Поле = Элементы.ТоварыЦенаСоСкидкой Тогда
	// }
	// 4D
...
// 4D:ERP для Беларуси, Екатерина, 22.04.2016 12:05:37 
// Расчет скидки к цене, №10910
// {
&НаКлиенте
