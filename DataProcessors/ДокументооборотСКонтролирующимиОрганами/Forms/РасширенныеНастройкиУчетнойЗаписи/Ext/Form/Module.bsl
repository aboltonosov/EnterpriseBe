...
Процедура КомандаОК(Команда)
	...
	Результат = Новый Структура("НеФормироватьПодтвержденияАвтоматически, ИспользоватьСервисОнлайнПроверкиОтчетов, ЯвляетсяУчетнойЗаписьюУполномоченногоПредставителя, ПолноеНаименованиеУполномоченногоПредставителя, ИННУполномоченногоПредставителя, КППУполномоченногоПредставителя, ИдентификаторСистемыОтправителяПФР, ОтключитьАвтообмен, ИдентификаторСистемыОтправителяФСГС");
