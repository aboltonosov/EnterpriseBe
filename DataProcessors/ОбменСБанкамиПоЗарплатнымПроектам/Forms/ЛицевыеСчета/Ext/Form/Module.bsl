...
// 4D:ERP для Беларуси, Петр, 17.08.2017 17:18:34 
// Ввод данных по лицевым счетам сотрудников замечания, № 15518
// {
&НаКлиенте
Процедура ЛицевыеСчетаПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	
	Если НЕ ЗначениеЗаполнено(ЭтаФорма.Элементы.Организация.ТекстРедактирования) Тогда 
