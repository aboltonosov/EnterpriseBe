...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УправлениеПечатью.ПриСозданииНаСервере(ЭтаФорма, Элементы.ГруппаКоманднаяПанельЗачислениеЗарплатыЛевая);
...
Процедура ЗачислениеЗарплатыПоказатьОтправленныйДокумент(Команда)
	...
	ОбменСБанкамиКлиент.ОткрытьАктуальныйЭД(ТекущиеДанные.Ссылка, ЭтаФорма);
...
Процедура ОткрытиеЛицевыхСчетовПоказатьОтправленныйДокумент(Команда)
	...
	ОбменСБанкамиКлиент.ОткрытьАктуальныйЭД(ТекущиеДанные.ДокументЗаявка, ЭтаФорма);
...
Функция ЗачислениеЗарплатыМассивДокументовВыделенныхСтрок()
	...
	Для каждого ЗаписьРегистра Из Элементы.ЗачислениеЗарплаты.ВыделенныеСтроки Цикл
		Если ТипЗнч(ЗаписьРегистра.ДокументЗачисленияЗарплаты) = Тип("ДокументСсылка.ВедомостьНаВыплатуЗарплатыВБанк") Тогда
...
Функция ЗачислениеЗарплатыВыгрузитьНаСервере()
	...
	Результат = ОбменСБанкамиПоЗарплатнымПроектам.РезультатВыгрузкиФайловДляОбменаСБанком(ЭтаФорма, МассивДокументов);
...
Процедура УстановитьВидимостьЭлементовНаСервере()
	...
	ИспользоватьПередачуВБанкРеестровНаЗачисление = ОбменСБанкамиПоЗарплатнымПроектам.ИспользоватьПередачуВБанкРеестровНаЗачислениеЗарплаты();
	ИспользоватьПрямойЭОИСБанком = ОбменСБанкамиПоЗарплатнымПроектам.ИспользоватьПрямойЭОИСБанком(Объект.ЗарплатныйПроект);
	
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "ЗачислениеЗарплатыВыгрузить", "Видимость", Не ИспользоватьПрямойЭОИСБанком И ИспользоватьПередачуВБанкРеестровНаЗачисление);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "ОткрытиеЛицевыхСчетовВыгрузить", "Видимость", Не ИспользоватьПрямойЭОИСБанком);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "ЗакрытиеЛицевыхСчетовВыгрузить", "Видимость", Не ИспользоватьПрямойЭОИСБанком);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "КаталогФайловГруппа", "Видимость", Не ИспользоватьПрямойЭОИСБанком);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "ЗачислениеЗарплатыОтправитьВБанк", "Видимость", ИспользоватьПрямойЭОИСБанком И ИспользоватьПередачуВБанкРеестровНаЗачисление);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "ОткрытиеЛицевыхСчетовОтправитьВБанк", "Видимость", ИспользоватьПрямойЭОИСБанком);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "ЗакрытиеЛицевыхСчетовОтправитьВБанк", "Видимость", ИспользоватьПрямойЭОИСБанком);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "ВыполнитьСинхронизациюСБанком", "Видимость", ИспользоватьПрямойЭОИСБанком);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "ЗачислениеЗарплатыПоказатьОтправленныйДокумент", "Видимость", ИспользоватьПрямойЭОИСБанком);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "ОткрытиеЛицевыхСчетовПоказатьОтправленныйДокумент", "Видимость", ИспользоватьПрямойЭОИСБанком);
