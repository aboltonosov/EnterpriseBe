...
Процедура ЗаполнитьТабличныйДокументЗаявлениеНаВозвратТоваровОтКлиента(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати)
	...
	// 4D:ERP для Беларуси, Петр, 01.08.2017 16:04:49 
	// <Перенести макеты печатных форм из 2.1.3.266 в 2.2.3.138>, №15620
	// {
	Макет = УправлениеПечатью.МакетПечатнойФормы("Обработка.ПечатьЗаявленияНаВозвратТоваровОтКлиента.ПФ_MXL_ЗаявлениеНаВозвратТоваров_Локализация");
	// }
	// 4D
