...
Процедура ПоказатьИнформационнуюПанель(Результат)
	...
	Если Результат.Свойство("ЕстьОшибки") И Результат.ЕстьОшибки Тогда
...
Процедура ЗавершениеЗаданияВыполнитьКонвертациюЗаказов(АдресХранилища)
	...
	ОповеститьПользователяОРезультатеКонвертации(Результат);
...
Функция ЗавершениеЗаданияНаСервере(АдресХранилища)
	...
	Если ТипЗнч(Результат) = Тип("Структура") Тогда
		...
		ОбработаноЭтапов = Результат.ОбработаноЭтапов;
...
&НаКлиенте
Процедура ОповеститьПользователяОРезультатеКонвертации(ОбработаноЭтапов)
	
	Если ОбработаноЭтапов > 0 Тогда
