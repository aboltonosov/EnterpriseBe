...
Процедура УстановитьОтборыВДинамическихСписках()
	...
	МассивСписков.Добавить(ОтпускаПоУходуЗаРебенком);
	МассивСписков.Добавить(Реестры);
	МассивСписков.Добавить(ОплатаДнейУходаЗаДетьмиИнвалидами);
	МассивСписков.Добавить(ОплатаПособийНаПогребение);
