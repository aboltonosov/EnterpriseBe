...
Процедура ВключитьВерсионированиеДокументовПродажи(Команда)
	...
	Если Результат.Свойство("ВерсионированиеВключено") Тогда
		...
		Если Результат.ВерсионированиеВключено Тогда
			Пояснение = НСтр("ru = 'Для документов продажи установлен вариант версионирования ""Версионировать при проведении""'");
		Иначе
			Пояснение = НСтр("ru = 'Для документов продажи версионирование уже было включено'");
		КонецЕсли;
...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьПродажиНаЭкспортСырьевыхТоваровУслуг" 
		...
		Константы.ИспользоватьПродажиНаЭкспорт.Установить(ИспользоватьПродажиНаЭкспорт);
		
		Если НЕ ИспользоватьПродажиНаЭкспорт Тогда
			НаборКонстант.ВестиУчетТаможенныхДекларацийНаЭкспорт = Ложь;
		КонецЕсли;
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьДоговорыСКлиентами" ИЛИ РеквизитПутьКДанным = "" Тогда
		...
		Элементы.ГруппаКомментарийИспользоватьДоговорыСКлиентами.Видимость = ЗначениеКонстанты;
	КонецЕсли;
	//-- НЕ УТ
