...
Функция СформироватьПечатнуюФормуАктНаПередачуПрав(СтруктураТипов, ОбъектыПечати, ПараметрыПечати, КомплектыПечати = Неопределено) Экспорт
...
Функция ЗаполнитьРеквизитыПодвалаАктНаПередачуПрав(ДанныеПечати, ИтоговыеСуммы, Макет, НомерСтраницы)
	...
	СтруктураПараметров.Вставить("КоличествоЛистовВПриложении", Строка(НомерСтраницы)+Суффикс);
...
Процедура ЗаполнитьТабличныйДокументАктНаПередачуПрав(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати, КомплектыПечати = Неопределено) Экспорт
...
Процедура ЗаполнитьРеквизитыПодвалаМХ1(ОбластьПодвала, ДанныеПечати)
	
	ОбластьПодвала.Параметры.Заполнить(ДанныеПечати);
	
КонецПроцедуры

Процедура ЗаполнитьТабличныйДокументМХ1(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати, КомплектыПечати)
	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		Пока ВыборкаПоСкладам.Следующий() Цикл
			...
			// Выводим итоги по документу
			ЗаполнитьРеквизитыПодвалаМХ1(ОбластьПодвала, ВыборкаДанныеПоСкладу);
			ТабличныйДокумент.Вывести(ОбластьПодвала);
...
Функция СформироватьПечатнуюФормуМХ3(СтруктураТипов, ОбъектыПечати, ПараметрыПечати, КомплектыПечати = Неопределено) Экспорт
	...
	Для Каждого СтруктураОбъектов Из СтруктураТипов Цикл
		...
		Попытка
			...
			ЗаполнитьТабличныйДокументМХ3(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати, КомплектыПечати);
		Исключение
		КонецПопытки;
...
Процедура ЗаполнитьРеквизитыПодвалаМХ3(ОбластьПодвала, ДанныеПечати)
	
	ОбластьПодвала.Параметры.Заполнить(ДанныеПечати);
	
КонецПроцедуры

Процедура ЗаполнитьТабличныйДокументМХ3(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати, КомплектыПечати)
	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		Пока ВыборкаПоСкладам.Следующий() Цикл
			...
			// Выводим итоги по документу
			ЗаполнитьРеквизитыПодвалаМХ3(ОбластьПодвала, ВыборкаДанныеПоСкладу);
			ТабличныйДокумент.Вывести(ОбластьПодвала);
...
Функция СформироватьПечатнуюФормуМХ18(СтруктураТипов, ОбъектыПечати, ПараметрыПечати, КомплектыПечати = Неопределено) Экспорт
	...
	Для Каждого СтруктураОбъектов Из СтруктураТипов Цикл
		...
		ЗаполнитьТабличныйДокументМХ18(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати, КомплектыПечати);
...
Процедура ЗаполнитьТабличныйДокументМХ18(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати, КомплектыПечати)
