...
Процедура ПроверитьЗаполнениеМатериалыИУслуги(МассивНепроверяемыхРеквизитов, Отказ)
	...
	Если НЕ ПроверкаСтрокаМатериалыИУслуги.Пустой() Тогда
		...
		ТекстОшибкиСклад = НСтр("ru='Не указан склад получения материалов в строке %1 списка ""Материалы и работы""'");
		ТекстОшибкиСпецификация = НСтр("ru='Не указана спецификация полуфабриката в строке %1 списка ""Материалы и работы""'");
		ТекстОшибкиЭтапВыпуска = НСтр("ru='Не указан этап выпуска полуфабриката в строке %1 списка ""Материалы и работы""'");
		ТекстОшибкиДатаПотребности = НСтр("ru='Не указана дата потребности в строке %1 списка ""Материалы и работы""'");
