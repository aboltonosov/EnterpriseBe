...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РольКорреспондента          = Параметры.РольКорреспондента;
	...
	НастройкаОтборовНаУзле = ОбменДаннымиСервер.НастройкаОтборовНаУзле(ИмяПланаОбмена, ВерсияКорреспондента, ФормаНастройкиУзлов, ВариантНастройкиОбмена);
