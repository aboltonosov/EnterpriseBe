...
Функция МатериалыСпецификации(Параметры) Экспорт
	...
	ТабличныеЧасти = Справочники.РесурсныеСпецификации.ДанныеСпецификацииПоНоменклатуре(
						ДанныеПоНоменклатуре, Ложь, Ложь, УправлениеПроизводством2_2, ПереченьДанных, МенеджерВременныхТаблиц);
...
Процедура СформироватьЗаказыНаСервере()
	...
	РеквизитыШапки = Новый Структура("Дата, ЖелаемаяДатаОтгрузки, Организация, Подразделение, ЦеховаяКладовая,
