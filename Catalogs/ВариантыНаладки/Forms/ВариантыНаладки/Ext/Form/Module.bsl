...
Процедура ДлительностьПереналадкиТаблицаПриАктивизацииЯчейки(Элемент)
	...
	ТекстВТаблицеВыделеноЦветом = Новый ФорматированнаяСтрока("темно-синим цветом", Новый Шрифт(,,Истина), WebЦвета.ТемноСиний);
	...
	ИначеЕсли ПриоритетНастройки = 1 Тогда
		...
		ПояснениеПоНастройке = Новый ФорматированнаяСтрока(НСтр("ru = 'Длительность определяется по индвидуальной настройке.'"));
	...
	ИначеЕсли ПриоритетНастройки = 2 Тогда
		...
		ПояснениеПоНастройке = Новый ФорматированнаяСтрока(ПояснениеПоНастройкеТекст, " (в таблице выделена ", ТекстВТаблицеВыделеноЦветом, ").");
