...
Процедура НастроитьСписок(Номенклатура = Неопределено, ОтключениеОтбора = Ложь)
	...
	|	НовыйВидНоменклатуры.АлкогольнаяПродукция,
	...
	|	НовыйВидНоменклатуры.ВидАлкогольнойПродукции,
	...
	|	НовыйВидНоменклатуры.ВариантНастройкиСерийДляСкладов,
	|	НовыйВидНоменклатуры.ВариантНастройкиСерийДляПодразделений,
	...
	|	НовыйВидНоменклатуры.ИмпортнаяАлкогольнаяПродукция,
	...
	|	НовыйВидНоменклатуры.СодержитДрагоценныеМатериалы,
	...
	|	НовыйВидНоменклатуры.КодОКВЭД,
	|	НовыйВидНоменклатуры.КодТНВЭД,
