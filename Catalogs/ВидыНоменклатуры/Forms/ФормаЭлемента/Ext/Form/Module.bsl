...
Процедура НастройкаСерийПоСкладамПриИзменении(Элемент)
	...
	Если Объект.ВариантНастройкиСерийДляСкладов = ПредопределенноеЗначение("Перечисление.ВариантыНастроекСерий.ЕдинаяНастройка") Тогда
	...
	КонецЕсли;	
	НастроитьФорму();
	УстановитьУсловноеОформлениеПолитикиУчетаСерий();
КонецПроцедуры

&НаКлиенте
Процедура НастройкаСерийПоПозраделениямПриИзменении(Элемент)
	
	Если Объект.ВариантНастройкиСерийДляПодразделений = ПредопределенноеЗначение("Перечисление.ВариантыНастроекСерий.ЕдинаяНастройка") Тогда
		Индекс = Объект.ПолитикиУчетаСерий.Количество();
...
Процедура НастроитьФорму()
	...
	Элементы.НадписьНастройкаИспользованияСерий.Видимость = Элементы.ИспользоватьСерии.Видимость
	...
	Элементы.НастройкаСерийПоСкладам1.Видимость = Элементы.ИспользоватьСерии.Видимость
													И Объект.ИспользоватьСерии
													И Не Объект.НастройкиСерийБерутсяИзДругогоВидаНоменклатуры
													И ИспользоватьНесколькоСкладов;
	
	Элементы.НастройкаСерийПоСкладам2.Видимость = Элементы.ИспользоватьСерии.Видимость
													И Объект.ИспользоватьСерии
													И Не Объект.НастройкиСерийБерутсяИзДругогоВидаНоменклатуры
													И ИспользоватьНесколькоСкладов;
													
	Элементы.НастройкаСерийПоСкладам3.Видимость = Элементы.ИспользоватьСерии.Видимость
													И Объект.ИспользоватьСерии
													И Не Объект.НастройкиСерийБерутсяИзДругогоВидаНоменклатуры
													И ИспользоватьНесколькоСкладов
	...
	Элементы.ПолитикаУчетаСерийНаСкладах.Видимость = Объект.ИспользоватьСерии
													И Не Объект.НастройкиСерийБерутсяИзДругогоВидаНоменклатуры
													И ИспользоватьНесколькоСкладов;
	Элементы.ПолитикаУчетаСерийНаСкладах.Доступность = Объект.ВариантНастройкиСерийДляСкладов = Перечисления.ВариантыНастроекСерий.ЕдинаяНастройка;
	Элементы.ПолитикаУчетаСерийНаСкладах.АвтоОтметкаНезаполненного = Объект.ВариантНастройкиСерийДляСкладов = Перечисления.ВариантыНастроекСерий.ЕдинаяНастройка;
	...
	Элементы.ПодсказкаНастройкаСерийПоСкладам1.Видимость = Элементы.НастройкаСерийПоСкладам1.Видимость
															...
															И Объект.ВариантНастройкиСерийДляСкладов = Перечисления.ВариантыНастроекСерий.ЕдинаяНастройка;
													
	Элементы.НастройкаСерийПоПозраделениям1.Видимость = Элементы.ИспользоватьСерии.Видимость
													И Объект.ИспользоватьСерии
													И Не Объект.НастройкиСерийБерутсяИзДругогоВидаНоменклатуры
													И ИспользоватьПроизводство;
	
	Элементы.НастройкаСерийПоПозраделениям2.Видимость = Элементы.ИспользоватьСерии.Видимость
													И Объект.ИспользоватьСерии
													И Не Объект.НастройкиСерийБерутсяИзДругогоВидаНоменклатуры
													И ИспользоватьПроизводство;
													
	Элементы.НастройкаСерийПоПозраделениям3.Видимость = Элементы.ИспользоватьСерии.Видимость
													И Объект.ИспользоватьСерии
													И Не Объект.НастройкиСерийБерутсяИзДругогоВидаНоменклатуры
													И ИспользоватьПроизводство;
	...
	Элементы.ПолитикаУчетаСерийНаВПодраделениях.Доступность = Объект.ВариантНастройкиСерийДляПодразделений = Перечисления.ВариантыНастроекСерий.ЕдинаяНастройка;
	Элементы.ПолитикаУчетаСерийНаВПодраделениях.АвтоОтметкаНезаполненного = Объект.ВариантНастройкиСерийДляПодразделений = Перечисления.ВариантыНастроекСерий.ЕдинаяНастройка;
	...
	Элементы.НадписьПодсказкаПолитикиУчетаСерийОдинСклад.Видимость = Элементы.ИспользоватьСерии.Видимость
																	И Объект.ИспользоватьСерии
																	И Не ИспользоватьНесколькоСкладов
																	И Не ИспользоватьОрдернуюСхемуПриОтраженииИзлишковНедостач
																	И Не Объект.НастройкиСерийБерутсяИзДругогоВидаНоменклатуры;
	
	Элементы.ПолитикиУчетаСерий.Видимость = Элементы.ИспользоватьСерии.Видимость
											И Объект.ИспользоватьСерии
											И (ИспользоватьНесколькоСкладов
												Или ИспользоватьПроизводство)
											И Не Объект.НастройкиСерийБерутсяИзДругогоВидаНоменклатуры
											И (Объект.ВариантНастройкиСерийДляПодразделений = Перечисления.ВариантыНастроекСерий.РазныеНастройки
													И ИспользоватьПроизводство
												Или Объект.ВариантНастройкиСерийДляСкладов = Перечисления.ВариантыНастроекСерий.РазныеНастройки);
								
	ВТЧУказываютсяСкладыИПодразделения =  ИспользоватьНесколькоСкладов
											И ИспользоватьПроизводство
											И Объект.ВариантНастройкиСерийДляСкладов = Перечисления.ВариантыНастроекСерий.РазныеНастройки
											И Объект.ВариантНастройкиСерийДляПодразделений = Перечисления.ВариантыНастроекСерий.РазныеНастройки;											
	...
	Если ВТЧУказываютсяСкладыИПодразделения Тогда 
		Элементы.ПолитикиУчетаСерийСклад.Заголовок = НСтр("ru = 'Склад или подразделение'");
		Элементы.ПолитикиУчетаСерийСклад.Подсказка = НСтр("ru = 'Склад или подразделение, в котором ведется учет по сериям'");
	...
	ИначеЕсли ИспользоватьНесколькоСкладов
		И Объект.ВариантНастройкиСерийДляСкладов = Перечисления.ВариантыНастроекСерий.РазныеНастройки Тогда
		Элементы.ПолитикиУчетаСерийСклад.Заголовок = НСтр("ru = 'Склад'");
		Элементы.ПолитикиУчетаСерийСклад.Подсказка = НСтр("ru = 'Склад, в котором ведется учет по сериям'");
	...
	Иначе
		Элементы.ПолитикиУчетаСерийСклад.Заголовок = НСтр("ru = 'Подразделение'");
		Элементы.ПолитикиУчетаСерийСклад.Подсказка = НСтр("ru = 'Подразделение, в котором ведется учет по сериям'");
	...
	Элементы.ГруппаРеквизитыДляКонтроляСерий.Видимость = Элементы.ИспользоватьСерии.Видимость
													И Объект.ИспользоватьСерии
													И Не Объект.НастройкиСерийБерутсяИзДругогоВидаНоменклатуры;
	
	Элементы.ГруппаШаблоныНаименованийСерий.Видимость = Элементы.ИспользоватьСерии.Видимость
													И Объект.ИспользоватьСерии
													И Не Объект.НастройкиСерийБерутсяИзДругогоВидаНоменклатуры;
	
	Элементы.ТаблицаДопРеквизитовСерий.Видимость = Элементы.ИспользоватьСерии.Видимость
													И Объект.ИспользоватьСерии
													И Не Объект.НастройкиСерийБерутсяИзДругогоВидаНоменклатуры;
	
	Элементы.ТаблицаДопСведенийСерий.Видимость = Элементы.ИспользоватьСерии.Видимость
													И Объект.ИспользоватьСерии
													И Не Объект.НастройкиСерийБерутсяИзДругогоВидаНоменклатуры;
	
	Элементы.ШаблонЭтикеткиСерии.Видимость = Элементы.ИспользоватьСерии.Видимость
													И Объект.ИспользоватьСерии;
	
	Элементы.ПоказатьРеквизитыДляКонтроляСерий.Видимость = Элементы.ИспользоватьСерии.Видимость
													И Объект.ИспользоватьСерии
													И Не Объект.НастройкиСерийБерутсяИзДругогоВидаНоменклатуры;
	
	Элементы.ПоказатьРеквизитыДляКонтроляНоменклатуры.Видимость = (Элементы.ИспользоватьСерии.Видимость
																		И Объект.ИспользоватьСерии
																		И Не Объект.НастройкиСерийБерутсяИзДругогоВидаНоменклатуры)
...
Процедура УстановитьНастройкуИспользованияСерий()
	Если Объект.ПродукцияМаркируемаяДляГИСМ
		...
		Объект.ВариантНастройкиСерийДляСкладов = Перечисления.ВариантыНастроекСерий.ЕдинаяНастройка;
		
		Если ИспользоватьПроизводство Тогда
			Объект.ВариантНастройкиСерийДляПодразделений = Перечисления.ВариантыНастроекСерий.ЕдинаяНастройка;
		КонецЕсли;
	...
	ИначеЕсли Объект.ИспользоватьСерии Тогда
		...
		Если ИспользоватьПроизводство Тогда
			Объект.ВариантНастройкиСерийДляПодразделений = Перечисления.ВариантыНастроекСерий.ЕдинаяНастройка;
		Иначе
			Объект.ВариантНастройкиСерийДляПодразделений = Перечисления.ВариантыНастроекСерий.НеНастраивается;
		КонецЕсли;
	Иначе
		Объект.НастройкаИспользованияСерий = Перечисления.НастройкиИспользованияСерийНоменклатуры.ПустаяСсылка();
	КонецЕсли;
...
&НаСервере
Процедура УстановитьУсловноеОформлениеПолитикиУчетаСерий()
	
	ЭлементНайден = Ложь;
	ПолеКомпановки = Новый ПолеКомпоновкиДанных("ПолитикиУчетаСерийПолитикаУчетаСерий");
	
	Для Каждого Элемент Из УсловноеОформление.Элементы Цикл
		
		ЭлементыПоля = Элемент.Поля.Элементы;
		
		Для Каждого Поле Из ЭлементыПоля Цикл
			
			Если Не Поле.Поле = ПолеКомпановки Тогда
				Прервать;
			Иначе
		...
		Если Объект.ВариантНастройкиСерийДляСкладов = Перечисления.ВариантыНастроекСерий.ЕдинаяНастройка
			И Объект.ВариантНастройкиСерийДляПодразделений <> Перечисления.ВариантыНастроекСерий.ЕдинаяНастройка Тогда
			
			Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = '<выберите подразделение>'"));
