...
Процедура УстановитьПредставлениеОкладаИФОТ(Форма)
	...
	#Если Клиент Тогда
		УправленческаяПодсистемаСуществует = ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.УправленческаяЗарплата");
	#Иначе
		УправленческаяПодсистемаСуществует = ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.УправленческаяЗарплата");
	#КонецЕсли
	
	Если УправленческаяПодсистемаСуществует Тогда
