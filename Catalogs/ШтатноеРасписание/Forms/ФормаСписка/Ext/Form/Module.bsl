...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИсключаемыеПоля = "ЭтоГруппа,Утверждена,Закрыта,ГруппаНеЗакрыта";
	Если Элементы.Список.РежимВыбора И Параметры.Отбор.Свойство("Владелец") Тогда
		ИсключаемыеПоля = ИсключаемыеПоля + ",Владелец";
	КонецЕсли;
...
// 4D:ERP для Беларуси, Яна, 04.08.2017 17:32:11 
