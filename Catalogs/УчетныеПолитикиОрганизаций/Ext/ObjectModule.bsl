...
Процедура ПриЗаписи(Отказ)
	...
	Пока Выборка.Следующий() Цикл
		...
		СтрокаНабора.ПлательщикНалогаНаПрибыль = Не ЭтотОбъект.СистемаНалогообложения = Перечисления.СистемыНалогообложения.Упрощенная И Выборка.ЮрФизЛицо = Перечисления.ЮрФизЛицо.ЮрЛицо;
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Если ПрименяетсяПБУ18 Тогда
		СхемаУчетаСтоимостиОСвНУ = Перечисления.СхемыУчетаСтоимостиОСвНУ.СФормированиемВР;
	Иначе
		СхемаУчетаСтоимостиОСвНУ = Перечисления.СхемыУчетаСтоимостиОСвНУ.СФормированиемПР;
	КонецЕсли;
