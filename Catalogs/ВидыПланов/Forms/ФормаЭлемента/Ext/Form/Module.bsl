...
Процедура УстановитьВидимость(Форма)
	...
	//++ НЕ УТКА
	Форма.Элементы.ПланироватьПолуфабрикатыАвтоматически.Видимость = ЭтоПланПроизводства И Форма.ИспользоватьДляПланированияМатериалов;
	//-- НЕ УТКА
	...
	//++ НЕ УТ
	Форма.Элементы.ОтражаетсяВБюджетированииОплаты.Видимость = (ЭтоПланЗапкупок ИЛИ ЭтоПланПродаж) И Форма.ПравоПросмотраСтатейБюджетов;
	Форма.Элементы.СтатьяБюджетовОплат.Видимость = (ЭтоПланЗапкупок ИЛИ ЭтоПланПродаж) И Форма.ПравоПросмотраСтатейБюджетов;
	Форма.Элементы.ОтражаетсяВБюджетированииОплатыКредит.Видимость = (ЭтоПланЗапкупок ИЛИ ЭтоПланПродаж) И Форма.ПравоПросмотраСтатейБюджетов;
	Форма.Элементы.СтатьяБюджетовОплатКредит.Видимость = (ЭтоПланЗапкупок ИЛИ ЭтоПланПродаж) И Форма.ПравоПросмотраСтатейБюджетов;
	
	Если Форма.ОтражаетсяВБюджетировании И Форма.ПравоПросмотраСтатейБюджетов Тогда 
		Если ЭтоПланЗапкупок Тогда
