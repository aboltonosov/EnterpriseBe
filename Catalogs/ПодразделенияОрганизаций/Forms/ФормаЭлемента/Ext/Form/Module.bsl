...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Ключ.Пустая() Тогда
		...
		ДоступноРедактированиеБухучетЗарплатыПодразделений = Пользователи.РолиДоступны("ДобавлениеИзменениеБухгалтерскогоУчетаЗарплаты");
...
Процедура ТерриториальныеУсловияПФРПриИзменении(Элемент)
	...
	ЗарплатаКадрыРасширенныйКлиентСервер.УстановитьПроцентЗаОсобыеКлиматическиеУсловия(
		ЭтаФорма, Объект.ПроцентСевернойНадбавки, ТерриториальныеУсловияПФР.ТерриториальныеУсловияПФР);
...
Процедура РодительПриИзменении(Элемент)
	...
	УстановитьНомерТерриториальногоОрганаРосстата(ЭтаФорма);
...
Процедура ЗаписатьТерриториальныеУсловияПФР()
	...
	РедактированиеПериодическихСведений.ЗаписатьЗаписьПослеРедактированияВФорме(ЭтаФорма, "ТерриториальныеУсловияПФР", СсылкаНаОбъект);
...
Процедура ЗаписатьНаКлиенте(ЗакрытьПослеЗаписи, ОповещениеЗавершения = Неопределено) Экспорт 
	...
	РедактированиеПериодическихСведенийКлиент.ЗапроситьРежимИзмененияРегистра(ЭтаФорма,"ТерриториальныеУсловияПФР", ТекстВопроса, ТекстКнопкиДа, Ложь, Оповещение);
