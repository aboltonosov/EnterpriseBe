...
Функция ПолучитьБлокируемыеРеквизитыОбъекта() Экспорт
	...
	// {
	Результат.Добавить("РозничнаяСтавкаНДС");
	// }
	// 4D
...
Функция ЗначенияРеквизитовНоменклатуры(Номенклатура) Экспорт
	...
	// Розничная торговля, №15729
	// {
	|	Номенклатура.РозничнаяСтавкаНДС,
	// }
	// 4D
	...
	Если Выборка.Следующий() Тогда
		...
		// Розничная торговля, №15729
		// {
		РозничнаяСтавкаНДС = Выборка.РозничнаяСтавкаНДС;
		// }
		// 4D
	...
	// Розничная торговля, №15729
	// {
	СтруктураРеквизитов.Вставить("РозничнаяСтавкаНДС",РозничнаяСтавкаНДС);
	// }
	// 4D
...
Процедура ЗаполнитьРеквизитыПоВидуНоменклатуры(Номенклатура,
	...
	+"СтранаПроисхождения,РозничнаяСтавкаНДС";
	// }
	// 4D
...
Функция ТабличныйДокументКарточкиНоменклатуры(Номенклатура, НастройкиВидимостиИЗаголовков) Экспорт
	...
	Если ГлаваВидна("СведенияОПроизводителе", СтруктураВидимости) Тогда 
		...
		// 4D:ERP для Беларуси, Дмитрий, 03.11.2017 21:20:47 
		// Страна происхождения, №16517 
		// {
		Если РазделВиден("СтранаПроисхождения", СтруктураВидимости) Тогда 
			ВывестиРазделСУчетомРазмераЗначений(ТабличныйДокументЛево, Макет, "СтранаПроисхождения", Объект.СтранаПроисхождения);
		КонецЕсли;
		// }
		// 4D
	...
	Если ГлаваВидна("РегламентированныйИФинансовыйУчет", СтруктураВидимости) Тогда 
		...
		// Розничная торговля, №15729
		// {
		Если ПолучитьФункциональнуюОпцию("ИспользоватьРозничныеПродажи") И РазделВиден("РозничнаяСтавкаНДС", СтруктураВидимости) Тогда 
			ВывестиРазделСУчетомРазмераЗначений(ТабличныйДокументПраво, Макет, "РозничнаяСтавкаНДС", Объект.РозничнаяСтавкаНДС);
		КонецЕсли;
		// }
		// 4D
...
Функция ТекстЗначенияНеЗаполнен(ИмяРаздела)
	...
	// 4D:ERP для Беларуси, Дмитрий, 03.11.2017 21:44:10 
	// Страна происхождения, №16517 
	// {
...
Функция НеиспользуемыеДляКонтроляУникальностиРеквизиты() Экспорт
	...
	// 4D:ERP для Беларуси, Дмитрий, 03.11.2017 21:10:43 
	// Страна происхождения, №16517 
	// {
