...
Процедура ПроверитьЗаписатьНаСервере(Отказ)
	...
	Для Каждого СтрокаДрагоценныйМатериал Из СправочникОбъект.ДрагоценныеМатериалы Цикл
		...
		Если Не ЗначениеЗаполнено(СтрокаДрагоценныйМатериал.Расположение) 
			//++ НЕ УТ
			И СтрокаДрагоценныйМатериал.ДрагоценныйМатериал = ПредопределенноеЗначение("Справочник.ДрагоценныеМатериалы.Алмазы")
			//-- НЕ УТ
			Тогда
...
Процедура УстановитьУсловноеОформление()
	...
	ОтборЭлемента.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("Номенклатура.ДрагоценныеМатериалы.ДрагоценныйМатериал");
