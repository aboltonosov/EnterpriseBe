...
Процедура ЗаполнитьВидыОбразований() Экспорт
	...
	// 4D:ERP для Беларуси, Яна, 13.06.2017 10:45:50 
	// Редактировать предопределенные элементы в справочнике "Виды образования", №14841 
	// {
	СоответствиеЭлементовФасету = Новый Соответствие;	
	СоответствиеЭлементовФасету.Вставить(Справочники.ВидыОбразованияФизическихЛиц.ВысшееОбразование, 30);
	СоответствиеЭлементовФасету.Вставить(Справочники.ВидыОбразованияФизическихЛиц.ДошкольноеОбразование, 30);
	СоответствиеЭлементовФасету.Вставить(Справочники.ВидыОбразованияФизическихЛиц.ПослевузовскоеОбразование, 30);
	СоответствиеЭлементовФасету.Вставить(Справочники.ВидыОбразованияФизическихЛиц.ОбщееБазовоеОбразование, 30);
	СоответствиеЭлементовФасету.Вставить(Справочники.ВидыОбразованияФизическихЛиц.СреднееОбщееОбразование, 30);
	СоответствиеЭлементовФасету.Вставить(Справочники.ВидыОбразованияФизическихЛиц.ПрофессиональноТехническоеОбразование, 30);
	СоответствиеЭлементовФасету.Вставить(Справочники.ВидыОбразованияФизическихЛиц.СреднееСпециальноеОбразование, 30);
	// }
	// 4D
