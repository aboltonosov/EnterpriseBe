...
Процедура ДобавитьКомандыСозданияНаОсновании(КомандыСоздатьНаОсновании) Экспорт
	...
	КомандаСоздания = Документы.АктВыполненныхРабот.ДобавитьКомандуСоздатьНаОсновании(КомандыСоздатьНаОсновании);
	Если КомандаСоздания <> Неопределено Тогда
		КомандаСоздания.СписокФорм = "ФормаСписка,ФормаСпискаИндивидуальныхСоглашений";
	КонецЕсли;
	...
	КомандаСоздания = Документы.ЗаказКлиента.ДобавитьКомандуСоздатьНаОсновании(КомандыСоздатьНаОсновании);
	Если КомандаСоздания <> Неопределено Тогда
		КомандаСоздания.СписокФорм = "ФормаСписка,ФормаСпискаИндивидуальныхСоглашений";
	КонецЕсли;
	
	КомандаСоздания = Документы.ЗаявкаНаВозвратТоваровОтКлиента.ДобавитьКомандуСоздатьНаОсновании(КомандыСоздатьНаОсновании);
	Если КомандаСоздания <> Неопределено Тогда
		КомандаСоздания.СписокФорм = "ФормаСписка,ФормаСпискаИндивидуальныхСоглашений";
	КонецЕсли;
	
	КомандаСоздания = Документы.КоммерческоеПредложениеКлиенту.ДобавитьКомандуСоздатьНаОсновании(КомандыСоздатьНаОсновании);
	Если КомандаСоздания <> Неопределено Тогда
		КомандаСоздания.СписокФорм = "ФормаСписка,ФормаСпискаИндивидуальныхСоглашений";
	КонецЕсли;
	
	КомандаСоздания = Документы.РеализацияТоваровУслуг.ДобавитьКомандуСоздатьНаОсновании(КомандыСоздатьНаОсновании);
	Если КомандаСоздания <> Неопределено Тогда
		КомандаСоздания.СписокФорм = "ФормаСписка,ФормаСпискаИндивидуальныхСоглашений";
	КонецЕсли;
	
	КомандаСоздания = Документы.РеализацияУслугПрочихАктивов.ДобавитьКомандуСоздатьНаОсновании(КомандыСоздатьНаОсновании);
	Если КомандаСоздания <> Неопределено Тогда
		КомандаСоздания.СписокФорм = "ФормаСписка,ФормаСпискаИндивидуальныхСоглашений";
	КонецЕсли;
...
// заполняет реквизит "Валюта взаиморасчетов" справочника "СоглашенияСКлиентами".
//
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|	Справочник.СоглашенияСКлиентами КАК СоглашенияСКлиентами
	|ГДЕ
	|	(СоглашенияСКлиентами.ВалютаВзаиморасчетов = ЗНАЧЕНИЕ(Справочник.Валюты.ПустаяСсылка)
	|			ИЛИ СоглашенияСКлиентами.УдалитьРазбиватьРасходныеОрдераПоРаспоряжениям
	|				И НЕ СоглашенияСКлиентами.РазбиватьРасходныеОрдераПоРаспоряжениям)";	
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Если СправочникОбъект.УдалитьРазбиватьРасходныеОрдераПоРаспоряжениям 
			И Не СправочникОбъект.РазбиватьРасходныеОрдераПоРаспоряжениям Тогда
			СправочникОбъект.РазбиватьРасходныеОрдераПоРаспоряжениям = СправочникОбъект.УдалитьРазбиватьРасходныеОрдераПоРаспоряжениям;
			ОбъектИзменен = Истина;
		КонецЕсли;
