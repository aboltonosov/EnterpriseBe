// 4D:ERP для Беларуси, ВладимирР, 27.09.2017 14:42:21 
// Обновлено из ERP demo 2_2_3_231
// {
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокВыбора.Добавить("Сумма",Строка(ВалютаМУ.Функциональная)+" ("+НСтр("ru = 'функциональная валюта'")+")");
	СписокВыбора.Добавить("СуммаПредставления",Строка(ВалютаМУ.Представления)+" ("+НСтр("ru = 'валюта представления'")+")");
