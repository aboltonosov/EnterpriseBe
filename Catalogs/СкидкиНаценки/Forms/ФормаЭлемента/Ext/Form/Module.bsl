...
Процедура ОбновитьПредставлениеУточненияЗначенияСкидкиНаценки()
	...
	Если Объект.ЦеновыеГруппы.Количество() = 0 Тогда
		УточнениеПоЦеновымГруппамПредставление = Новый ФорматированнаяСтрока("Уточнить",,,,"Изменить");
	Иначе
		УточнениеПоЦеновымГруппамПредставление = Новый ФорматированнаяСтрока("Есть уточнения",,,,"Изменить");
	КонецЕсли;
