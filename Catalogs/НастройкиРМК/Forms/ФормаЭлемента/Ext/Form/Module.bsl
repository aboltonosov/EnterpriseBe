...
Процедура ОткрытьФормуПараметрыПодключенияЕГАИС(ТекущаяСтрока)
	...
	Если ЗначениеЗаполнено(ТекущаяСтрока.СтатусПодключенияКЕгаис)
		...
		ПараметрыЗаписи.Вставить("УдалитьИзмерениеОрганизация", ТекущаяСтрока.УдалитьИзмерениеОрганизация);
		ПараметрыЗаписи.Вставить("УдалитьИзмерениеСклад",       ТекущаяСтрока.УдалитьИзмерениеСклад);
