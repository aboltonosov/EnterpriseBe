...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	// 4D:ERP для Беларуси, Юлия, 29.12.2017 11:01:18 
	// При вводе отпуска без оплаты в справочник "Виды отпусков" требует заполнение поля "Количество дней в год", а не должно, № 17246
	// {
	...
	Если Не ПредоставлятьОтпускВсемСотрудникам Тогда
