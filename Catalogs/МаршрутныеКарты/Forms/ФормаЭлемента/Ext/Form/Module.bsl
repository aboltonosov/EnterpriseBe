...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	ЗаполнитьЕстьАвтовыборМатериалов();
...
Процедура УстановитьУсловноеОформление()
	...
	ОтборЭлемента = Элемент.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ОтборЭлемента.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("ЕстьАвтовыборМатериалов");
	ОтборЭлемента.ВидСравнения = ВидСравненияКомпоновкиДанных.Равно;
	ОтборЭлемента.ПравоеЗначение = Ложь;
...
&НаСервере
Процедура ЗаполнитьЕстьАвтовыборМатериалов()
	
	ЕстьАвтовыборМатериалов = Справочники.МаршрутныеКарты.ЕстьАвтовыборМатериалов(Объект.МатериалыИУслуги);
