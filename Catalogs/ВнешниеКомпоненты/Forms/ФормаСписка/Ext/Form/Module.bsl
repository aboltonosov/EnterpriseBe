...
Процедура ОбновитьВнешниеКомпоненты(Знач УникальныйИдентификатор, Результат)
	...
	Результат = ДлительныеОперации.ВыполнитьВФоне(
		"Справочники.ВнешниеКомпоненты.ОбновитьВнешниеКомпоненты", Новый Структура, ПараметрыВыполнения);
...
Процедура СоздатьЭлементСправочникаВКНаСервере(Адрес)
	...
	ИнформацияОВК = Справочники.ВнешниеКомпоненты.ИнформацияОВК(Адрес);
