...
// Процедура заполнения колонок "ИнвентарныйУчет", "СпособПогашенияСтоимостиБУ" и "СпособПогашенияСтоимостиНУ" в таблице формы
//
// Параметры:
// 		ТаблицаФормы - ДанныеФормыКоллекция - Таблица фомры для которой заполняются признаки
//
