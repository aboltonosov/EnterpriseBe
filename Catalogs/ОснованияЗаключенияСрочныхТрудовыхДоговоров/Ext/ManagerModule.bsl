...
Процедура ИсправитьНаименованиеП9Ч1Ст59ИУдалитьЗадвоенныеЭлементы() Экспорт
	...
	Если ЗначениеЗаполнено(Оригинал) Тогда
		...
		// 4D:ERP для Беларуси, Алеся, 18.08.2017 9:27:53 
		// <Спр. "Основания заключения срочных трудовых договор">, № 15753
		// {
		КлассификаторСправочника = ОбщегоНазначения.ПрочитатьXMLВТаблицу(
			Справочники.ОснованияЗаключенияСрочныхТрудовыхДоговоров.ПолучитьМакет("ОснованияЗаключенияСрочныхТрудовыхДоговоров_Локализация").ПолучитьТекст()).Данные;
		// }
		// 4D
...
Функция ИмяМакетаКлассификатора()
	...
	// 4D:ERP для Беларуси, Алеся, 18.08.2017 9:30:22 
	// <Спр. "Основания заключения срочных трудовых договор">, № 15753
	// {
	Возврат "ОснованияЗаключенияСрочныхТрудовыхДоговоров_Локализация";
	// }
	// 4D
