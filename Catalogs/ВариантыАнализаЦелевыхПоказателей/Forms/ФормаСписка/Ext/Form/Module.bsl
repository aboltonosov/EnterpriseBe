...
Процедура УстановитьДоступностьКомандПорядка(Элементы)
	...
	Если Элементы.ВариантыАнализаСписок.ТекущаяСтрока = Неопределено Тогда
		Элементы.ПереместитьЭлементВверх.Доступность = Ложь;
		Элементы.ПереместитьЭлементВниз.Доступность = Ложь;
		Элементы.ПереместитьЭлементВверхКонтекстноеМеню.Доступность = Ложь;
		Элементы.ПереместитьЭлементВнизКонтекстноеМеню.Доступность = Ложь;
		
	Иначе
		Элементы.ПереместитьЭлементВверх.Доступность = Истина;
		Элементы.ПереместитьЭлементВниз.Доступность = Истина;
		Элементы.ПереместитьЭлементВверхКонтекстноеМеню.Доступность = Истина;
		Элементы.ПереместитьЭлементВнизКонтекстноеМеню.Доступность = Истина;
		
	КонецЕсли;
	
	Если Элементы.СтруктураЦелейСписок.ТекущаяСтрока = Неопределено Тогда
		Элементы.СтруктураЦелейСписокПереместитьЭлементЦелиВверх.Доступность = Ложь;
		Элементы.СтруктураЦелейСписокПереместитьЭлементЦелиВниз.Доступность = Ложь;
		
	Иначе
		Элементы.СтруктураЦелейСписокПереместитьЭлементЦелиВверх.Доступность = Истина;
		Элементы.СтруктураЦелейСписокПереместитьЭлементЦелиВниз.Доступность = Истина;
