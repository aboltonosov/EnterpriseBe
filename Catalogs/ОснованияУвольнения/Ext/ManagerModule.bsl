...
Функция ТаблицаКлассификатора()
	...
	// 4D:ERP для Беларуси, Яна, 10.08.2017 17:44:12 
	// Справочник "Основания увольнения", № 15713 
	// {
	КлассификаторXML = Справочники.ОснованияУвольнения.ПолучитьМакет("ОснованияУвольненияПоТКРБ_Локализация").ПолучитьТекст();
	// }
	// 4D	
