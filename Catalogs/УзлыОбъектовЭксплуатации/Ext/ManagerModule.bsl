...
// 		СтруктураДополнительныхСвойств - Структура - Структура доп. свойст для записи объекта
...
//
// Параметры:
// 		ОбъектПроверки - Массив, СправочникСсылка.УзвлыОбъектовЭксплуатации - Ссылка на проверяемый объект или массив объектов
