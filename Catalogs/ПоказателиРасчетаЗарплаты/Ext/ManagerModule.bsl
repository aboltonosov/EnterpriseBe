...
Процедура СоздатьПоказателиПоНастройкам(НастройкиРасчетаЗарплаты = Неопределено, ПараметрыПланаВидовРасчета = Неопределено) Экспорт
	...
	// 4D:ERP для Беларуси, Петр, 11.09.2017 15:05:44 
	// Локализация документа "Премии", №15462
	// {
	ОписаниеПоказателя = ОписаниеПоказателя();
	...
	// 4D:ERP для Беларуси, Петр, 30.01.2018 18:01:01 
	// Анализ расчета суммы единовременной выплаты к отпуску, № 17575
	// {
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "СреднийЗаработокОбщийДвеНедели";
	ОписаниеПоказателя.Наименование = НСтр("ru = 'Средний заработок (пособие за 2 недели)'");
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru = 'Ср. заработок (2 нед.)'");
	ОписаниеПоказателя.Точность = 2;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "СреднийЗаработокОбщийТриМесяца";
	ОписаниеПоказателя.Наименование = НСтр("ru = 'Средний заработок (пособие за 3 месяца)'");
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru = 'Ср. заработок (3 мес.)'");
	ОписаниеПоказателя.Точность = 2;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "МесяцевВыходногоПособия";
	ОписаниеПоказателя.Наименование = НСтр("ru = 'Количество месяцев выходного пособия'");
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru = 'Месяцев вых. пособия.'");
	...
	// 4D:ERP для Беларуси, , 06.12.2017 14:21:42 
	// Создать новые виды начислений и назначений начислений для оплаты больничных листов, №16969
	// {
	// Тарифный Оклад
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "ТарифныйОклад";
	ОписаниеПоказателя.Наименование = НСтр("ru = 'Тарифный оклад'");
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru = 'Тариф. оклад'");   
	ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
	ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Истина;
	ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
	ОписаниеПоказателя.Точность = ПараметрыПоказателей.ОкладТарифТочность;
	...
	// 4D:ERP для Беларуси, Яна, 20.06.2017 15:42:25 
	// Документ "Отпуск по уходу за ребенком", №14900, 14877, 15145  
	// {
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "ПроцентПособияДоТрехЛет";
	ОписаниеПоказателя.Наименование = НСтр("ru = 'Процент пособия по уходу за ребенком до 3 лет '");
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru = 'Процент пособие до трех лет'");
	ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Истина;
	ОписаниеПоказателя.Точность = 2;
	ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;	
	ЗаписатьПоказатель(ОписаниеПоказателя);	
	...
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "РазмерПособияПоУходуЗаРебенкомДоТрехЛетНаВторогоРебенка";
	ОписаниеПоказателя.Наименование = НСтр("ru = 'Размер пособия по уходу за ребенком до 3 лет на второго и последующих детей'");
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru = 'Пособие до трех лет на второго'");
	ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
	ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "ПроцентПособияДоТрехЛетНаВторогоРебенка";
	ОписаниеПоказателя.Наименование = НСтр("ru = 'Процент пособия по уходу за ребенком до 3 лет на второго и последующих детей'");
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru = 'Процент пособия до трех лет на второго'");
	ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Истина;
	ОписаниеПоказателя.Точность = 2;
	ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;	
	ЗаписатьПоказатель(ОписаниеПоказателя);
	
	//пособие 50 процентов БПМ
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "РазмерПособияПоУходуЗаРебенкомДоТрехЛет50ПроцентовБПМ";
	ОписаниеПоказателя.Наименование = НСтр("ru = 'Размер пособия по уходу за ребенком до 3 лет 50 процентов бюджета прожиточного минимума'");
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru = 'Пособие до трех лет 50 % БПМ'");
	ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;	
	ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
	ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	...
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "ПроцентПособияДоТрехЛетНаРебенкаИнвалида";
	ОписаниеПоказателя.Наименование = НСтр("ru = 'Процент пособия по уходу за ребенком до 3 лет на ребенка-инвалида'");
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru = 'Процент пособие до 3 лет на ребенка-инвалида'");
	ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Истина;
	ОписаниеПоказателя.Точность = 2;
	ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;	
	ЗаписатьПоказатель(ОписаниеПоказателя);	
	...
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "РазмерПособияПоУходуЗаРебенкомДоТрехЛетНаРебенкаИнвалида";
	ОписаниеПоказателя.Наименование = НСтр("ru = 'Размер пособия по уходу за ребенком до трех лет на ребенка-инвалида'");
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru = 'Пособие до трех лет на ребенка-инвалида'");
	ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
	ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
	ЗаписатьПоказатель(ОписаниеПоказателя); 
	
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "ПособиеНаВичИнфицРебенка";
	ОписаниеПоказателя.Наименование = НСтр("ru = 'Размер пособия на детей в возрасте до 18 лет, инфицированных вирусом иммунодефицита человека (ежемесячное)'");
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru = 'Пособие до трех лет на ребенка инф. ВИЧ'");
	ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
	ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "ПособиеНаРебенкаДо18ЛетНаРебенкаИнвалида";
	ОписаниеПоказателя.Наименование = НСтр("ru = 'Размер пособия по уходу за ребенком-инвалидом в возрасте до 18 лет (ежемесячное)'");
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru = 'Пособие по уходу за реб. - инв. до 18 лет'");
	ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
	ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "ПособиеНаРебенкаСтарше3ЛетКромеРебенкаИнвалида";
	ОписаниеПоказателя.Наименование = НСтр("ru = 'Размер пособия на детей старше 3 лет из отдельных категорий семей: на каждого ребенка, кроме ребенка-инвалида'");
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru = 'Пособие по уходу детьми страше 3 лет , кроме реб. - инв.'");
	ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
	ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
	ЗаписатьПоказатель(ОписаниеПоказателя);
	
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "ПособиеНаРебенкаСтарше3ЛетНаРебенкаИнвалида";
	ОписаниеПоказателя.Наименование = НСтр("ru = 'Размер пособия на детей старше 3 лет из отдельных категорий семей: на ребенка-инвалида'");
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru = 'Пособие по уходу детьми страше 3 лет , на реб. - инв.'");
	ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
	ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
	ЗаписатьПоказатель(ОписаниеПоказателя);
		
	ОписаниеПоказателя = ОписаниеПоказателя();
	ОписаниеПоказателя.Идентификатор = "ПособиеНаРебенкаСтарше3Лет";
	ОписаниеПоказателя.Наименование = НСтр("ru = 'Размер пособия на детей в возрасте от 3  до 18 лет в период воспитания ребенка в возрасте до 3 лет (ежемесячное)'");
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru = 'Пособие на детей от 3 до 18 лет в период восп.-ия реб.-ка до 3 лет'");
	ОписаниеПоказателя.ТипПоказателя = Перечисления.ТипыПоказателейРасчетаЗарплаты.Денежный;
	ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
	ЗаписатьПоказатель(ОписаниеПоказателя);	
	// }
	...
	// 4D:ERP для Беларуси, Яна, 31.05.2017 10:45:08 
	// Ошибка конфигурации при создании нового вида расчета Удержания, №15011 
	// {
	Если ПараметрыПланаВидовРасчета.ИспользоватьУдержаниеВСчетВозмещенияУщерба Тогда
		...
		ОписаниеПоказателя.Наименование = НСтр("ru = 'Размер возмещения ущерба'");
		ОписаниеПоказателя.КраткоеНаименование = НСтр("ru = 'сум. возм. ущерба'");
		ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Ложь;
		ОписаниеПоказателя.Точность = 2;
		ОписаниеПоказателя.Предопределенный = Ложь;
		ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;
		ЗаписатьПоказатель(ОписаниеПоказателя, СозданныеЭлементы);
	Иначе
		НачальнаяНастройкаОтключитьИспользованиеПоказателя(СозданныеЭлементы, "РазмерВозмещенияУщерба");
	КонецЕсли;
	// }
	// 4D
...
Функция СсылкиПоказателиРасчетаЗарплатыНачальнойНастройкиПрограммы() Экспорт 
	...
	// 4D:ERP для Беларуси, , 31.05.2017 10:46:17 
	// Ошибка конфигурации при создании нового вида расчета Удержания, №15011 
	// {
	СсылкиПоказателиРасчетаЗарплаты.Вставить("РазмерВозмещенияУщерба", Неопределено);
	// }
	// 4D
...
Функция ПоказателиНедоступныеДляУдержаний() Экспорт
	...
	// 4D:ERP для Беларуси, Яна, 14.06.2017 9:59:25 
	// Документ "Отпуск по уходу за ребенком", №14900 
	// {
	Показатели.Добавить(ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ПоказателиРасчетаЗарплаты.РазмерПособияПоУходуЗаРебенкомДоТрехЛетНаВторогоРебенка"));	
	Показатели.Добавить(ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ПоказателиРасчетаЗарплаты.РазмерПособияПоУходуЗаРебенкомДоТрехЛетНаРебенкаИнвалида"));	
	// }
	// 4D
...
// 4D:ERP для Беларуси, Яна, 14.06.2017 9:58:25 
// Документ "Отпуск по уходу за ребенком", №14900 
// {
Процедура СоздатьПоказателиДляПособийНаРебенка(НастройкиРасчетаЗарплаты = Неопределено, ПараметрыПланаВидовРасчета = Неопределено)  Экспорт
	...
	ОписаниеПоказателя.Идентификатор = "ПроцентПособияДоТрехЛетНаРебенкаИнвалида";
	ОписаниеПоказателя.Наименование = НСтр("ru = 'Процент пособия по уходу за ребенком до 3 лет на ребенка-инвалида'");
	ОписаниеПоказателя.КраткоеНаименование = НСтр("ru = 'Процент пособие до трех лет на ребенка-инвалида'");
	ОписаниеПоказателя.ЗначениеРассчитываетсяАвтоматически = Истина;
	ОписаниеПоказателя.Точность = 2;
	ОписаниеПоказателя.СпособПримененияЗначений = Перечисления.СпособыПримененияЗначенийПоказателейРасчетаЗарплаты.Постоянное;	
	ЗаписатьПоказатель(ОписаниеПоказателя);
