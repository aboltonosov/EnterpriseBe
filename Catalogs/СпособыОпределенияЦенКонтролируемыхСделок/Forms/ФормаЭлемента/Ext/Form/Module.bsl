...
// - заполнение списка выбора кодов определения цены сделки (на основании макета, где хранятся коды и их расщифровка);
// - заполнение списка выбора кодов метода ценообразования (на основании макета, где хранятся коды и их расщифровка).
//
&НаСервере
