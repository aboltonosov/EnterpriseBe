...
Процедура ЗаполнитьНомерДатаСумма(ДанныеСтроки, Объект)
	Если Не ДанныеСтроки = Неопределено Тогда
		Если ДанныеСтроки.ВидДокумента = ПредопределенноеЗначение("Справочник.ВидыПодтверждающихДокументов.КредитныйДоговор") 
			И Объект.ХарактерДоговора = ПредопределенноеЗначение("Перечисление.ХарактерДоговораКредитовИДепозитов.КредитИлиЗайм") 
			Или ДанныеСтроки.ВидДокумента = ПредопределенноеЗначение("Справочник.ВидыПодтверждающихДокументов.ДепозитныйДоговор")
			И Объект.ХарактерДоговора = ПредопределенноеЗначение("Перечисление.ХарактерДоговораКредитовИДепозитов.Депозит") Тогда
...
Процедура УстановитьВидимость()
	...
	//++ НЕ УТ
	Элементы.ПодтверждающиеДокументы.Видимость = ПлатежиПо275ФЗ;
	//-- НЕ УТ
