...
Функция ДоступныПлатежиПо275ФЗ() Экспорт
	...
	Возврат ОтдельныйСчетГОЗ
		И (ХарактерДоговора = Перечисления.ХарактерДоговораКредитовИДепозитов.Депозит
		Или ХарактерДоговора = Перечисления.ХарактерДоговораКредитовИДепозитов.КредитИлиЗайм
