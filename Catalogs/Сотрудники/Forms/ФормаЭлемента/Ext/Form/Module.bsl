...
&НаКлиенте
Процедура ЛицевыеСчета(Команда)
	ПараметрыФормы = Новый Структура("ОтборПоФизлицу", ЭтотОбъект.ФизическоеЛицо.Ссылка);
	ОткрытьФорму("Справочник.БанковскиеСчетаКонтрагентов.ФормаСписка",
	             ПараметрыФормы, ЭтотОбъект.ФизическоеЛицо.Ссылка);
КонецПроцедуры
