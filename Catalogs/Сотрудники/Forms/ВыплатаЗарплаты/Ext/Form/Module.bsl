...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбновитьСтраницуБухучетСтраницы(ЭтаФорма);
...
Процедура ОбновитьСтраницуБухучетСтраницы(Форма)
	...
	Если ЗначениеЗаполнено(Форма.БухучетЗарплатыСотрудников.ДействуетДо) Тогда
		Форма.Элементы.БухучетСтраницы.ТекущаяСтраница = Форма.Элементы.БухучетСтраницаДействуетПоОкончании;
		Форма.Элементы.РедактированиеБухучетаИнфоНадпись.Видимость = Истина;
	Иначе
		Форма.Элементы.БухучетСтраницы.ТекущаяСтраница = Форма.Элементы.БухучетСтраницаДействует;
		ТолькоПросмотр = ЗначениеЗаполнено(Форма.БухучетЗарплатыСотрудников.ДокументОснование);
		Форма.Элементы.СтатьяФинансирования.ТолькоПросмотр = ТолькоПросмотр;
		Форма.Элементы.СпособОтраженияЗарплатыВБухучете.ТолькоПросмотр = ТолькоПросмотр;
		Форма.Элементы.ОтношениеКЕНВД.ТолькоПросмотр = ТолькоПросмотр;
		Форма.Элементы.БухучетЗарплатыСотрудниковПериод.ТолькоПросмотр = ТолькоПросмотр;
		Форма.Элементы.РедактированиеБухучетаИнфоНадпись.Видимость = ТолькоПросмотр;
	КонецЕсли;
