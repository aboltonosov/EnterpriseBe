...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СоответствиеПараметров.Вставить(НСтр("ru = 'Цвет фона'"), 				Новый Структура("Имя, ПоУмолчанию, Тип, Порядок", "ЦветФона", ЦветаСтиля.ЦветФонаПоля, "Цвет", 1));
	СоответствиеПараметров.Вставить(НСтр("ru = 'Цвет текста'"),				Новый Структура("Имя, ПоУмолчанию, Тип, Порядок", "ЦветТекста", ЦветаСтиля.ЦветТекстаПоля, "Цвет", 2));
	СоответствиеПараметров.Вставить(НСтр("ru = 'Цвет границы'"), 			Новый Структура("Имя, ПоУмолчанию, Тип, Порядок", "ЦветГраницы", ЦветаСтиля.ЦветЛинииОтчета, "Цвет", 3));
	СоответствиеПараметров.Вставить(НСтр("ru = 'Шрифт'"), 					Новый Структура("Имя, ПоУмолчанию, Тип, Порядок", "Шрифт", ШрифтыСтиля.ШрифтТекста, "Шрифт", 4));
	СоответствиеПараметров.Вставить(НСтр("ru = 'Горизонтальное положение'"), Новый Структура("Имя, ПоУмолчанию, Тип, Порядок", "ГоризонтальноеПоложение", ГоризонтальноеПоложение.Авто, "ГоризонтальноеПоложение", 5));
	СоответствиеПараметров.Вставить(НСтр("ru = 'Вертикальное положение'"), 	Новый Структура("Имя, ПоУмолчанию, Тип, Порядок", "ВертикальноеПоложение", ВертикальноеПоложение.Центр, "ВертикальноеПоложение", 6));
	СоответствиеПараметров.Вставить(НСтр("ru = 'Ориентация текста'"), 		Новый Структура("Имя, ПоУмолчанию, Тип, Порядок", "ОриентацияТекста", 0, "ОриентацияТекста", 7));
	СоответствиеПараметров.Вставить(НСтр("ru = 'Формат'"), 					Новый Структура("Имя, ПоУмолчанию, Тип, Порядок", "Формат", "", "Формат", 8));
