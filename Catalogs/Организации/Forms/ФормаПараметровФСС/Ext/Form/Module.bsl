...
// 4D:ERP для Беларуси, Петр, 18.01.2018 13:05:21 
// Редактирование закладок "Регистрационные данные" и "Зарплата и кадры" спр. Организации, № 16293
// {
&НаКлиенте
Процедура ПриОкончанииВВодаФСЗН(ТекстРедактирования, ИмяПоля)
	...
	Если НЕ ПустаяСтрока(ТекстРедактирования) 
		И НЕ РегламентированныеДанныеКлиентСервер.ФСЗНСоответствуетТребованиям(ТекстРедактирования, 
...
&НаКлиенте
Процедура РегистрационныйНомерФССОкончаниеВводаТекста(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, СтандартнаяОбработка)
	
	ПриОкончанииВВодаФСЗН(Текст, Элемент.Имя)
	
КонецПроцедуры

&НаКлиенте
Процедура ИПКодПодчиненностиФССОкончаниеВводаТекста(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, СтандартнаяОбработка)
