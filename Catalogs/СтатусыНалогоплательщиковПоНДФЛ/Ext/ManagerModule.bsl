...
Процедура НачальноеЗаполнение() Экспорт
	...
	ОписатьСтатусыНерезидентов2015();
	ПроставитьКоды_2015();
...
Процедура ОписатьСтатусыНерезидентов2015() Экспорт
	
	Если Не ЗначениеЗаполнено(ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Справочники.СтатусыНалогоплательщиковПоНДФЛ.ГражданинСтраныЕАЭС, "КодФНС")) Тогда
	...
	Если Не ЗначениеЗаполнено(ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Справочники.СтатусыНалогоплательщиковПоНДФЛ.НерезидентРаботающийНаОснованииПатента, "КодФНС")) Тогда
...
Процедура ПроставитьКоды_2015() Экспорт
