...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Ключ.Пустая() Тогда
		...
		ДоступенПросмотрБухучетЗарплатыТерриторийВыполненияРабот = Пользователи.РолиДоступны("ЧтениеБухгалтерскогоУчетаЗарплаты,ДобавлениеИзменениеБухгалтерскогоУчетаЗарплаты");
	...
	Если ДоступенПросмотрБухучетЗарплатыТерриторийВыполненияРабот Тогда
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			...
			"ТолькоПросмотр",
			Не Пользователи.РолиДоступны("ДобавлениеИзменениеБухгалтерскогоУчетаЗарплаты"));
