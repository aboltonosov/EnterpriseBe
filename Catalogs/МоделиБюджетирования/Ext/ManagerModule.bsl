...
Функция МодельБюджетированияПоУмолчанию() Экспорт
	...
	Если ЗначениеЗаполнено(ЗаполняемыеРеквизиты.МодельБюджетирования) 
		И ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ЗаполняемыеРеквизиты.МодельБюджетирования, "Статус") = СтатусДействует Тогда
...
Функция ПолучитьТаблицуЗадачБюджетирования(МодельБюджетирования, ДатаНачала, ДатаОкончания, ДополнятьФактом, ПроверятьЗадачиДругихПериодов)
	...
	Если ДополнятьФактом Тогда
		Для Каждого ОставшасяСтрокаЗадач из ПараметрыТаблицыЗадач.ТаблицаФакт Цикл
			...
			НоваяСтрока.ЭтапПодготовкиБюджетов 	= ОставшасяСтрокаЗадач.ЭтапПодготовкиБюджетов;
			НоваяСтрока.ЭтапПодготовкиБюджетовОснование = ОставшасяСтрокаЗадач.ЭтапПодготовкиБюджетовОснование; 
