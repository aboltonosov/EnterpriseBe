...
Функция ПолучитьТаблицуФорм() Экспорт 
	...
	Стр.ОписаниеФормы = "Заявление о государственной регистрации физического лица в качестве индивидуального предпринимателя (Р21001)/приказ ФНС России от 25.01.2012 № ММВ-7-6/25@";
...
Функция СформироватьМакет_Форма2014_1(Объект)
	...
	Для Каждого Стр Из СтруктураПараметров.ДеревоСтраниц.Строки Цикл
		НомСтр = НомСтр + 1;
		МакетПФ = Отчеты.РегламентированноеУведомлениеФормаР21001.ПолучитьМакет("ПФ_" + Стр.ИмяМакета);
