...
Функция ТекстЗапросаСебестоимостьТоваров()
	...
	|	(ВЫБОР
	|		КОГДА Себестоимость.ВидДвижения = ЗНАЧЕНИЕ(ВидДвиженияНакопления.Приход)
	|			ТОГДА Себестоимость.Стоимость + Себестоимость.СтоимостьЗабалансовая + Себестоимость.СуммаДопРасходов
	...
	|		КОГДА Себестоимость.ВидДвижения = ЗНАЧЕНИЕ(ВидДвиженияНакопления.Приход)
	|			ТОГДА -(Себестоимость.Стоимость + Себестоимость.СтоимостьЗабалансовая + Себестоимость.СуммаДопРасходов)
	|			ИНАЧЕ Себестоимость.Стоимость + Себестоимость.СтоимостьЗабалансовая + Себестоимость.СуммаДопРасходов КОНЕЦ)
	|	 															КАК СтоимостьКонечныйОстаток,
	|	(ВЫБОР
	|		КОГДА Себестоимость.ВидДвижения = ЗНАЧЕНИЕ(ВидДвиженияНакопления.Приход)
	|			ТОГДА -(Себестоимость.СтоимостьБезНДС + Себестоимость.СуммаДопРасходовБезНДС)
	|			ИНАЧЕ Себестоимость.СтоимостьБезНДС + Себестоимость.СуммаДопРасходовБезНДС КОНЕЦ)
