...
Функция ПолучитьДанныеДляПечатнойФормыМХ2(Отчет, СписокДокументов)
	...
	|			И ТоварыОрганизаций.Регистратор.Организация = РасчетСебестоимостиТоваровОрганизации.Организация
	...
	|		+ СтоимостьТоваров.ПостатейныеРегл) КАК Стоимость
	...
	|		+ СебестоимостьТоваров.ПостатейныеРегл) КАК Стоимость
