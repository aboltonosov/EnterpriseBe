...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ИначеЕсли КлючВарианта = "ЧисленностьРаботающихИЗабронированныхГражданЗапаса2015" Тогда
		...
		// Параметры документа
		ДокументРезультат.ТолькоПросмотр = Истина;
		ДокументРезультат.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_ЧисленностьРаботающихИЗабронированныхГражданЗапаса2015";
		ДокументРезультат.ОриентацияСтраницы = ОриентацияСтраницы.Портрет;
	...
	ИначеЕсли КлючВарианта = "СведенияОбОбеспеченностиТрудовымиРесурсами" Тогда
		...
		// Параметры документа
		ДокументРезультат.ТолькоПросмотр = Истина;
		ДокументРезультат.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_СведенияОбОбеспеченностиТрудовымиРесурсами";
		ДокументРезультат.ОриентацияСтраницы = ОриентацияСтраницы.Портрет;
...
Функция СформироватьТаблицуСтрокиОтчета()
	...
	// 4D:ERP для Беларуси, Петр, 10.11.2017 16:43:36 
	// Редактировать значения перечислений КатегорииДолжностейДляВоинскогоУчета, №16589
	// {
	...
	ОписаниеСтрокиДанных(ТДанных, "14", НСтр("ru='3 - 4-го разряда'"),												КатегорииУчетаЗабронированных.РабочиеТретьегоЧетвертогоРазрядов);
