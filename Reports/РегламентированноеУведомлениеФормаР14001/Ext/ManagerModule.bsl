...
Функция ПолучитьТаблицуФорм() Экспорт 
	...
	Стр.ОписаниеФормы = "Заявление о внесении изменений в данные ЕГРЮЛ (Р14001)/приказ ФНС России от 25.01.2012 № ММВ-7-6/25@";
...
Функция СформироватьСписокЛистовФорма2014_1(Объект) Экспорт
	...
	Для Каждого Стр Из СтруктураПараметров.ДеревоСтраниц.Строки Цикл
		...
		Если Стр.ИДНаименования = "ЛистН1" Или Стр.ИДНаименования = "ЛистН2" Тогда 
			...
			ПечатнаяФорма = Отчеты.РегламентированноеУведомлениеФормаР14001.ПолучитьМакет("ПФ_" + Стр.ИмяМакета);
			НомСтр = НомСтр + 1;
...
Функция СформироватьДеревоСтраниц_Форма2014_1()
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаВ2;ПФ_Форма2014_1_СтраницаВ3;ПФ_Форма2014_1_СтраницаВ4";
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаГ1;ПФ_Форма2014_1_СтраницаГ2";
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаГ3;ПФ_Форма2014_1_СтраницаГ4;ПФ_Форма2014_1_СтраницаГ5";
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаД1;ПФ_Форма2014_1_СтраницаД2;ПФ_Форма2014_1_СтраницаД6;ПФ_Форма2014_1_СтраницаД7;ПФ_Форма2014_1_СтраницаД8;ПФ_Форма2014_1_СтраницаД9";
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаД3;ПФ_Форма2014_1_СтраницаД4;ПФ_Форма2014_1_СтраницаД5";
	...
	Стр002.МакетыПФ = "ПФ_Форма2014_1_СтраницаЕ3;ПФ_Форма2014_1_СтраницаЕ4";
	...
	Стр002.МакетыПФ = "ПФ_Форма2014_1_СтраницаЕ5;ПФ_Форма2014_1_СтраницаЕ6;ПФ_Форма2014_1_СтраницаЕ7";
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаЖ1;ПФ_Форма2014_1_СтраницаЖ2";
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаЖ3;ПФ_Форма2014_1_СтраницаЖ4;ПФ_Форма2014_1_СтраницаЖ5";
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаК1;ПФ_Форма2014_1_СтраницаК2";
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаЛ1;ПФ_Форма2014_1_СтраницаЛ2;ПФ_Форма2014_1_СтраницаЛ3";
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаМ1;ПФ_Форма2014_1_СтраницаМ2";
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаО1;ПФ_Форма2014_1_СтраницаО2";
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаР1;ПФ_Форма2014_1_СтраницаР2;ПФ_Форма2014_1_СтраницаР3;ПФ_Форма2014_1_СтраницаР4";
...
Процедура СформироватьДеревоСтраницПоДанным(ДеревоСтраниц, ДанныеМногостраничныхРазделов) Экспорт 
	...
	Для Каждого Стр Из ДанныеМногостраничныхРазделов["ЛистВ1"] Цикл 
		...
		Для Каждого СтрПодч Из ДанныеМногостраничныхРазделов["ЛистВ2_4"] Цикл 
			...
			Стр002Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаВ2;ПФ_Форма2014_1_СтраницаВ3;ПФ_Форма2014_1_СтраницаВ4";
		КонецЦикла;
	КонецЦикла;
	...
	Для Каждого Стр Из ДанныеМногостраничныхРазделов["ЛистГ1_2"] Цикл 
		...
		Стр001Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаГ1;ПФ_Форма2014_1_СтраницаГ2";
		...
		Для Каждого СтрПодч Из ДанныеМногостраничныхРазделов["ЛистГ3_5"] Цикл 
			...
			Стр002Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаГ3;ПФ_Форма2014_1_СтраницаГ4;ПФ_Форма2014_1_СтраницаГ5";
		КонецЦикла;
	КонецЦикла;
	...
	Для Каждого Стр Из ДанныеМногостраничныхРазделов["ЛистД"] Цикл 
		...
		Стр001Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаД1;ПФ_Форма2014_1_СтраницаД2;ПФ_Форма2014_1_СтраницаД6;ПФ_Форма2014_1_СтраницаД7;ПФ_Форма2014_1_СтраницаД8;ПФ_Форма2014_1_СтраницаД9";
		...
		Для Каждого СтрПодч Из ДанныеМногостраничныхРазделов["ЛистД3_5"] Цикл 
			...
			Стр002Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаД3;ПФ_Форма2014_1_СтраницаД4;ПФ_Форма2014_1_СтраницаД5";
		КонецЦикла;
	КонецЦикла;
	...
	Для Каждого Стр Из ДанныеМногостраничныхРазделов["ЛистЕ1"] Цикл 
		...
		Для Каждого СтрПодч Из ДанныеМногостраничныхРазделов["ЛистЕ3_4"] Цикл 
			...
			Стр002Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаЕ3;ПФ_Форма2014_1_СтраницаЕ4";
		КонецЦикла;
		...
		Для Каждого СтрПодч Из ДанныеМногостраничныхРазделов["ЛистЕ5_7"] Цикл 
			...
			Стр002Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаЕ5;ПФ_Форма2014_1_СтраницаЕ6;ПФ_Форма2014_1_СтраницаЕ7";
		КонецЦикла;
	КонецЦикла;
	...
	Для Каждого Стр Из ДанныеМногостраничныхРазделов["ЛистЖ1_2"] Цикл 
		...
		Стр001Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаЖ1;ПФ_Форма2014_1_СтраницаЖ2";
		...
		Для Каждого СтрПодч Из ДанныеМногостраничныхРазделов["ЛистЖ3_5"] Цикл 
			...
			Стр002Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаЖ3;ПФ_Форма2014_1_СтраницаЖ4;ПФ_Форма2014_1_СтраницаЖ5";
		КонецЦикла;
	КонецЦикла;
	...
	Для Каждого Стр Из ДанныеМногостраничныхРазделов["ЛистК"] Цикл 
		...
		Стр001Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаК1;ПФ_Форма2014_1_СтраницаК2";
	КонецЦикла;
	...
	Для Каждого Стр Из ДанныеМногостраничныхРазделов["ЛистЛ"] Цикл 
		...
		Стр001Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаЛ1;ПФ_Форма2014_1_СтраницаЛ2;ПФ_Форма2014_1_СтраницаЛ3";
	КонецЦикла;
	...
	Для Каждого Стр Из ДанныеМногостраничныхРазделов["ЛистМ"] Цикл 
		...
		Стр001Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаМ1;ПФ_Форма2014_1_СтраницаМ2";
	КонецЦикла;
	...
	Для Каждого Стр Из ДанныеМногостраничныхРазделов["ЛистО"] Цикл 
		...
		Стр001Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаО1;ПФ_Форма2014_1_СтраницаО2";
	КонецЦикла;
	...
	Для Каждого Стр Из ДанныеМногостраничныхРазделов["ЛистР"] Цикл 
		...
		Стр001Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаР1;ПФ_Форма2014_1_СтраницаР2;ПФ_Форма2014_1_СтраницаР3;ПФ_Форма2014_1_СтраницаР4";
	КонецЦикла;
КонецПроцедуры
