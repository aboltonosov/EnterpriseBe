...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мСоответствиеИдГруппыРегистр.Вставить(СтруктураРеквизитовФормы.мИдГруппы12, "СведенияРеглОтчетАлкоПрил14Декларация");	
		
	СтруктураРеквизитовФормы.мСоответствиеРегистрИдГруппы = Новый Соответствие;
	СтруктураРеквизитовФормы.мСоответствиеРегистрИдГруппы.Вставить("СведенияРеглОтчетАлкоПрил14Декларация", СтруктураРеквизитовФормы.мИдГруппы12);	
