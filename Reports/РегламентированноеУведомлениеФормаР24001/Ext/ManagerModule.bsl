...
Функция ПолучитьТаблицуФорм() Экспорт 
	...
	Стр.ОписаниеФормы = "Заявление о внесении изменений в регистрационные данные индивидуального предпринимателя (Р24001)/приказ ФНС России от 25.01.2012 № ММВ-7-6/25@";
...
Функция СформироватьСписокЛистовФорма2014_1(Объект) Экспорт
	...
	Для Каждого Стр Из СтруктураПараметров.ДеревоСтраниц.Строки Цикл
		МакетПФ = Отчеты.РегламентированноеУведомлениеФормаР24001.ПолучитьМакет("ПФ_" + Стр.ИмяМакета);
