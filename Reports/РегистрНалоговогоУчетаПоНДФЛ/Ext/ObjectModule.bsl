...
Процедура ПолучитьДанныеДляПостроенияОтчета(СписокФизЛицОрганизация)
	...
	|	СвойстваКодаДохода.СоответствуетОплатеТруда КАК СоответствуетОплатеТруда,
	...
	|	НДФЛСведенияОДоходах.ИсточникДоходаЗаПределамиРФ
	...
	|	НДФЛРасчетыСБюджетом.СуммаВыплаченногоДохода
