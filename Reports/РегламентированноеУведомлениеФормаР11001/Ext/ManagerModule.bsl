...
Функция ПолучитьТаблицуФорм() Экспорт 
	...
	Стр.ОписаниеФормы = "Заявление о государственной регистрации юридического лица (Р11001)/приказ ФНС России от 25.01.2012 № ММВ-7-6/25@";
...
Функция СформироватьСписокЛистовФорма2014_1(Объект) Экспорт
	...
	Для Каждого Стр Из СтруктураПараметров.ДеревоСтраниц.Строки Цикл
		...
		Если Стр.ИДНаименования = "ЛистИ" Тогда 
			...
			ПечатнаяФорма = Отчеты.РегламентированноеУведомлениеФормаР11001.ПолучитьМакет("ПФ_" + Стр.ИмяМакета);
			НомСтр = НомСтр + 1;
...
#Область ЛистыАБВ
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаВ1;ПФ_Форма2014_1_СтраницаВ2";
#КонецОбласти
...
#Область ЛистыГ
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаГ1";
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаГ2;ПФ_Форма2014_1_СтраницаГ3";
#КонецОбласти
...
#Область ЛистыДЕЖЗИ
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаЖ1;ПФ_Форма2014_1_СтраницаЖ2;ПФ_Форма2014_1_СтраницаЖ3";
...
#Область ЛистыКЛМН
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаН1;ПФ_Форма2014_1_СтраницаН2;ПФ_Форма2014_1_СтраницаН3";
#КонецОбласти
