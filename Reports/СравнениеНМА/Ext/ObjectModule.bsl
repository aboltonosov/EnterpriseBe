...
Функция РеквизитыСравнения()
	...
	ОписаниеРаздела.Реквизиты.Добавить(ОписаниеРеквизита("ПервоначальнаяСтоимость", НСтр("ru='Первоначальная стоимость'"),, "ЧЦ=15; ЧДЦ=2"));
	ОписаниеРаздела.Реквизиты.Добавить(ОписаниеРеквизита("СправедливаяСтоимость", НСтр("ru='Справедливая стоимость'"), Ложь, "ЧЦ=15; ЧДЦ=2"));
	ОписаниеРаздела.Реквизиты.Добавить(ОписаниеРеквизита("ЛиквидационнаяСтоимость", НСтр("ru='Ликвидационная стоимость'"), Ложь, "ЧЦ=15; ЧДЦ=2"));
	...
	ОписаниеРаздела.Реквизиты.Добавить(ОписаниеРеквизита("ОбъемНаработки", НСтр("ru='Предполагаемый объем наработки'"),, "ЧЦ=15; ЧДЦ=2"));
	ОписанияРазделов.Добавить(ОписаниеРаздела);
