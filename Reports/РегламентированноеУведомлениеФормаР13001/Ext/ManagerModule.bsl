...
Функция ПолучитьТаблицуФорм() Экспорт 
	...
	Стр.ОписаниеФормы = "Заявление о внесении изменений в регистрационные документы юридического лица (Р13001)/приказ ФНС России от 25.01.2012 № ММВ-7-6/25@";
...
Функция СформироватьСписокЛистовФорма2014_1(Объект) Экспорт
	...
	Для Каждого Стр Из СтруктураПараметров.ДеревоСтраниц.Строки Цикл
		...
		Если Стр.ИДНаименования = "ЛистЛ1" Или Стр.ИДНаименования = "ЛистЛ2" Тогда 
			...
			ПечатнаяФорма = Отчеты.РегламентированноеУведомлениеФормаР13001.ПолучитьМакет("ПФ_" + Стр.ИмяМакета);
			НомСтр = НомСтр + 1;
...
Функция СформироватьДеревоСтраниц_Форма2014_1()
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаД1;ПФ_Форма2014_1_СтраницаД2";
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаЕ1;ПФ_Форма2014_1_СтраницаЕ2";
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаЖ1";
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаЖ2;ПФ_Форма2014_1_СтраницаЖ3;ПФ_Форма2014_1_СтраницаЖ4";
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаЗ1;ПФ_Форма2014_1_СтраницаЗ2";
	...
	Стр001.МакетыПФ = "ПФ_Форма2014_1_СтраницаМ1;ПФ_Форма2014_1_СтраницаМ2;ПФ_Форма2014_1_СтраницаМ3";
...
Процедура СформироватьДеревоСтраницПоДанным(ДеревоСтраниц, ДанныеМногостраничныхРазделов) Экспорт 
	...
	Для Каждого Стр Из ДанныеМногостраничныхРазделов["ЛистД"] Цикл 
		...
		Стр001Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаД1;ПФ_Форма2014_1_СтраницаД2";
	КонецЦикла;
	...
	Для Каждого Стр Из ДанныеМногостраничныхРазделов["ЛистЖ1"] Цикл 
		...
		Стр001Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаЖ1";
		...
		Для Каждого СтрПодч Из ДанныеМногостраничныхРазделов["ЛистЖ2_4"] Цикл 
			...
			Стр002Нов.МакетыПФ = "ПФ_Форма2014_1_СтраницаЖ2;ПФ_Форма2014_1_СтраницаЖ3;ПФ_Форма2014_1_СтраницаЖ4";
		КонецЦикла;
	КонецЦикла;
