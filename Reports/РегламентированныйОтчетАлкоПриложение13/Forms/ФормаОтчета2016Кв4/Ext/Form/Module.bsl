...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мСоответствиеИдГруппыРегистр.Вставить(СтруктураРеквизитовФормы.мИдГруппы12, "СведенияРеглОтчетАлкоПрил13Декларация");	
		
	СтруктураРеквизитовФормы.мСоответствиеРегистрИдГруппы = Новый Соответствие;
	СтруктураРеквизитовФормы.мСоответствиеРегистрИдГруппы.Вставить("СведенияРеглОтчетАлкоПрил13Декларация", СтруктураРеквизитовФормы.мИдГруппы12);	
