...
Функция ПолучитьПараметрыИсполненияОтчета() Экспорт
	...
	СтруктураВозврата.Вставить("ИспользоватьПослеКомпоновкиМакета", Ложь);
	СтруктураВозврата.Вставить("ИспользоватьПослеВыводаРезультата", Истина);
	СтруктураВозврата.Вставить("ИспользоватьДанныеРасшифровки", Ложь);
	СтруктураВозврата.Вставить("ИспользоватьПриВыводеЗаголовка", Истина);
