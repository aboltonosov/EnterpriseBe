...
Процедура ПодготовитьДанныеПоРазделуУправлениеПерсоналом(ТаблицаПоказателей)
	...
	Если ПолучитьФункциональнуюОпцию("РаботаВХозрасчетнойОрганизации") Тогда 
		...
		ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиКлючевыхПоказателейЭффективности", "ИспользоватьКлючевыеПоказателиЭффективности", 
			"Используется оценка эффективности по ключевым показателям", "Управление персоналом", "Ключевые показатели эффективности", "Ложь", 5, 4, 1);
		ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиКлючевыхПоказателейЭффективности", "ИспользоватьРасчетПоказателейЭффективностиПоШкале", 
			"Для оценки эффективности", "Управление персоналом", "Ключевые показатели эффективности", "Ложь", 5, 4, 2);

		// Льготы
		ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиЛьготСотрудников", "ИспользоватьЛьготыСотрудников", 
			"Предоставляются льготы сотрудникам", "Управление персоналом", "Льготы", "Ложь", 5, 5, 1);
		ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиЛьготСотрудников", "ИспользоватьИндивидуальныеЛьготыСотрудников", 
			"Предоставляются индивидуальные льготы сотрудникам", "Управление персоналом", "Льготы", "Ложь", 5, 5, 2);
	...
	ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиОбученияРазвития", "ИспользоватьОбучениеРазвитиеСотрудников", 
		"Используются программы обучения и развития сотрудников", "Управление персоналом", "Обучение и развитие", "Ложь", 5, 6, 1);
	ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиОбученияРазвития", "ИспользоватьУченическиеДоговоры", 
		"Оформляются ученические договоры", "Управление персоналом", "Обучение и развитие", "Ложь", 5, 6, 2);

	// Кадровый резерв
	ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиКадровогоРезерва", "ИспользоватьКадровыйРезерв", 
		"Ведется кадровый резерв", "Управление персоналом", "Кадровый резерв", "Ложь", 5, 7, 1);
	ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиКадровогоРезерва", "ИспользоватьЗаявкиНаВключениеВКадровыйРезерв", 
		"Включение в списки резерва осуществляется по заявке руководителя", "Управление персоналом", "Кадровый резерв", "Ложь", 5, 7, 2);
	ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиКадровогоРезерва", "ИспользоватьКадровыйРезервПоВидам", 
		"Кадровый резерв на одну позицию разделяется по видам", "Управление персоналом", "Кадровый резерв", "Ложь", 5, 7, 3);

	// Оценка персонала
	ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиОценкиПерсонала", "ИспользоватьОценкуПерсонала", 
		"Проводится оценка по методу 360°", "Управление персоналом", "Оценка персонала", "Ложь", 5, 8, 1);
	...
	ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиСамообслуживанияСотрудников", "ИспользоватьСамообслуживаниеСотрудников", 
		"Самообслуживание сотрудников", "Управление персоналом", "Самообслуживание сотрудников", "Ложь", 5, 9, 1);
	ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиСамообслуживанияСотрудников", "ИспользоватьЗаявкиНаКомандировку", 
		"Сотрудники самостоятельно оформляют заявки на командировку", "Управление персоналом", "Самообслуживание сотрудников", "Ложь", 5, 9, 2);
	ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиСамообслуживанияСотрудников", "ИспользоватьЗаявкиНаОтпуск", 
		"Сотрудники самостоятельно оформляют заявки на отпуск", "Управление персоналом", "Самообслуживание сотрудников", "Ложь", 5, 9, 3);
	ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиСамообслуживанияСотрудников", "ИспользоватьСообщенияОбОтсутствии", 
		"Сотрудники самостоятельно оформляют сообщения о своем отсутствии", "Управление персоналом", "Самообслуживание сотрудников", "Ложь", 5, 9, 4);
	ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиСамообслуживанияСотрудников", "ИспользоватьСозданиеПользователейРегламентнымЗаданием", 
		"Создавать учетные записи для вновь принятых сотрудников автоматически", "Управление персоналом", "Самообслуживание сотрудников", "Ложь", 5, 9, 5);
	ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиСамообслуживанияСотрудников", "ИспользоватьРегламентноеЗаданиеДляЗапретаВходаВПрограммуУволеннымСотрудникам", 
		"Запрещать доступ в программу уволенным сотрудникам автоматически", "Управление персоналом", "Самообслуживание сотрудников", "Ложь", 5, 9, 6);
	...
	ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиСпециальнойОценкиУсловийТруда", "ИспользоватьСпециальнуюОценкуУсловийТруда", 
		"Использовать специальную оценку условий труда", "Управление персоналом", "Охрана труда", "Ложь", 5, 10, 1);
	ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиНесчастныхСлучаевНаПроизводстве", "ИспользоватьНесчастныеСлучаиНаПроизводстве", 
		"Вести учет несчастных случаев на производстве", "Управление персоналом", "Охрана труда", "Ложь", 5, 10, 2);
