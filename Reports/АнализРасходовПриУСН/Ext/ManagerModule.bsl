...
// Функция на основании вида расходов возвращает соответсвующее имя варианта настроек для формирования отчета по данному виду расходов.
// Параметры:
...
Функция СоответствиеВидовРасходовВариантамОтчета(ВидРасходов) Экспорт
	...
	СоответствиеВариантов.Вставить(Перечисления.ВидыРасходовУСН.ДопРасходы, "ПрочиеРасходы");
