	...
	Если СписокСохранения.Свойство("ДанныеМногострочныхРазделов", ДанныеМногострочныхРазделов) Тогда
		...
		Если ДанныеМногострочныхРазделов.Свойство("П0000100010") Тогда
			...
			Для НомСтр1 = 1 По ТЗ_1.Количество() Цикл
				Если НовыеДанные1.Свойство("П000100000101_" + Формат(НомСтр1, "ЧГ=")) Тогда
					СтрокаТЗ_1 = ТЗ_1[НомСтр1 - 1];
					СтрокаТЗ_1["П000100000101"] = НовыеДанные1["П000100000101_" + Формат(НомСтр1, "ЧГ=")];
					СтрокаТЗ_1["П000100000102"] = НовыеДанные1["П000100000102_" + Формат(НомСтр1, "ЧГ=")];
					СтрокаТЗ_1["П000100000103"] = НовыеДанные1["П000100000103_" + Формат(НомСтр1, "ЧГ=")];
				КонецЕсли;
			КонецЦикла;
		...
		Если ДанныеМногострочныхРазделов.Свойство("П0000662100") Тогда
			...
			Для НомСтр6 = 1 По ТЗ_6.Количество() Цикл
				Если НовыеДанные6.Свойство("П000620000101_" + Формат(НомСтр6, "ЧГ=")) Тогда
					СтрокаТЗ_6 = ТЗ_6[НомСтр6 - 1];
					СтрокаТЗ_6["П000620000101"] = НовыеДанные6["П000620000101_" + Формат(НомСтр6, "ЧГ=")];
					СтрокаТЗ_6["П000620000102"] = НовыеДанные6["П000620000102_" + Формат(НомСтр6, "ЧГ=")];
					СтрокаТЗ_6["П000620000103"] = НовыеДанные6["П000620000103_" + Формат(НомСтр6, "ЧГ=")];
					СтрокаТЗ_6["П000620000104"] = НовыеДанные6["П000620000104_" + Формат(НомСтр6, "ЧГ=")];
				КонецЕсли;
			КонецЦикла;
					...
					Для каждого СтрокаТЗ_4 Из ТЗ_4 Цикл
						...
						Если СтрокаТЗ_4.ДополнительныеДанные <> Неопределено
							...
							Для каждого СтрокаТЗ_40 Из ТЗ_40 Цикл
								НомСтр40 = НомСтр40 + 1;
								НовыеДанные.Вставить("П000400000101_" + Формат(НомСтр40, "ЧГ="), СтрокаТЗ_40["КодОснования"]);
								НовыеДанные.Вставить("П000400000102_" + Формат(НомСтр40, "ЧГ="), СтрокаТЗ_40["Количество"]);
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Пока Раздел1.Свойство("П000100000101_" + Формат(НомерСтроки, "ЧГ=")) Цикл
		ИмяЯчейкиКБКРаздел1 = "П000100000101_" + Формат(НомерСтроки, "ЧГ=");
		ИмяЯчейкиОКТМОРаздел1 = "П000100000102_" + Формат(НомерСтроки, "ЧГ=");
		ИмяЯчейкиСуммаРаздел1 = "П000100000103_" + Формат(НомерСтроки, "ЧГ=");
		...
		Если ДлинаКБКРаздел1 <> 20 Тогда
			СообщитьВТС("Раздел 1: в строке " + Формат(НомерСтроки, "ЧГ=") + " не"
		...
		Для каждого СтраницаРаздела2 Из ДанныеРаздела2.Строки Цикл
			...
			Для каждого СтраницаРаздела21 Из СтраницаРаздела2.Строки Цикл
				...
				Пока СтраницаРаздела21.Данные.Свойство("П000211000101_" + Формат(НомерСтроки211, "ЧГ=")) Цикл
					...
					КодОснНал = СокрЛП(СтраницаРаздела21.Данные["П000211000101_" + Формат(НомерСтроки211, "ЧГ=")]);
					КолНефти  = СтраницаРаздела21.Данные["П000211000102_" + Формат(НомерСтроки211, "ЧГ=")];
					...
					Если КодОснНалДлина <> 4 Тогда
						СообщитьВТС("Раздел 2 -> Уплата налога. Страница " + НомерСтраницы
						+ " -> Расчет налога. Страница " + НомерСтраницы21
						+ ": в строке " + Формат(НомерСтроки211, "ЧГ=") + " не" + ?(КодОснНалДлина = 0, "", "верно")
						+ " задан код основания налогообложения.",
						"Раздел21", "П000211000101_" + Формат(НомерСтроки211, "ЧГ="), КоординатыСтраницы21);
						СтатусПроверки = Ложь;
					КонецЕсли;
				...
				Если ПроверятьРаздел212 Тогда
					...
					Для каждого СтраницаРаздела212 Из СтраницаРаздела21.Строки Цикл
						...
						Пока СтраницаРаздела212.Данные.Свойство("П000212000101_" + Формат(НомерСтроки212, "ЧГ=")) Цикл
							...
							КодОснНал212 = СокрЛП(СтраницаРаздела212.Данные["П000212000101_" + Формат(НомерСтроки212, "ЧГ=")]);
							КолНефти212  = СтраницаРаздела212.Данные["П000212000102_" + Формат(НомерСтроки212, "ЧГ=")];
							...
							Если КодОснНал212Длина <> 4 Тогда
								...
								+ " -> Расчет налога. Страница " + НомерСтраницы21
								+ " -> Нефть, добытая из залежи. Страница " + НомерСтраницы212
								+ ": в строке " + Формат(НомерСтроки212, "ЧГ=") + " не" + ?(КодОснНал212Длина = 0, "", "верно")
								+ " задан код основания налогообложения.", "Раздел212",
								"П000212000101_" + Формат(НомерСтроки212, "ЧГ="), КоординатыСтраницы212);
								СтатусПроверки = Ложь;
							КонецЕсли;
			...
			Для каждого СтраницаРаздела31 Из СтраницаРаздела3.Строки Цикл
				...
				Для каждого СтраницаРаздела311 Из СтраницаРаздела31.Строки Цикл
					...
					Пока СтраницаРаздела311.Данные.Свойство("П000311000101_" + Формат(НомерСтроки311, "ЧГ=")) Цикл
						...
						КодОснНал311 = СокрЛП(СтраницаРаздела311.Данные["П000311000101_" + Формат(НомерСтроки311, "ЧГ=")]);
						КолНефти311  = СтраницаРаздела311.Данные["П000311000102_" + Формат(НомерСтроки311, "ЧГ=")];
						...
						Если КодОснНал311Длина <> 4 Тогда
							...
							+ ": в строке " + Формат(НомерСтроки311, "ЧГ=") + " не" + ?(КодОснНал311Длина = 0, "", "верно")
							+ " задан код основания налогообложения.", "Раздел311",
							"П000311000101_" + Формат(НомерСтроки311, "ЧГ="), КоординатыСтраницы311);
							СтатусПроверки = Ложь;
						КонецЕсли;
	...
	Если ПроверятьРаздел4 Тогда
		...
		Для Каждого СтраницаРаздела4 Из Раздел4 Цикл
			...
			НомерСтроки4 = 1;
			Пока Данные4.Свойство("П000400000101_" + Формат(НомерСтроки4, "ЧГ=")) Цикл
				
				КодОснНал4 = СокрЛП(Данные4["П000400000101_" + Формат(НомерСтроки4, "ЧГ=")]);
				КолНефти4  = Данные4["П000400000102_" + Формат(НомерСтроки4, "ЧГ=")];
				...
				Если КодОснНал4Длина <> 4 Тогда
					СообщитьВТС("Раздел 4 -> Страница " + НомерСтраницы4
					+ ": в строке " + Формат(НомерСтроки4, "ЧГ=") + " не" + ?(КодОснНал4Длина = 0, "", "верно")
					+ " задан код основания налогообложения.", "Раздел4",
					"П000400000101_" + Формат(НомерСтроки4, "ЧГ="), НомерСтраницы4);
					СтатусПроверки = Ложь;
				КонецЕсли;
		...
		Для каждого СтраницаРаздела5 Из ДанныеРаздела5.Строки Цикл
			...
			Для каждого СтраницаРаздела51 Из СтраницаРаздела5.Строки Цикл
				...
				Пока СтраницаРаздела51.Данные.Свойство("П000510000101_" + Формат(НомерСтроки51, "ЧГ=")) Цикл
					...
					КодОснНал51 = СокрЛП(СтраницаРаздела51.Данные["П000510000101_" + Формат(НомерСтроки51, "ЧГ=")]);
					КолНефти51  = СтраницаРаздела51.Данные["П000510000102_" + Формат(НомерСтроки51, "ЧГ=")];
					
					Если НЕ ЗначениеЗаполнено(КодОснНал51)
					   И НЕ ЗначениеЗаполнено(КолНефти51) Тогда
						НомерСтроки51 = НомерСтроки51 + 1;
						Продолжить;
					КонецЕсли;
					...
					Если КодОснНал51Длина <> 4 Тогда
						СообщитьВТС("Раздел 5 -> Уплата налога. Страница " + НомерСтраницы5
						+ " -> Раздел 5.1. Страница " + НомерСтраницы51
						+ ": в строке " + Формат(НомерСтроки51, "ЧГ=") + " не" + ?(КодОснНал51Длина = 0, "", "верно")
						+ " задан код основания налогообложения.", "Раздел51",
						"П000510000101_" + Формат(НомерСтроки51, "ЧГ="), КоординатыСтраницы51);
						СтатусПроверки = Ложь;
					КонецЕсли;
	...
	Если ПроверятьРаздел6 Тогда
		...
		Пока Раздел6.Свойство("П000620000101_" + Формат(НомерСтроки6, "ЧГ=")) Цикл
			
			КодДПИРаздел6   = СокрЛП(Раздел6["П000620000101_" + Формат(НомерСтроки6, "ЧГ=")]);
			КоличДПИРаздел6 = Раздел6["П000620000102_" + Формат(НомерСтроки6, "ЧГ=")];
			ДоляДПИРаздел6  = Раздел6["П000620000103_" + Формат(НомерСтроки6, "ЧГ=")];
			СумРасхРаздел6  = Раздел6["П000620000104_" + Формат(НомерСтроки6, "ЧГ=")];
			...
			Если КодДПИРаздел6Длина <> 5 Тогда
				СообщитьВТС("Раздел 6: в строке " + Формат(НомерСтроки6, "ЧГ=")
				+ " не" + ?(КодДПИРаздел6Длина = 0, "", "верно")
				+ " задан код добытого полезного ископаемого.", "Раздел6",
				"П000620000101_" + Формат(НомерСтроки6, "ЧГ="));
				СтатусПроверки = Ложь;
			КонецЕсли;
	...
	Если ПроверятьРаздел7 Тогда
		...
		Для Каждого СтраницаРаздела7 Из Раздел7 Цикл
			...
			Пока Данные7.Свойство("П000710000101_" + Формат(НомерСтроки71, "ЧГ=")) Цикл
				
				КодДПИРаздел71    = СокрЛП(Данные7["П000710000101_" + Формат(НомерСтроки71, "ЧГ=")]);
				КодОснНалРаздел71 = СокрЛП(Данные7["П000710000102_" + Формат(НомерСтроки71, "ЧГ=")]);
				КоличДПИРаздел71  = Данные7["П000710000103_" + Формат(НомерСтроки71, "ЧГ=")];
				...
				Если КодОснНалРаздел71Длина <> 4 Тогда
					...
					"П000710000102_" + Формат(НомерСтроки71, "ЧГ="), НомерСтраницы7);
					СтатусПроверки = Ложь;
				КонецЕсли;
			...
			Пока Данные7.Свойство("П000730000101_" + Формат(НомерСтроки73, "ЧГ=")) Цикл
				
				МесГодВознРаздел73 = Данные7["П000730000101_" + Формат(НомерСтроки73, "ЧГ=")];
				НалВычНачРаздел7   = Данные7["П000730000102_" + Формат(НомерСтроки73, "ЧГ=")];
				НалВычПредРаздел7  = Данные7["П000730000103_" + Формат(НомерСтроки73, "ЧГ=")];
				НалВычТекРаздел7   = Данные7["П000730000104_" + Формат(НомерСтроки73, "ЧГ=")];
				НалВычКонРаздел7   = Данные7["П000730000105_" + Формат(НомерСтроки73, "ЧГ=")];
				МесГодОконРаздел73 = Данные7["П000730000106_" + Формат(НомерСтроки73, "ЧГ=")];
				...
				Если НЕ ЗначениеЗаполнено(МесГодВознРаздел73) Тогда
					СообщитьВТС("Раздел 7 -> Страница " + НомерСтраницы7
					+ ": в строке " + Формат(НомерСтроки73, "ЧГ=")
					+ " подраздела 7.3 не заданы месяц и год возникновения права на налоговый вычет.",
					"Раздел7", "П000730000101_" + Формат(НомерСтроки73, "ЧГ="), НомерСтраницы7);
					СтатусПроверки = Ложь;
				КонецЕсли;
				...
				Если НЕ ЗначениеЗаполнено(МесГодОконРаздел73) Тогда
					...
					"Раздел7", "П000730000106_" + Формат(НомерСтроки73, "ЧГ="), НомерСтраницы7);
					СтатусПроверки = Ложь;
				КонецЕсли;
...
Процедура ОбновитьСтруктуруМногоуровневогоМногострочногоРаздела(Форма, ИмяГруппы, ДанныеРаздела)
	...
	Пока ДанныеРаздела.Свойство(ИмяПервойКолонки + "_" + Формат(НСтр, "ЧГ=")) Цикл
		...
		Для НомерГрафы = 1 По Форма.мСтруктураКолвоКолонокРазделов[ИмяГруппы] Цикл
			...
			Если ТекСтрокаТаблицы.Свойство(ИмяКолонки) Тогда
				...
				ИмяПоказателя = ИмяКолонки + "_" + Формат(НСтр, "ЧГ=");
	...
	ИначеЕсли ИмяРаздела = "Раздел6" Тогда
		...
		Если НЕ ЗначениеЗаполнено(ОбластьИмя) ИЛИ (ЗначениеЗаполнено(ОбластьИмя)
			...
			Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
				...
				НомДопСтроки = 1;
				Пока Форма.ТабличныйДокумент.Области.Найти("П000620000101_" + Формат(НомДопСтроки, "ЧГ=")) <> Неопределено Цикл
					ОбщаяСуммаПоГрафе2 = ОбщаяСуммаПоГрафе2
						+ Форма.ТабличныйДокумент.Области["П000620000102_" + Формат(НомДопСтроки, "ЧГ=")].Значение;
				...
				Пока Форма.ТабличныйДокумент.Области.Найти("П000620000101_" + Формат(НомДопСтроки, "ЧГ=")) <> Неопределено Цикл
					...
					Если НЕ ЭтоПоследняяСтрокаРаздела62 Тогда
						Форма.ТабличныйДокумент.Области["П000620000103_" + Формат(НомДопСтроки, "ЧГ=")].Значение
							= ?(ОбщаяСуммаПоГрафе2 <> 0,
							Форма.ТабличныйДокумент.Области["П000620000102_" + Формат(НомДопСтроки, "ЧГ=")].Значение
							/ ОбщаяСуммаПоГрафе2, 0);
					...
					КонецЕсли;
					Форма.ТабличныйДокумент.Области["П000620000104_" + Формат(НомДопСтроки, "ЧГ=")].Значение
						= Форма.ТабличныйДокумент.Области["П000620000103_" + Формат(НомДопСтроки, "ЧГ=")].Значение
						* Форма.ТабличныйДокумент.Области["П000600010003"].Значение;
					НомДопСтроки = НомДопСтроки + 1;
				КонецЦикла;
		...
		Если ИмяЛиста = "Раздел7" Тогда
			...
			Если Страница.АктивнаяСтраница И (Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяЛиста) Тогда
				Для НомДопСтроки = 1 По ДанныеДопСтрокПодразд73.Количество() Цикл
					...
					ДопСтрокаПодразд73.П000730000102 = Форма.ТабличныйДокумент.Области["П000730000102_" + Формат(НомДопСтроки, "ЧГ=")].Значение;
					ДопСтрокаПодразд73.П000730000103 = Форма.ТабличныйДокумент.Области["П000730000103_" + Формат(НомДопСтроки, "ЧГ=")].Значение;
					ДопСтрокаПодразд73.П000730000104 = Форма.ТабличныйДокумент.Области["П000730000104_" + Формат(НомДопСтроки, "ЧГ=")].Значение;
				КонецЦикла;
			КонецЕсли;
		...
		Для каждого ВеткаРаздел5 Из ДеревоДанныхРаздел5.Строки Цикл
			...
			Для каждого ВеткаРаздел51 Из ВеткаРаздел5.Строки Цикл
				...
				Если ВеткаРаздел51 = АктивнаяВетка51 Тогда
					НомСтр = 1;
					Пока ВеткаРаздел51.Данные.Свойство("П000510000101_" + Формат(НомСтр, "ЧГ=")) Цикл
						ВеткаРаздел51.Данные.Вставить("П000510000101_" + Формат(НомСтр, "ЧГ="),
							Форма.ТабличныйДокумент.Области["П000510000101_" + Формат(НомСтр, "ЧГ=")].Значение);
						ВеткаРаздел51.Данные.Вставить("П000510000102_" + Формат(НомСтр, "ЧГ="),
							Форма.ТабличныйДокумент.Области["П000510000102_" + Формат(НомСтр, "ЧГ=")].Значение);
						НомСтр = НомСтр + 1;
					КонецЦикла;
				КонецЕсли;
				...
				НомСтр = 1;
				Пока ВеткаРаздел51.Данные.Свойство("П000510000101_" + Формат(НомСтр, "ЧГ=")) Цикл
					ТекКодОсн = СокрЛП(ВеткаРаздел51.Данные["П000510000101_" + Формат(НомСтр, "ЧГ=")]);
					Если ЗначениеЗаполнено(ТекКодОсн)
						...
						СуммаПоГрафе2Раздела51 = СуммаПоГрафе2Раздела51
							+ ВеткаРаздел51.Данные["П000510000102_" + Формат(НомСтр, "ЧГ=")];
					КонецЕсли;
					НомСтр = НомСтр + 1;
				КонецЦикла;
...
Процедура ПроверитьКС_2_7(СтруктураРезультата)
	...
	ОписаниеКС      = НСтр("ru='Показатель, характеризующий особенности добычи нефти Дм в строке 060 Раздела 2.1 должен быть равен произведению: строка 070 х строка 080 х (1 - строка 090 х строка 110 х 1 х строка 115 х строка 120)'");
	...
	Для Каждого СтраницаРаздела Из Раздел2 Цикл
		...
		ВнестиПоказательВРасшифровку(Р2Ст60Гр03, Р2Ст60Гр03.Раздел, НомерСтраницыМнУ(СтраницаРаздела.Представление, Р2Ст60Гр03.ПорядокСтраницы));
		...
		ВнестиПоказательВРасшифровку(Р2Ст90Гр03, Р2Ст90Гр03.Раздел, НомерСтраницыМнУ(СтраницаРаздела.Представление, Р2Ст90Гр03.ПорядокСтраницы));
		ВнестиПоказательВРасшифровку(Р2Ст110Гр03, Р2Ст110Гр03.Раздел, НомерСтраницыМнУ(СтраницаРаздела.Представление, Р2Ст110Гр03.ПорядокСтраницы));
		ВнестиПоказательВРасшифровку(Р2Ст115Гр03, Р2Ст115Гр03.Раздел, НомерСтраницыМнУ(СтраницаРаздела.Представление, Р2Ст115Гр03.ПорядокСтраницы));
		...
		КС = ПоказателиКС(Р2Ст60Гр03.Значение,
			Р2Ст70Гр03.Значение * Р2Ст80Гр03.Значение
			* (1 - Р2Ст90Гр03.Значение * Р2Ст110Гр03.Значение * Р2Ст115Гр03.Значение * Р2Ст120Гр03.Значение));
		Расшифровка = КС.ЛеваяЧастьСтр + " = " + Р2Ст70Гр03.ЗначениеСтр + " * " + Р2Ст80Гр03.ЗначениеСтр + " * " + "(1 - "
			+ Р2Ст90Гр03.ЗначениеСтр + " * " + Р2Ст110Гр03.ЗначениеСтр + " * " + Р2Ст115Гр03.ЗначениеСтр + " * "
			+ Р2Ст120Гр03.ЗначениеСтр + " ) Итог [" + КС.ПраваяЧастьСтр + "]";
...
Процедура ПроверитьКС_6_2(СтруктураРезультата)
	...
	КС = ПоказателиКС(Р6Ст90Гр03.Значение, Р6Ст50Гр03.Значение + Р6Ст60Гр03.Значение + Р6Ст70Гр03.Значение * Р6Ст80Гр03.Значение);
	Расшифровка = КС.ЛеваяЧастьСтр + " = " + Р6Ст50Гр03.ЗначениеСтр + " + " + Р6Ст60Гр03.ЗначениеСтр + " + " + Р6Ст70Гр03.ЗначениеСтр + " * " + Р6Ст80Гр03.ЗначениеСтр + " Итог [" + КС.ПраваяЧастьСтр + "]";
