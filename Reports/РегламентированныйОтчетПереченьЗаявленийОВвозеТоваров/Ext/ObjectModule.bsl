...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     = "Приложение № 1 к приказу ФНС России от 6 апреля 2015 года № ММВ-7-15/139@.";
	НоваяФорма.РедакцияФормы	  = "от 6 апреля 2015 года № ММВ-7-15/139@.";
