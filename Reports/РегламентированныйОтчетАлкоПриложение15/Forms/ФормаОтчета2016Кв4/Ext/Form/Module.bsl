...
&НаКлиенте
Перем СписокПараметровПереходаНаСтраницуРазделаПокаИдетОткрытие Экспорт;
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мИдГруппы22 = "П0000110003";
	
	// Количество строк многострочных разделов по "бумажной" форме отчета,
	// (минимальное количество строк, которое должно присутствовать всегда).
	КолИсхСтрокИдГруппы12 = 1;		
	КолКолонокИдГруппы12 = 6;
	
	КолИсхСтрокИдГруппы22 = 1;		
	КолКолонокИдГруппы22 = 3;
	...
	СтруктураРеквизитовФормы.мСоответствиеИдГруппыРаздел.Вставить(СтруктураРеквизитовФормы.мИдГруппы12, "Декларация");	
	СтруктураРеквизитовФормы.мСоответствиеИдГруппыРаздел.Вставить(СтруктураРеквизитовФормы.мИдГруппы22, "Декларация");
	
	СтруктураРеквизитовФормы.мСоответствиеРазделИдГруппы = Новый Соответствие;
	СтруктураРеквизитовФормы.мСоответствиеРазделИдГруппы.Вставить("Декларация",  СтруктураРеквизитовФормы.мИдГруппы12);	
	
	СтруктураРеквизитовФормы.мСоответствиеИдГруппыРегистр = Новый Соответствие;
	СтруктураРеквизитовФормы.мСоответствиеИдГруппыРегистр.Вставить(СтруктураРеквизитовФормы.мИдГруппы12, "СведенияРеглОтчетАлкоПрил15Поставщики");
	СтруктураРеквизитовФормы.мСоответствиеИдГруппыРегистр.Вставить(СтруктураРеквизитовФормы.мИдГруппы22, "СведенияРеглОтчетАлкоПрил15Производство");
		
	СтруктураРеквизитовФормы.мСоответствиеРегистрИдГруппы = Новый Соответствие;
	СтруктураРеквизитовФормы.мСоответствиеРегистрИдГруппы.Вставить("СведенияРеглОтчетАлкоПрил15Поставщики", СтруктураРеквизитовФормы.мИдГруппы12);	
	СтруктураРеквизитовФормы.мСоответствиеРегистрИдГруппы.Вставить("СведенияРеглОтчетАлкоПрил15Производство", СтруктураРеквизитовФормы.мИдГруппы22);	
	...
	СписокИдГруппРаздела.Добавить(СтруктураРеквизитовФормы.мИдГруппы22, "Произведено");
	...
	РегламентированнаяОтчетностьАЛКО.ИнициализацияНаСервереАЛКО(ЭтаФорма, Параметры.БезОткрытияФормы);
...
// Процедура устанавливается обработчиком действия "ПриАктивизацииСтроки" пока идет открытие страницы раздела,
// накапливая переходы на другие страницы отчета.
// Устанавливается в РегламентированнаяОтчетностьАЛКОКлиент.ВыполнитьПереходНаСтраницуРазделаАЛКО()
// 
&НаКлиенте
Процедура РазделыОтчетаПокаИдетОткрытиеПриАктивизацииСтроки(Элемент) Экспорт
	
	РегламентированнаяОтчетностьАЛКОКлиент.РазделыОтчетаПокаИдетОткрытиеПриАктивизацииСтрокиАЛКО(ЭтаФорма, Элемент);
...
Процедура ОткрытьОтчетНаКлиенте() Экспорт
	...
	РегламентированнаяОтчетностьАЛКОКлиент.ОткрытьОтчетАЛКО(ЭтаФорма);
