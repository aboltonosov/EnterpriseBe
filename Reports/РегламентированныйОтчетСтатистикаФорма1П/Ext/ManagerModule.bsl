...
Функция ДеревоФормИФорматов() Экспорт
	...
	Форма20150101 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "601009", '20160821', "541",	"ФормаОтчета2017Кв1");
	ВерсияВыгрузки = РегламентированнаяОтчетность.ПолучитьВерсиюВыгрузкиСтатОтчета("РегламентированныйОтчетСтатистикаФорма1П", "ФормаОтчета2017Кв1");
...
Функция СформироватьСтруктуруПараметров2017(КонтекстФормы, мСохраненныйДок)
	...
	ДопАтрибуты = РегламентированнаяОтчетность.СформироватьСтруктуруДопАтрибутов("Отчет.РегламентированныйОтчетСтатистикаФорма1П.Форма.ФормаОтчета2017Кв1", "АтрибВыгрузкиXML2017Кв1");
