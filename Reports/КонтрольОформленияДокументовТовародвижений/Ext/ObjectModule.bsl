...
Процедура УстановитьОбязательныеНастройки(ПользовательскиеНастройкиМодифицированы)
	...
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "СтрокаРекомендацияОформитеПоступлениеТоваровИУслуг", НСтр("ru='Оформите поступление товаров и услуг'"));
...
Функция ТекстЗапросаЗакупки()
	...
	|	ВЫБОР
	|		КОГДА ТоварыКОформлениюПоступления.КОформлениюОстаток > 0
	|			ТОГДА &СтрокаРекомендацияОформитеПоступлениеТоваровИУслуг
	|		ИНАЧЕ &СтрокаРекомендацияОформитеПриходныеОрдераНаТовары
	|	КОНЕЦ КАК Рекомендация,
	|	ВЫБОР
	|		КОГДА ТоварыКОформлениюПоступления.КОформлениюОстаток > 0
