...
Процедура ОбновитьНаСервере()
	...
	ОсновнаяИнформация					= ДанныеОКонтракте[6].Выгрузить()[0];
	...
	Если ЭтоКонтрактСЗаказчиком Тогда
		СтоимостныеХарактеристики		= ДанныеОКонтракте[5].Выгрузить()[0];
	КонецЕсли;
	...
	КонтактнаяИнформация = УправлениеКонтактнойИнформацией.КонтактнаяИнформацияОбъектов(ЗаказчикИИсполнитель, , ВидыКИ);
...
Функция ТекстЗапросаПаспортКонтракта() Экспорт
	...
	|
	|////////////////////////////////////////////////////////////////////////////////
	|// Таблица[6] СтоимостныеХарактеристики
	|ВЫБРАТЬ
	|	ОсновнаяИнформацияОКонтракте.Контракт,
	|	ОсновнаяИнформацияОКонтракте.КонтрактПрибыль,
	|	ОсновнаяИнформацияОКонтракте.КонтрактСуммаКонтракта,
	|	СУММА(КалькуляцияЗатрат.Сумма) КАК КонтрактСуммаЗатрат,
	|	СУММА(КалькуляцияЗатрат.СуммаКВозмещению) КАК КонтрактСтоимостьЗапасовЗаСчетСобственныхСредств
	|ИЗ
	|	ОсновнаяИнформацияОКонтракте КАК ОсновнаяИнформацияОКонтракте
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ДоговорыКонтрагентов.КалькуляцияЗатрат КАК КалькуляцияЗатрат
	|		ПО ОсновнаяИнформацияОКонтракте.Контракт = КалькуляцияЗатрат.Ссылка
	|ГДЕ
	|	// Контракт с заказчиком
	|	ОсновнаяИнформацияОКонтракте.ТипДоговора В (
	|		Значение(Перечисление.ТипыДоговоров.СПокупателем),
	|		Значение(Перечисление.ТипыДоговоров.СКомиссионером),
	|		Значение(Перечисление.ТипыДоговоров.СДавальцем))
	|
	...
	|ИЗ
	|	ОсновнаяИнформацияОКонтракте КАК ОсновнаяИнформацияОКонтракте
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ДоговорыМеждуОрганизациями.КалькуляцияЗатрат КАК КалькуляцияЗатрат
	|		ПО ОсновнаяИнформацияОКонтракте.Контракт = КалькуляцияЗатрат.Ссылка
	|ГДЕ
	|	// Контракт интеркампани
	|	ОсновнаяИнформацияОКонтракте.ТипДоговора = Значение(Перечисление.ТипыДоговоровМеждуОрганизациями.КупляПродажа)
	|
	|СГРУППИРОВАТЬ ПО
	|	ОсновнаяИнформацияОКонтракте.Контракт,
	|	ОсновнаяИнформацияОКонтракте.КонтрактПрибыль,
