...
Процедура ОбновитьНаСервере()
	...
	Если ИсполнителиДляКИ.Количество() > 0 Тогда
		...
		КонтактнаяИнформация = УправлениеКонтактнойИнформацией.КонтактнаяИнформацияОбъектов(ИсполнителиДляКИ, , ВидыКИ);
	КонецЕсли;
...
Функция КонтактнаяИнформацияОбъекта(КонтактнаяИнформация, ОбъектКИ, ВидКИ)
	...
	// 4D:ERP для Беларуси, ВладимирР, 27.09.2017 10:30:17 
