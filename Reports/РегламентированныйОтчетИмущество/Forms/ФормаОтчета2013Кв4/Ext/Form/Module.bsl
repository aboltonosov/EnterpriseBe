...
Процедура ВосстановитьСохраненныеДанные()
	...
	Если НЕ СтруктураДанныхТитульный.Свойство("КрупнНплПерешедшийНаНалМониторинг") Тогда
		СтруктураДанныхТитульный.Вставить("КрупнНплПерешедшийНаНалМониторинг", "");
		СтруктураРеквизитовФормы.КрупнейшийНалогоплательщик
			= СтруктураРеквизитовФормы.Организация.КрупнейшийНалогоплательщик;
	Иначе
		Если СтруктураДанныхТитульный.КрупнНплПерешедшийНаНалМониторинг = "X"
			ИЛИ СтруктураДанныхТитульный.КрупнНплПерешедшийНаНалМониторинг = "Х" Тогда// отчет создан в 2.0.
			СтруктураДанныхТитульный.КрупнНплПерешедшийНаНалМониторинг = "V";
		КонецЕсли;
...
Процедура ЗаполнитьСведенияОбОрганизации(Форма, ИзмененаДатаПодписи = Ложь)
	...
	Если НЕ ИзмененаДатаПодписи Тогда
		...
		Форма.СтруктураРеквизитовФормы.КрупнейшийНалогоплательщик
			= Форма.СтруктураРеквизитовФормы.Организация.КрупнейшийНалогоплательщик;
...
Процедура ОбработкаВыбораВПолеТабличногоДокумента(Элемент, Область, СтандартнаяОбработка)
	...
	Если Область.Имя = "КрупнНплПерешедшийНаНалМониторинг" Тогда
...
Процедура УстановитьДоступностьОбластей(Форма, ИмяСтраницыПанели = "")
	...
	Если ИмяСтраницыПанели = "Титульный" Тогда
		...
		Если Форма.ДатаПодписи >= '2016-04-01'
			И Форма.СтруктураРеквизитовФормы.КрупнейшийНалогоплательщик Тогда
...
Функция ПараметрыВыгрузкиОтчета()
	...
	Если ДатаПодписи >= '2016-04-01' И НЕ ЭтоКрупнНплПерешедшийНаНалМониторинг Тогда
