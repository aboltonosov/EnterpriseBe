...
Процедура НалоговаяНагрузка(ПараметрыОтчета, ДанныеУчетнойПолитики, СведенияПредельныхЗначений, 
	...
	Если ТекущаяУчетнаяПолитика.ПлательщикНДС Тогда
		...
		ПериодыОтчетаНДС = Новый Структура("НачалоПериода, КонецПериода", 
			БлижайшийНалоговыйПериод.Начало, БлижайшийНалоговыйПериод.Конец);
...
Функция ПолучитьВыручку(Организация, ПериодыОтчета)
	...
	// 4D:ERP для Беларуси, Екатерина, 14.12.2015 19:07:15 
	// , №10763
	// {
	СчетДт = Новый Массив;
...
Процедура ПолучитьДанныеОтчетаОФинансовыхРезультатах(Организация, ПериодыОтчета, ЧистаяПрибыль, ПрибыльПродаж,
	...
	// , №10763
	// {
	Счет_68_04_1 = ПланыСчетов.Хозрасчетный.НалогНаПрибыль;
	Счет_68_04_2 = ПланыСчетов.Хозрасчетный.НалогНаПрибыль;
	// }
	// 4D
...
Функция ПолучитьСтоимостьАктивов(Организация, ПериодыОтчета)
	...
	// 4D:ERP для Беларуси, Екатерина, 14.12.2015 19:07:52 
	// , №10763
	// {
	СКД1_1.Добавить(ПланыСчетов.Хозрасчетный.НалогНаПрибыль);
	...
	// 4D:ERP для Беларуси, Екатерина, 02.12.2015 11:24:58 
	// , №10675
	// {
	...
	// 4D:ERP для Беларуси, Екатерина, 14.12.2015 19:06:36 
	// , №10763
	// {
	СКД4_2.Добавить(ПланыСчетов.Хозрасчетный.ПрочиеНалогиИСборы);
	СКД4_2.Добавить(ПланыСчетов.Хозрасчетный.НалогНаПрибыль);
	// }
	// 4D
	...
	// 4D:ERP для Беларуси, Екатерина, 14.12.2015 19:05:51 
	// , №10763
	// {
	СКД5_2 = Новый Массив;
	...
	// , №10763
	// {
	СКД6_1.Добавить(ПланыСчетов.Хозрасчетный.НалогНаПрибыль);
	// }
	// 4D
...
Функция ДанныеРасчетаУСН(Параметры)
	...
	СтруктураТаблиц = УчетУСНСервер.ПодготовитьТаблицыНачисленияНалогаУСН(ТаблицаРеквизитов);
