...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для Каждого Регион Из ТаблицаРегионов Цикл
		...
		// {
		Если Регион.КодСубъектаРФ = 0 Тогда
			Регион.Представление = " " + Формат(Регион.КодСубъектаРФ + 1, "ЧЦ=3; ЧН=; ЧВН=; ЧГ=") + ", " + Регион.Представление;
		Иначе
			Регион.Представление = " " + Формат(Регион.КодСубъектаРФ + 1, "ЧЦ=3; ЧН=; ЧВН=; ЧГ=") + ", " + Регион.Представление + " (Российская Федерация)";
		КонецЕсли;
		// }
		// 4D
	КонецЦикла;
	...
	Иначе
		...
		// Адресный и банковский классификаторы, №10377 (2)
		// {
		АктуальнаяВерсия = АдресныйКлассификаторСлужебный_Локализация.ПолучитьИнформациюОВерсииАдресныхСведенийРБ();
		ИнформацияОЗагруженнойВерсииРБ = АдресныйКлассификаторСлужебный_Локализация.ИнформацияОЗагруженнойВерсииАдресныхСведенийРБ();
		Если АктуальнаяВерсия.ДатаВерсии > ИнформацияОЗагруженнойВерсииРБ.ДатаВерсии Тогда
			АдресныйКлассификаторСлужебный_Локализация.ДобавитьДоступныеВерсииАдресныхСведений(ДоступныеВерсии);
		КонецЕсли;
		// }
		// 4D
	...
	// Адресный и банковский классификаторы, №10377 (2)
	// {
	Элементы.ТекстОписанияЗагрузки.РасширеннаяПодсказка.Заголовок =
		"Загрузка адресного классификатора может занять длительное время,
		|которое зависит от количества выбранных регионов.";
	// }
	// 4D
...
Процедура УстановитьУсловноеОформление()
	...
	// Адресный и банковский классификаторы, №10377 (2)
	// {
	АдресныйКлассификаторСервер_Локализация.ВыделитьВСпискеОсновнойРегион(Элементы, УсловноеОформление);
	// }
	// 4D
