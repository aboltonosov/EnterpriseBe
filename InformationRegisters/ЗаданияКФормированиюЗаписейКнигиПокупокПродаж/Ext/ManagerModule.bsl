...
Процедура СформироватьЗаданияПоДокументамСчетФактураПолученный(МассивСсылок)
	...
	|	КорректировкаПоступления.ДокументОснование
	|ИЗ
	|	ВТ_ДокументыОснования КАК ВТ_ДокументыОснования
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаПоступления КАК КорректировкаПоступления
	|		ПО ВТ_ДокументыОснования.СчетФактура = КорректировкаПоступления.Ссылка
	|
	|ОБЪЕДИНИТЬ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|ИЗ
	|	ВТ_ДокументыОснования КАК ВТ_ДокументыОснования
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаПоступления КАК КорректировкаПоступленияОснование
	|		ПО ВТ_ДокументыОснования.СчетФактура = КорректировкаПоступленияОснование.Ссылка
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаПоступления КАК ДругиеКорректировкиОснования
	|		ПО (КорректировкаПоступленияОснование.ДокументОснование = ДругиеКорректировкиОснования.ДокументОснование)
