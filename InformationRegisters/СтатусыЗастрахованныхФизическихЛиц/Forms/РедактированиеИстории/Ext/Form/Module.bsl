...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// 4D:ERP для Беларуси, Юлия, 10.11.2017 18:06:09 
...
Процедура НаборЗаписейПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	...
	Если Элемент.ТекущиеДанные <> Неопределено Тогда
		...
		Если НоваяСтрока Тогда
			...
			// 4D:ERP для Беларуси, Яна, 17.05.2017 12:13:33 
			// Устранение замечаний по справочнику "Физические лица", № 14912 
			// {
			Элемент.ТекущиеДанные.ВидЗастрахованногоЛица = ПредопределенноеЗначение("Перечисление.ВидыЗастрахованныхЛицОбязательногоСтрахования.ГражданеРБ");
			// }
			// 4D
