...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если (НЕ ПустаяСтрока(СтрокаРегистрСведенийЛицензииПоставщиковАлкогольнойПродукции)) 
		...
		ТекстЗапроса = "ВЫБРАТЬ РАЗЛИЧНЫЕ
			...
			|ЛицензииПоставщиковАлкогольнойПродукции." + ИзмерениеПериод + " КАК ДатаВыдачи,
			|ЛицензииПоставщиковАлкогольнойПродукции.ДатаОкончания КАК ДатаОкончания,
			|ЛицензииПоставщиковАлкогольнойПродукции." + ИзмерениеСерияНомер + " КАК СерияНомер,
	...
	ИначеЕсли ПоказатьВыборПоставщиков Тогда
		...
		Если ЗначениеЗаполнено(Запись.Поставщик) Тогда
			...
			Если ДинСписокПоставщика.ОсновнаяТаблица = СтрокаРегистрСведенийЛицензииПоставщиковАлкогольнойПродукции Тогда
				...
				ТекстЗапроса = "ВЫБРАТЬ РАЗЛИЧНЫЕ
					   |	" + ?(ИзмерениеПоставщик = "Владелец", "ЛицензииПоставщиковАлкогольнойПродукции.Ссылка КАК Ссылка,", "") 
						+ "
					   |	ЛицензииПоставщиковАлкогольнойПродукции.ВидЛицензии КАК ВидЛицензии,
					   |	ЛицензииПоставщиковАлкогольнойПродукции." + ИзмерениеПериод + " КАК ДатаНачала,
					   |	ЛицензииПоставщиковАлкогольнойПродукции.ДатаОкончания КАК ДатаОкончания,
					   |	ЛицензииПоставщиковАлкогольнойПродукции.КемВыдана КАК КемВыдана,
					   |    ЛицензииПоставщиковАлкогольнойПродукции." + ИзмерениеСерияНомер + " КАК СерияНомер
		               |ИЗ
		               ...
		               |	ЛицензииПоставщиковАлкогольнойПродукции.ВидЛицензии <> ЗНАЧЕНИЕ("
					   + СтрокаПеречислениеВидыЛицензийНаПродажуАлкоголяПиво + ")
		               |	И ЛицензииПоставщиковАлкогольнойПродукции." + ИзмерениеПоставщик + " = &Поставщик";
