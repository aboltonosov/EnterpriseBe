...
Процедура ЗаполнитьПоказателиПредопределенногоСпособаРасчета()
	...
	УстановитьДоступностьРасчетаБазы(ЭтаФорма, ЕстьПоказательРасчетнаяБаза);
...
Функция УдерживаетсяВЦеломЗаМесяц(Форма)
	Возврат РасчетЗарплатыРасширенныйКлиентСервер.УдержаниеВыполняетсяВЦеломЗаМесяц(Форма.Объект, Форма.ЕстьПоказательРасчетнаяБаза, Форма.ЕстьОперативныеПоказатели, Форма.ЕстьПоказательРасчетнаяБазаСтраховыеВзносы);
КонецФункции  
