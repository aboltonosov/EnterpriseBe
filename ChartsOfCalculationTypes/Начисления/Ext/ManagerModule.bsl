...
Процедура СоздатьНачисленияПоНастройкам(ПараметрыПланаВидовРасчета = Неопределено, НачальноеЗаполнение = Ложь) Экспорт
	...
	// 4D:ERP для Беларуси, Юлия, 24.08.2017 14:39:45 
	// Проверить план видов расчета "Начисление", № 15672
	// { 	
	...
	// 4D:ERP для Беларуси, Петр, 05.12.2017 15:12:11 
	// Создать новые виды начислений и назначений начислений для оплаты больничных листов, №16969
	// Редактировать настройки начислений в плане видов расчета "начисления", № 17489
	// {
	// Больничный
	Если НачальноеЗаполнение Тогда
		Описание = ОписаниеНачисления();
		...
		// Больничный от тарифной ставки
		Описание = ОписаниеНачисления();
		Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаБольничногоЛистаОтТарифногоОклада;
		Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
		Описание.Код					= НСтр("ru = 'БЛНТО'");
		Описание.Наименование			= НСтр("ru = 'Больничный от тарифного оклада'");
		Описание.КраткоеНаименование 	= НСтр("ru = 'Больничный от тариф. ст.'");
		СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание);
		...
		Описание.КодДоходаСтраховыеВзносы2017 = Справочники.ВидыДоходовПоСтраховымВзносам.БольничныйИзФСЗН;
		Описание.ВидНачисленияДляНУ		= Перечисления.ВидыНачисленийОплатыТрудаДляНУ.ПустаяСсылка();
		СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание);
		
		// 4D:ERP для Беларуси, Петр, 05.12.2017 17:08:16 
		// Создать новые виды начислений и назначений начислений для оплаты больничных листов, №16969
		// {
		// Отпуск по беременности и родам от тарифной ставки
		Описание = ОписаниеНачисления();
		Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОтпускПоБеременностиИРодамОтТарифногоОклада;
		Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
		Описание.Код					= НСтр("ru = 'ОТБОТ'");
		Описание.Наименование			= НСтр("ru = 'Отпуск по беременности и родам от тарифной ставки'");
		Описание.КраткоеНаименование 	= НСтр("ru = 'Отп. по берем. от тариф. ст.'");
	...
	// 4D:ERP для Беларуси, Петр, 14.02.2018 9:48:15 
	// Редактировать настройки начислений в плане видов расчета "Начисления", № 17489
	// {
	// Отпуск без оплаты согласно ТК РБ.
	Описание = ОписаниеНачисления();
	...
	Описание.Наименование			= НСтр("ru = 'Отпуск без оплаты согласно статье 189 ТК РБ'");
	Описание.КраткоеНаименование 	= НСтр("ru = 'Отп. без опл. по ст.189'");
	...
	Описание.Наименование			= НСтр("ru = 'Отпуск без оплаты согласно статье 190 ТК РБ'");
	Описание.КраткоеНаименование 	= НСтр("ru = 'Отп. без опл. По ст. 190'");
	...
	Описание.ВидОтпуска 			= ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыОтпусков.ОтпускБезОплаты190ПоТКРБ");
	Описание.КлючевыеСвойства		= "ОбозначениеВТабелеУчетаРабочегоВремени,ВидОтпуска";
	Если НастройкиРасчетаЗарплаты.ИспользоватьОтпускаБезОплаты Тогда
		СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание);
	Иначе
	...
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОтпускБезОплаты;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Наименование			= НСтр("ru = 'Отпуск без оплаты согласно статье 191 ТК РБ'");
	Описание.КраткоеНаименование 	= НСтр("ru = 'Отп. без опл. По ст. 191'");
	...
	Описание.ВидОтпуска 			= ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыОтпусков.ОтпускБезОплаты191ПоТКРБ");
	Описание.КлючевыеСвойства		= "ОбозначениеВТабелеУчетаРабочегоВремени,ВидОтпуска";
	Если НастройкиРасчетаЗарплаты.ИспользоватьОтпускаБезОплаты Тогда
		СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание);
	Иначе
	...
	// 4D:ERP для Беларуси, Петр, 29.01.2018 12:58:11 
	// Редактировать настройки начислений в плане видов расчета "Начисления", № 17489
	// {
	...
	Описание.Наименование			= НСтр("ru = 'Единовременная выплата на оздоровление к отпуску'");
	...
	// 4D:ERP для Беларуси, Петр, 29.01.2018 12:52:33 
	// Редактировать настройки начислений в плане видов расчета "Начисления", № 17489
	// {
	// Оплата пособиея в размере не менее двухнедельного среднего заработка
	Описание = ОписаниеНачисления();
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ВыходноеПособиеЗа2недели;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru = 'ВЫХ2Н'");
	Описание.Наименование			= НСтр("ru = 'Выходное пособие при увольнении за 2 недели'");
	Описание.КраткоеНаименование 	= НСтр("ru = 'Вых. пособие 2 нед.'");
	Описание.ВидНачисленияДляНУ = Перечисления.ВидыНачисленийОплатыТрудаДляНУ.пп10ст255;
	Описание.КодДоходаСтраховыеВзносы = Справочники.ВидыДоходовПоСтраховымВзносам.НеОблагаетсяЦеликом;
	Описание.КодДоходаСтраховыеВзносы2017 = Справочники.ВидыДоходовПоСтраховымВзносам.НеОблагаетсяЦеликом;
	СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание);
	
	// Выходное пособие при увольнении за 3 месяца
	Описание = ОписаниеНачисления();
	Описание.КатегорияНачисленияИлиНеоплаченногоВремени = Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ВыходноеПособиеЗа3Месяца;
	Описание.СвойстваПоКатегории 	= СвойстваНачислений[Описание.КатегорияНачисленияИлиНеоплаченногоВремени];
	Описание.Код					= НСтр("ru = 'ВЫХ3М'");
	Описание.Наименование			= НСтр("ru = 'Выходное пособие при увольнении за 3 месяца'");
	Описание.КраткоеНаименование 	= НСтр("ru = 'Вых. пособие 3 мес.'");
	Описание.ВидНачисленияДляНУ = Перечисления.ВидыНачисленийОплатыТрудаДляНУ.пп10ст255;
	Описание.КодДоходаСтраховыеВзносы = Справочники.ВидыДоходовПоСтраховымВзносам.НеОблагаетсяЦеликом;
	Описание.КодДоходаСтраховыеВзносы2017 = Справочники.ВидыДоходовПоСтраховымВзносам.НеОблагаетсяЦеликом;
	СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание);	
	...
	Если НачальноеЗаполнение Тогда
		...
		// 4D:ERP для Беларуси, Петр, 15.01.2018 17:13:41 
		// Редактирование плана видов расчета "Начисления", № 17167
		// {
		...
		// 4D:ERP для Беларуси, Яна, 20.06.2017 16:34:15 
		// Добавление варианта оплаты отпуска по уходу за ребенком инвалидом до 3-х лет, №15145, 14877  
		// {
		// Безусловно создаем отпуск по уходу за ребенком до 3 лет на ребенка инвалида.
		Описание = ОписаниеНачисления();
		...
		Описание.Наименование			= НСтр("ru = 'Пособие по уходу за ребенком до трех лет на ребенка-инвалида'");
		Описание.КраткоеНаименование 	= НСтр("ru = 'Уход за реб.- инв. до 3 лет'");
		Описание.КодДоходаСтраховыеВзносы = Справочники.ВидыДоходовПоСтраховымВзносам.ПособияИзФСЗН;		
		СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание);	
		
		//Безусловно создаем пособие на ребенка с ВИЧ	
		Описание = ОписаниеНачисления();
		...
		//Безусловно создаем пособие по уходу за ребенком-инвалидом в возрасте до 18 лет
		Описание = ОписаниеНачисления();
		...
		//Безусловно создаем пособие на детей до 3 лет , кроме реб.-ка инв. 	
		Описание = ОписаниеНачисления();
		...
		//Безусловно создаем пособие на детей до 3 лет , на реб.-ка инв. 
		Описание = ОписаниеНачисления();
		...
		//Безусловно создаем пособие на детей от 3 до 18 лет , в пер. восп.-ия реб.-ка до 3 лет 	
		Описание = ОписаниеНачисления();
		...
		// Безусловно создаем отпуск по уходу за ребенком до 3 лет 50 процентов БПМ.
		Описание = ОписаниеНачисления();
		...
		Описание.Наименование			= НСтр("ru = 'Пособие по уходу за ребенком до трех лет 50 процентов бюджета прожиточного минимума'");
		Описание.КраткоеНаименование 	= НСтр("ru = 'Уход за реб. до 3 лет 50 % БПМ'");
		Описание.КодДоходаСтраховыеВзносы = Справочники.ВидыДоходовПоСтраховымВзносам.ПособияИзФСЗН;		
		СоздатьИзменитьНачисленияПоОписанию(КоллекторНачислений, Описание);
		// }
		// 4D
...
// 4D:ERP для Беларуси,Яна, 24.07.2017 14:52:01 
// Ошибка "Метод объекта не обнаружен (доходы по ставке 09)", №15534 
// {
...
Функция СвойстваНачисленийПоКатегориям() Экспорт
	...
	// 4D:ERP для Беларуси, Петр, 15.12.2017 16:50:33 
	// Не сохраняются настройки вида начисления на закладке "Средний заработок", № 17074
	// Редактирование плана видов расчета "Начисления", № 17167
	// {
	// Для некоторых категорий доступен выбор кода 4800 или 2760.
	ДоступныеКоды = Новый Массив;
	ДоступныеКоды.Добавить("2000");
	// 4D:ERP для Беларуси, АлексейЧ, 20.02.2018 12:35:43 
	// Локализовать документ "Начисление зарплаты и взносов", № 15928
	// Добавить в отбор коды дохода 406, 408 и 409 (ставка 9% для ПВТ и Вел. Камень) 
	// Коды 406 и 409 являются аналогами 2000 при вхождении организации в ПВТ или Великий камень.
	// {
	ДоступныеКоды.Добавить("406");	
	ДоступныеКоды.Добавить("408");	
	ДоступныеКоды.Добавить("409");	
	// }
	// 4D
	...
	Описание.ВключатьВСреднийЗаработокОтпуск = Истина;
	Описание.СреднийЗаработокОтпуск = Перечисления.УчетНачисленийВСреднемЗаработкеОтпуск.ОбщийЗаработок;
	Описание.ВключатьВСреднийЗаработокФСС = Истина;
	Описание.СреднийЗаработокФСС = Перечисления.УчетНачисленийВСреднемЗаработкеФСС.ОбщийЗаработок;
	...
	Описание.ВидНачисленияДляНУ = Перечисления.ВидыНачисленийОплатыТрудаДляНУ.пп1ст255;
	Описание.КодДоходаНДФЛ = Справочники.ВидыДоходовНДФЛ.НайтиПоКоду("2000");
	ОбщегоНазначенияКлиентСервер.УдалитьЗначениеИзМассива(Описание.НедоступныеСвойства, "КодДоходаНДФЛ");
	ОбщегоНазначенияКлиентСервер.УдалитьЗначениеИзМассива(Описание.НедоступныеСвойства, "СпособВыполненияНачисления");
	...
	// Коды 406 и 409 являются аналогами 2000 при вхождении организации в ПВТ или Великий камень.
	// {
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("500");	
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("501");	
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("502");	
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("504");	
	//
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("406");	
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("408");	
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("409");	
	// }
	// 4D
	...
	Описание.ВключатьВСреднийЗаработокОтпуск = Ложь;
	Описание.СреднийЗаработокОтпуск = Перечисления.УчетНачисленийВСреднемЗаработкеОтпуск.НеВключать;
	Описание.ВключатьВСреднийЗаработокФСС = Ложь;
	Описание.СреднийЗаработокФСС = Перечисления.УчетНачисленийВСреднемЗаработкеФСС.НеВключать;
	Описание.ВидСтажаСЗВ = Перечисления.ВидыСтажаСЗВ.НеВключаетсяВСтраховойСтаж;
	Описание.ВидСтажаПФР2014 = Перечисления.ВидыСтажаПФР2014.НеВключаетсяВСтраховойСтаж;
	Описание.КодДоходаНДФЛ = Справочники.ВидыДоходовНДФЛ.Код16313;
	Описание.КодДоходаСтраховыеВзносы = Справочники.ВидыДоходовПоСтраховымВзносам.ОблагаетсяЦеликом;
	Описание.КодДоходаСтраховыеВзносы2017 = Справочники.ВидыДоходовПоСтраховымВзносам.ОблагаетсяЦеликом;
	...
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Очистить();
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("2000");
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("16313");	
	// 4D:ERP для Беларуси, АлексейЧ, 20.02.2018 12:35:43 
	// Локализовать документ "Начисление зарплаты и взносов", № 15928
	// Добавить в отбор коды дохода 406, 408 и 409 (ставка 9% для ПВТ и Вел. Камень) 
	// Коды 406 и 409 являются аналогами 2000 при вхождении организации в ПВТ или Великий камень.
	...
	Описание.ВидВремени = Перечисления.ВидыРабочегоВремениСотрудников.ДополнительноОплачиваемоеВПределахНормы;
	Описание.ВключатьВСреднийЗаработокОбщий = Истина;
	Описание.СреднийЗаработокОбщий = Перечисления.УчетНачисленийВСреднемЗаработкеОбщий.ПремияМесячнаяПропорциональноОтработанномуВремени;
	Описание.ВключатьВСреднийЗаработокОтпуск = Истина;
	Описание.СреднийЗаработокОтпуск = Перечисления.УчетНачисленийВСреднемЗаработкеОтпуск.ПремияМесячная;
	Описание.ВключатьВСреднийЗаработокФСС = Истина;
	Описание.СреднийЗаработокФСС = Перечисления.УчетНачисленийВСреднемЗаработкеФСС.ПремияМесячная;
	...
	Описание.ВключатьВФОТ = Истина;
	Описание.СпособРасчета = Перечисления.СпособыРасчетаНачислений.ПроизвольнаяФормула;
	// 4D:ERP для Беларуси, АлексейЧ, 20.02.2018 14:10:04 
	// начисления "Надбавка за работу во вредных", № 17021 
	// {
	//Описание.ФормулаРасчета = "ПроцентНадбавкиЗаВредность / 100 * РасчетнаяБаза";
	Описание.ФормулаРасчета = "БазовыйТарифГруппы * ПроцентНадбавкиЗаВредность * ОтработаноЧасов";
	// }
	// 4D
	Описание.ВидВремени = Перечисления.ВидыРабочегоВремениСотрудников.ДополнительноОплачиваемоеВПределахНормы;
	Описание.ВключатьВСреднийЗаработокОбщий = Истина;
	...
	Описание.СреднийЗаработокФСС = Перечисления.УчетНачисленийВСреднемЗаработкеФСС.ОбщийЗаработок; 
	Описание.ПорядокОпределенияРасчетногоПериодаСреднегоЗаработка = Перечисления.ПорядокОпределенияРасчетногоПериодаСреднегоЗаработка.ПоТрудовомуЗаконодательству;
	Описание.КоличествоМесяцевРасчетаСреднегоЗаработка = 12;
	Описание.КодДоходаНДФЛ = Справочники.ВидыДоходовНДФЛ.НайтиПоКоду("2000");
	Описание.ПараметрыВыбора = ПараметрыВыбораСвойствНачисления();
	...
	Описание.ПорядокОпределенияРасчетногоПериодаСреднегоЗаработка = Перечисления.ПорядокОпределенияРасчетногоПериодаСреднегоЗаработка.ПоТрудовомуЗаконодательству;
	Описание.КодДоходаНДФЛ = Справочники.ВидыДоходовНДФЛ.НайтиПоКоду("2000");
	Описание.ВидНачисленияДляНУ	= Перечисления.ВидыНачисленийОплатыТрудаДляНУ.пп18ст255;
	Описание.ПараметрыВыбора = ПараметрыВыбораСвойствНачисления();
	Описание.ПараметрыВыбора.КодДоходаНДФЛ = ОбщегоНазначенияКлиентСервер.СкопироватьСтруктуру(ПараметрыВыбораНДФЛ);
	Описание.ПараметрыВыбора.ВидОтпуска = Справочники.ВидыОтпусков.ПараметрыВыбораВидаОтпуска();
	ОбщегоНазначенияКлиентСервер.УдалитьЗначениеИзМассива(Описание.НедоступныеСвойства, "КодДоходаНДФЛ");
	...
	Описание.ВидСтажаСЗВ = Перечисления.ВидыСтажаСЗВ.НеВключаетсяВСтраховойСтаж;
	Описание.ВидСтажаПФР2014 = Перечисления.ВидыСтажаПФР2014.НеВключаетсяВСтраховойСтаж;
	Описание.КодДоходаНДФЛ = Справочники.ВидыДоходовНДФЛ.Код500;
	Описание.КодДоходаСтраховыеВзносы = Справочники.ВидыДоходовПоСтраховымВзносам.ОблагаетсяЦеликом;
	Описание.КодДоходаСтраховыеВзносы2017 = Справочники.ВидыДоходовПоСтраховымВзносам.ОблагаетсяЦеликом;
	Описание.ВидНачисленияДляНУ	= Неопределено;
	...
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Очистить();
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("500");
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("500иныеорг");
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("501");
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("502");
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("");
	ДоступныеВидыДоходов = Новый Массив;
	...
	// 4D:ERP для Беларуси, Петр, 28.02.2018 15:52:13 
	// Редактировать настройки начислений в плане видов расчета "Начисления", № 17489
	// {
	Описание.ВключатьВСреднийЗаработокОтпуск = Ложь;
	// }
	...
	Описание.ВидНачисленияДляНУ = Перечисления.ВидыНачисленийОплатыТрудаДляНУ.пп12_1ст255;
	...
	Описание.ПорядокОпределенияРасчетногоПериодаСреднегоЗаработка = Перечисления.ПорядокОпределенияРасчетногоПериодаСреднегоЗаработка.ПоТрудовомуЗаконодательству;
	Описание.КоличествоМесяцевРасчетаСреднегоЗаработка = 2;
	Описание.ВключатьВСреднийЗаработокОбщий = Истина;
	Описание.СреднийЗаработокОбщий = Перечисления.УчетНачисленийВСреднемЗаработкеОбщий.ОбщийЗаработок;
	Описание.ВключатьВСреднийЗаработокОтпуск = Истина;
	Описание.СреднийЗаработокОтпуск = Перечисления.УчетНачисленийВСреднемЗаработкеОтпуск.ОбщийЗаработок;
	...
	// 4D:ERP для Беларуси, Петр, 29.01.2018 12:53:45 
	// Редактировать настройки начислений в плане видов расчета "Начисления", № 17489
	// {
	...
	Описание.СпособРасчета = Перечисления.СпособыРасчетаНачислений.ПроизвольнаяФормула;
	Описание.ФормулаРасчета = "СреднийЗаработокОбщийДвеНедели * ДнейЧасовВыходногоПособия";
	Описание.ВидВремени = Перечисления.ВидыРабочегоВремениСотрудников.ДополнительноОплачиваемоеВПределахНормы;
	Описание.КодДоходаНДФЛ = Неопределено;
	Описание.КодДоходаСтраховыеВзносы = Справочники.ВидыДоходовПоСтраховымВзносам.НеОблагаетсяЦеликом;
	Описание.ПорядокОпределенияРасчетногоПериодаСреднегоЗаработка = Перечисления.ПорядокОпределенияРасчетногоПериодаСреднегоЗаработка.ПоТрудовомуЗаконодательству;
	...
	Описание.ПараметрыВыбора = ПараметрыВыбораСвойствНачисления();
	Описание.ПараметрыВыбора.КодДоходаНДФЛ = ПараметрыВыбораНДФЛ;
	СвойстваПоКатегориям.Вставить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ВыходноеПособиеЗа2недели, Описание);
	...
	Описание.ВидДокументаНачисления = Перечисления.ВидыДокументовНачисления.Увольнение;
	Описание.СпособРасчета = Перечисления.СпособыРасчетаНачислений.ПроизвольнаяФормула;
	Описание.ФормулаРасчета = "СреднийЗаработокОбщийТриМесяца * МесяцевВыходногоПособия";
	Описание.ВидВремени = Перечисления.ВидыРабочегоВремениСотрудников.ДополнительноОплачиваемоеВПределахНормы;
	Описание.КодДоходаНДФЛ = Неопределено;
	Описание.КодДоходаСтраховыеВзносы = Справочники.ВидыДоходовПоСтраховымВзносам.НеОблагаетсяЦеликом;
	Описание.ПорядокОпределенияРасчетногоПериодаСреднегоЗаработка = Перечисления.ПорядокОпределенияРасчетногоПериодаСреднегоЗаработка.ПоТрудовомуЗаконодательству;
	...
	Описание.ПараметрыВыбора = ПараметрыВыбораСвойствНачисления();
	Описание.ПараметрыВыбора.КодДоходаНДФЛ = ПараметрыВыбораНДФЛ;
	СвойстваПоКатегориям.Вставить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ВыходноеПособиеЗа3Месяца, Описание);
	// }
	// 4D
	...
	Описание.СреднийЗаработокФСС = Перечисления.УчетНачисленийВСреднемЗаработкеФСС.ПремияМесячная; 
	Описание.НачисляетсяПриРасчетеПервойПоловиныМесяца = Истина;
	Описание.ВидНачисленияДляНУ = Перечисления.ВидыНачисленийОплатыТрудаДляНУ.пп4ст255;
	Описание.ПоддерживаетНесколькоПлановыхНачислений = Истина;
	Описание.НедоступныеСвойства.Добавить("ВидВремени");
	Описание.НедоступныеСвойства.Добавить("ОбозначениеВТабелеУчетаРабочегоВремени");
	Описание.НедоступныеСвойства.Добавить("ПоддерживаетНесколькоПлановыхНачислений");
	...
	// 4D:ERP для Беларуси, Петр, 05.12.2017 15:18:03 
	// Создать новые виды начислений и назначений начислений для оплаты больничных листов, №16969
	// {
	// Оплата больничного (за счет ФСЗН).
	Описание = СвойстваНачисленияПоКатегорииПоУмолчанию();
	Описание.СпособВыполненияНачисления = Перечисления.СпособыВыполненияНачислений.ПоОтдельномуДокументуДоОкончательногоРасчета;
	...
	Описание.КатегорияСтатистическогоНаблюдения = Неопределено;
	Описание.ПорядокОпределенияРасчетногоПериодаСреднегоЗаработка = Перечисления.ПорядокОпределенияРасчетногоПериодаСреднегоЗаработка.ПоТрудовомуЗаконодательству;
	Описание.КоличествоМесяцевРасчетаСреднегоЗаработка = 6;
	...
	// Оплата больничного от тарифного оклада(за счет ФСЗН).
	Описание = СвойстваНачисленияПоКатегорииПоУмолчанию();
	Описание.СпособВыполненияНачисления = Перечисления.СпособыВыполненияНачислений.ПоОтдельномуДокументуДоОкончательногоРасчета;
	Описание.ВидДокументаНачисления = Перечисления.ВидыДокументовНачисления.БольничныйЛист;
	Описание.СпособРасчета = Перечисления.СпособыРасчетаНачислений.ПроизвольнаяФормула;
	Описание.ФормулаРасчета = "ТарифныйОклад * (ПроцентОплатыПоСреднему/100)* КалендарныеДни / КалендарныеДниМесяца";
	Описание.ВидВремени = Перечисления.ВидыРабочегоВремениСотрудников.ЦелодневноеНеотработанное;
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.Болезнь");
	Описание.ВидПособияСоциальногоСтрахования = Перечисления.ПереченьПособийСоциальногоСтрахования.Нетрудоспособность;
	Описание.КодДоходаНДФЛ = Справочники.ВидыДоходовНДФЛ.НайтиПоКоду("2000");
	...
	Описание.НедоступныеСвойства.Добавить("ВидВремени");
	ДополнитьНедоступныеСвойстваПолямиОтраженияВБухУчете(Описание.НедоступныеСвойства);
	СвойстваПоКатегориям.Вставить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаБольничногоЛистаОтТарифногоОклада, Описание);
	...
	Описание.КодДоходаНДФЛ = Справочники.ВидыДоходовНДФЛ.НайтиПоКоду("16311");
	Описание.КодДоходаСтраховыеВзносы = Справочники.ВидыДоходовПоСтраховымВзносам.БольничныйИзФСЗН;
	Описание.КодДоходаСтраховыеВзносы2017 = Справочники.ВидыДоходовПоСтраховымВзносам.БольничныйИзФСЗН;
	Описание.КатегорияСтатистическогоНаблюдения = Неопределено;
	Описание.ПорядокОпределенияРасчетногоПериодаСреднегоЗаработка = Перечисления.ПорядокОпределенияРасчетногоПериодаСреднегоЗаработка.ПоТрудовомуЗаконодательству;
	...
	// Отпуск по беременности и родам от тарифного оклада.
	Описание = СвойстваНачисленияПоКатегорииПоУмолчанию();
	Описание.СпособВыполненияНачисления = Перечисления.СпособыВыполненияНачислений.ПоОтдельномуДокументуДоОкончательногоРасчета;
	Описание.ВидДокументаНачисления = Перечисления.ВидыДокументовНачисления.БольничныйЛист;
	Описание.СпособРасчета = Перечисления.СпособыРасчетаНачислений.ПроизвольнаяФормула;
	...
	Описание.НедоступныеСвойства.Добавить("ВидВремени");
	ДополнитьНедоступныеСвойстваПолямиОтраженияВБухУчете(Описание.НедоступныеСвойства);
	СвойстваПоКатегориям.Вставить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОтпускПоБеременностиИРодамОтТарифногоОклада, Описание);
	// }
	// 4D
	...
	// 4D:ERP для Беларуси, Петр, 05.12.2017 15:31:54 
	// Создать новые виды начислений и назначений начислений для оплаты больничных листов, №16969
	// {
	...
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("");	
	Описание.КодДоходаСтраховыеВзносы = Справочники.ВидыДоходовПоСтраховымВзносам.ПособияИзФСЗН;
	Описание.КодДоходаСтраховыеВзносы2017 = Справочники.ВидыДоходовПоСтраховымВзносам.ПособияИзФСЗН;
	...
	Описание.ФормулаРасчета = "РазмерПособияПоУходуЗаРебенкомДоТрехЛет*ПроцентПособияДоТрехЛет/100";
	Описание.ВидВремени = Перечисления.ВидыРабочегоВремениСотрудников.ДополнительноОплачиваемоеВПределахНормы;
	Описание.КодДоходаНДФЛ = Неопределено;
	//Описание.КодДоходаСтраховыеВзносы = Справочники.ВидыДоходовПоСтраховымВзносам.НеОблагаетсяЦеликом;
	//Описание.КодДоходаСтраховыеВзносы2017 = Справочники.ВидыДоходовПоСтраховымВзносам.НеОблагаетсяЦеликом;
	...
	// 4D:ERP для Беларуси, Яна, 14.07.2017 09:54:38 
	// Изменения по зарплате 2.1.3.266, № 15399
	// {
	// Пособие до трех лет на второго ребенка 
	Описание = СвойстваНачисленияПоКатегорииПоУмолчанию();
	Описание.СпособВыполненияНачисления = Перечисления.СпособыВыполненияНачислений.ЕжемесячноПриОкончательномРасчете;
	Описание.СпособРасчета = Перечисления.СпособыРасчетаНачислений.ПроизвольнаяФормула;
	Описание.ФормулаРасчета = "РазмерПособияПоУходуЗаРебенкомДоТрехЛетНаВторогоРебенка*ПроцентПособияДоТрехЛетНаВторогоРебенка/100";  
	Описание.ВидВремени = Перечисления.ВидыРабочегоВремениСотрудников.ДополнительноОплачиваемоеВПределахНормы;
	Описание.КодДоходаНДФЛ = Неопределено;
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.ОтпускПоУходуЗаРебенком");
	Описание.ВидСтажаСЗВ = Перечисления.ВидыСтажаСЗВ.ДЛДЕТИ;
	...
	Описание.ПараметрыВыбора.КодДоходаНДФЛ = ОбщегоНазначенияКлиентСервер.СкопироватьСтруктуру(ПараметрыВыбораНДФЛ);
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("2760");
	СвойстваПоКатегориям.Вставить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПособиеПоУходуЗаРебенкомДоТрехЛетНаВторогоРебенка, Описание);
	
	// Пособие до трех лет на второго ребенка 50 процентов БПМ
	Описание = СвойстваНачисленияПоКатегорииПоУмолчанию();
	Описание.СпособВыполненияНачисления = Перечисления.СпособыВыполненияНачислений.ЕжемесячноПриОкончательномРасчете;
	Описание.СпособРасчета = Перечисления.СпособыРасчетаНачислений.ПроизвольнаяФормула;
	Описание.ФормулаРасчета = "РазмерПособияПоУходуЗаРебенкомДоТрехЛет50ПроцентовБПМ";  
	Описание.ВидВремени = Перечисления.ВидыРабочегоВремениСотрудников.ДополнительноОплачиваемоеВПределахНормы;
	Описание.КодДоходаНДФЛ = Неопределено;
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени =Справочники.ВидыИспользованияРабочегоВремени.ПустаяСсылка();
	Описание.ВидСтажаСЗВ = Перечисления.ВидыСтажаСЗВ.ДЛДЕТИ;
	Описание.ВидСтажаПФР2014 = Перечисления.ВидыСтажаПФР2014.ДЛДЕТИ;
	ОбщегоНазначенияКлиентСервер.УдалитьЗначениеИзМассива(Описание.НедоступныеСвойства, "КодДоходаСтраховыеВзносы");
	ОбщегоНазначенияКлиентСервер.УдалитьЗначениеИзМассива(Описание.НедоступныеСвойства, "ВидНачисленияДляНУ");
	...
	ДоступныеВидыНачисленияНУ.Добавить(Перечисления.ВидыНачисленийОплатыТрудаДляНУ.пп25ст255);
	Описание.ПараметрыВыбора.ВидНачисленияДляНУ = Новый Структура("Отбор_Ссылка", ДоступныеВидыНачисленияНУ);
	СвойстваПоКатегориям.Вставить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПособиеПоУходуЗаРебенкомДо3Лет50ПроцентовБПМ, Описание);
	// }
	// 4D
	
	// 4D:ERP для Беларуси, Юлия, 28.08.2017 16:36:15 
	// Проверить план видов расчета "Начисление", № 15672
	// {
	// Пособие по уходу за ребенком до трех на ребенка инвалида
	Описание = СвойстваНачисленияПоКатегорииПоУмолчанию();
	Описание.СпособВыполненияНачисления = Перечисления.СпособыВыполненияНачислений.ЕжемесячноПриОкончательномРасчете;
	Описание.СпособРасчета = Перечисления.СпособыРасчетаНачислений.ПособиеНаРебенкаДо3ЛетНаРебенкаИнвалида;
	Описание.ФормулаРасчета = "ПособиеНаРебенкаДо3ЛетНаРебенкаИнвалида";
	Описание.ВидВремени = Перечисления.ВидыРабочегоВремениСотрудников.ДополнительноОплачиваемоеВПределахНормы;
	Описание.КодДоходаНДФЛ = Неопределено;
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.ОтпускПоУходуЗаРебенком");
	Описание.ВидСтажаСЗВ = Перечисления.ВидыСтажаСЗВ.ДЛДЕТИ;
	...
	Описание.ПараметрыВыбора.КодДоходаНДФЛ = ОбщегоНазначенияКлиентСервер.СкопироватьСтруктуру(ПараметрыВыбораНДФЛ);
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("2760");
	СвойстваПоКатегориям.Вставить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПособиеПоУходуЗаРебенкомДоТрехНаРебенкаИнвалида, Описание);
	
	// Пособие на Вич инфицированного ребенка
	Описание = СвойстваНачисленияПоКатегорииПоУмолчанию();
	Описание.СпособВыполненияНачисления = Перечисления.СпособыВыполненияНачислений.ЕжемесячноПриОкончательномРасчете;
	Описание.СпособРасчета = Перечисления.СпособыРасчетаНачислений.ПособиеНаВичИнфицРебенка;
	Описание.ФормулаРасчета = "ПособиеНаВичИнфицРебенка";  
	Описание.ВидВремени = Перечисления.ВидыРабочегоВремениСотрудников.ДополнительноОплачиваемоеВПределахНормы;
	Описание.КодДоходаНДФЛ = Неопределено;
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.ОтпускПоУходуЗаРебенком");
	Описание.ВидСтажаСЗВ = Перечисления.ВидыСтажаСЗВ.ДЛДЕТИ;
	...
	Описание.ПараметрыВыбора.КодДоходаНДФЛ = ОбщегоНазначенияКлиентСервер.СкопироватьСтруктуру(ПараметрыВыбораНДФЛ);
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("2760");
	СвойстваПоКатегориям.Вставить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПособиеНаВичИнфицРебенка, Описание);
	
	// Пособие на ребенка старше 3 лет кроме ребенка инвалида
	Описание = СвойстваНачисленияПоКатегорииПоУмолчанию();
	Описание.СпособВыполненияНачисления = Перечисления.СпособыВыполненияНачислений.ЕжемесячноПриОкончательномРасчете;
	Описание.СпособРасчета = Перечисления.СпособыРасчетаНачислений.ПособиеНаРебенкаСтарше3ЛетКромеРебенкаИнвалида;
	Описание.ФормулаРасчета = "ПособиеНаРебенкаСтарше3ЛетКромеРебенкаИнвалида";  
	Описание.ВидВремени = Перечисления.ВидыРабочегоВремениСотрудников.ДополнительноОплачиваемоеВПределахНормы;
	Описание.КодДоходаНДФЛ = Неопределено;
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.ОтпускПоУходуЗаРебенком");
	Описание.ВидСтажаСЗВ = Перечисления.ВидыСтажаСЗВ.ДЛДЕТИ;
	...
	Описание.ПараметрыВыбора.КодДоходаНДФЛ = ОбщегоНазначенияКлиентСервер.СкопироватьСтруктуру(ПараметрыВыбораНДФЛ);
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("2760");
	СвойстваПоКатегориям.Вставить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПособиеНаРебенкаСтарше3ЛетКромеРебенкаИнвалида, Описание);
	
	// Пособие на ребенка старше 3 лет на ребенка инвалида
	Описание = СвойстваНачисленияПоКатегорииПоУмолчанию();
	Описание.СпособВыполненияНачисления = Перечисления.СпособыВыполненияНачислений.ЕжемесячноПриОкончательномРасчете;
	Описание.СпособРасчета = Перечисления.СпособыРасчетаНачислений.ПособиеНаРебенкаСтарше3ЛетНаРебенкаИнвалида;
	Описание.ФормулаРасчета = "ПособиеНаРебенкаСтарше3ЛетНаРебенкаИнвалида";  
	Описание.ВидВремени = Перечисления.ВидыРабочегоВремениСотрудников.ДополнительноОплачиваемоеВПределахНормы;
	Описание.КодДоходаНДФЛ = Неопределено;
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.ОтпускПоУходуЗаРебенком");
	Описание.ВидСтажаСЗВ = Перечисления.ВидыСтажаСЗВ.ДЛДЕТИ;
	...
	Описание.ПараметрыВыбора.КодДоходаНДФЛ = ОбщегоНазначенияКлиентСервер.СкопироватьСтруктуру(ПараметрыВыбораНДФЛ);
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("2760");
	СвойстваПоКатегориям.Вставить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПособиеНаРебенкаСтарше3ЛетНаРебенкаИнвалида, Описание);
	
	// Пособие на ребенка старше 3 лет
	Описание = СвойстваНачисленияПоКатегорииПоУмолчанию();
	Описание.СпособВыполненияНачисления = Перечисления.СпособыВыполненияНачислений.ЕжемесячноПриОкончательномРасчете;
	Описание.СпособРасчета = Перечисления.СпособыРасчетаНачислений.ПособиеНаРебенкаСтарше3Лет;
	Описание.ФормулаРасчета = "ПособиеНаРебенкаСтарше3Лет";  
	Описание.ВидВремени = Перечисления.ВидыРабочегоВремениСотрудников.ДополнительноОплачиваемоеВПределахНормы;
	Описание.КодДоходаНДФЛ = Неопределено;
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.ОтпускПоУходуЗаРебенком");
	Описание.ВидСтажаСЗВ = Перечисления.ВидыСтажаСЗВ.ДЛДЕТИ;
	...
	Описание.ПараметрыВыбора.КодДоходаНДФЛ = ОбщегоНазначенияКлиентСервер.СкопироватьСтруктуру(ПараметрыВыбораНДФЛ);
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("2760");
	СвойстваПоКатегориям.Вставить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПособиеНаРебенкаСтарше3Лет, Описание);
	
	// Пособие на ребенка до 3 лет на ребенка инвалида
	Описание = СвойстваНачисленияПоКатегорииПоУмолчанию();
	Описание.СпособВыполненияНачисления = Перечисления.СпособыВыполненияНачислений.ЕжемесячноПриОкончательномРасчете;
	Описание.СпособРасчета = Перечисления.СпособыРасчетаНачислений.ПособиеНаРебенкаДо3ЛетНаРебенкаИнвалида;
	Описание.ФормулаРасчета = "ПособиеНаРебенкаДо3ЛетНаРебенкаИнвалида";  
	...
	Описание.ПараметрыВыбора.КодДоходаНДФЛ = ОбщегоНазначенияКлиентСервер.СкопироватьСтруктуру(ПараметрыВыбораНДФЛ);
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("2760");
	СвойстваПоКатегориям.Вставить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПособиеНаРебенкаДо3ЛетНаРебенкаИнвалида, Описание);
	
	// Пособие на ребенка до 18 лет на ребенка инвалида
	Описание = СвойстваНачисленияПоКатегорииПоУмолчанию();
	Описание.СпособВыполненияНачисления = Перечисления.СпособыВыполненияНачислений.ЕжемесячноПриОкончательномРасчете;
	Описание.СпособРасчета = Перечисления.СпособыРасчетаНачислений.ПособиеНаРебенкаДо18ЛетНаРебенкаИнвалида;
	Описание.ФормулаРасчета = "ПособиеНаРебенкаДо18ЛетНаРебенкаИнвалида";  
	Описание.ВидВремени = Перечисления.ВидыРабочегоВремениСотрудников.ДополнительноОплачиваемоеВПределахНормы;
	Описание.КодДоходаНДФЛ = Неопределено;
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.ОтпускПоУходуЗаРебенком");
	Описание.ВидСтажаСЗВ = Перечисления.ВидыСтажаСЗВ.ДЛДЕТИ;
	...
	Описание.ПараметрыВыбора.КодДоходаНДФЛ = ОбщегоНазначенияКлиентСервер.СкопироватьСтруктуру(ПараметрыВыбораНДФЛ);
	Описание.ПараметрыВыбора.КодДоходаНДФЛ.Отбор_Код.Добавить("");
	СвойстваПоКатегориям.Вставить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПособиеНаРебенкаДо18ЛетНаРебенкаИнвалида, Описание);
	// }
	// 4D 
	
	// 4D:ERP для Беларуси, Юлия, 13.12.2017 9:52:58 
	// Внести изменения в документ "Оплата дней ухода за детьми-инвалидами", № 17078
	// {
	...
	Описание.ВидОперацииПоЗарплате = Перечисления.ВидыОперацийПоЗарплате.ОплатаДнейУходаЗаДетьмиИнвалидами;
	Описание.КодДоходаСтраховыеВзносы = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыДоходовПоСтраховымВзносам.БольничныйИзФСЗН");
	Описание.КодДоходаСтраховыеВзносы2017 = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыДоходовПоСтраховымВзносам.БольничныйИзФСЗН");
	Описание.КатегорияСтатистическогоНаблюдения = Неопределено;
	Описание.ВидСтажаСЗВ = Перечисления.ВидыСтажаСЗВ.ВключаетсяВСтраховойСтаж;
	...
	ДоступныеВидыДоходов.Добавить(Справочники.ВидыДоходовПоСтраховымВзносам.ОблагаетсяЦеликом);
	ДоступныеВидыДоходов.Добавить(Справочники.ВидыДоходовПоСтраховымВзносам.НеОблагаетсяЦеликом);
	ДоступныеВидыДоходов.Добавить(Справочники.ВидыДоходовПоСтраховымВзносам.ПособияИзФСЗН);
	Описание.ПараметрыВыбора.КодДоходаСтраховыеВзносы = Новый Структура("Отбор_Ссылка", ДоступныеВидыДоходов);
	...
	// 4D:ERP для Беларуси, Яна, 24.07.2017 14:54:38 
	// Изменения по зарплате 2.1.3.266, №15399
	// {
	Описание.НедоступныеСвойства.Добавить("ВидВремени");
	Описание.НедоступныеСвойства.Добавить("ОбозначениеВТабелеУчетаРабочегоВремени");
...
// 4D:ERP для Беларуси, Юлия, 10.08.2017 12:22:10 
// Проверить план видов расчета "Начисление", № 15672
// { 

// Функция возвращает массив категорий начислений, которые входят в базу РК и СН.
//
Функция КатегорииБазаРКиСН()
...
Процедура СоздатьНачислениеНадбавкаЗаВредность(КоллекторНачислений = Неопределено, СвойстваНачислений = Неопределено, НастройкиРасчетаЗарплаты = Неопределено) Экспорт
	...
	// 4D:ERP для Беларуси, АлексейЧ, 20.02.2018 14:23:29 
	// начисления "Надбавка за работу во вредных", № 17021
	// {
	Описание.ФормулаРасчета 		= "БазовыйТарифГруппы * ПроцентНадбавкиЗаВредность * ОтработаноЧасов";
	// }
...
Процедура СоздатьНачисленияПремий(КоллекторНачислений, СвойстваНачислений, ПараметрыПланаВидовРасчета)
	...
	Описание.КоличествоМесяцевБазовогоПериода = 1;	
	// 4D:ERP для Беларуси, Яна, 04.08.2017 14:23:29 
...
Процедура СоздатьНачисленияЕжегодногоОтпуска(КоллекторНачислений, КоллекторУдержаний, СвойстваНачислений) 
	...
	// 4D:ERP для Беларуси, Петр, 28.02.2018 12:25:31 
	// Редактировать настройки начислений в плане видов расчета "начисления", № 17489
	// {
	ВидОтпуска 					= ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыОтпусков.ОтпускЗаНенормированныйДень"); 
	НаименованиеОтпуска  		= НСтр("ru = 'Дополнительный отпуск за ненормированный рабочий день'");
	КраткоеНаименование 		= НСтр("ru = 'Доп.отпуск за ненорм. день'");
	СоздаватьКомпенсацию  		= Истина;
	...
	ВидОтпуска 					= ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыОтпусков.ОтпускЗаРаботуСВреднымиУсловиями"); 
	НаименованиеОтпуска  		= НСтр("ru = 'Дополнительный отпуск за работу с вредными условиями труда'");
	КраткоеНаименование 		= НСтр("ru = 'Доп.отпуск за вредн. усл.'");
	СоздаватьКомпенсацию  		= Истина;
...
Процедура СоздатьНачисленияДляУчетаВремениСотрудниковВЧасах(КоллекторНачислений, СвойстваНачислений, НастройкиРасчетаЗарплаты, ПараметрыПланаВидовРасчета)
	...
	// 4D:ERP для Беларуси, Петр, 27.02.2018 12:56:42 
	// Редактировать настройки начислений в плане видов расчета "начисления", № 17489
	// {
...
Процедура СоздатьВнутрисменныеОтклонения(КоллекторНачислений, СвойстваНачислений, НастройкиРасчетаЗарплаты, ПараметрыПланаВидовРасчета)
	...
	// 4D:ERP для Беларуси, Петр, 14.02.2018 9:55:14 
	// Редактировать настройки начислений в плане видов расчета "начисления", № 17489
	// {
	// Отпуск за свой счет
	Описание = ОписаниеНачисления();
	...
	Описание.Наименование			= НСтр("ru = 'Отпуск без оплаты согласно статье 190 ТК РБ (внутрисменный)'");
	Описание.КраткоеНаименование 	= НСтр("ru = 'Отп. без опл. по ст. 190(внсменн)'");
	Описание.ВидВремени 			= Перечисления.ВидыРабочегоВремениСотрудников.ЧасовоеНеотработанное;
	Описание.ОбозначениеВТабелеУчетаРабочегоВремени	= ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.НеоплачиваемыйОтпускПоРазрешениюРаботодателя");
...
Функция СвойстваНачисленияПоКатегорииПоУмолчанию() Экспорт
	...
	// 4D:ERP для Беларуси, Юлия, 10.08.2017 12:37:50 
	// Проверить план видов расчета "Начисление", № 15672
	// Создать новые виды начислений и назначений начислений для оплаты больничных листов, №16969
	// Не сохраняются настройки вида начисления на закладке "Средний заработок", № 17074
	// { 
	...
	|ПараметрыВыбора, 
	|НедоступныеСвойства,
	|СреднийЗаработокОтпуск,
	|СтратегияОтраженияВСреднемЗаработке,           
	|ВключатьВСреднийЗаработокОтпуск,
	...
	НедоступныеСвойстваПоУмолчанию.Добавить("КоличествоМесяцевРасчетаСреднегоЗаработка");
...
Функция ОписаниеНачисления() Экспорт 
	...
	// 4D:ERP для Беларуси, Яна, 14.06.2017 14:40:58 
	// Добавление варианта оплаты отпуска по уходу за ребенком инвалидом до 3-х лет, №15145 
	// Проверить первый запуск, № 15650 
	// Расчет суммы ФОТ в документе перевода, №15834
	// {
	Описание = Новый Структура(
	"Код,
...
Процедура СоздатьИзменитьНачисленияПоОписанию(Коллектор, Описание, ПроверятьНаличиеНачислений = Истина, ОбновлятьНачисленияПоСсылке = Ложь) Экспорт 
	...
	// 4D:ERP для Беларуси, Яна, 14.06.2017 14:45:20 
	// Добавление варианта оплаты отпуска по уходу за ребенком инвалидом до 3-х лет, №15145 
	// {
	//Действие не требуется.
	// }
...
Функция КатегорииВременнойНетрудоспособности()
	...
	// 4D:ERP для Беларуси, Петр, 16.01.2018 15:11:58 
	// Создать новые виды начислений и назначений начислений для оплаты больничных листов, № 16969
	// {
	Категории.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаБольничногоЛистаОтТарифногоОклада);
	Категории.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОтпускПоБеременностиИРодамОтТарифногоОклада);
	// }
	// 4D
...
Функция КатегорииОплатыБольничного() Экспорт
	...
	// 4D:ERP для Беларуси, Петр, 16.01.2018 15:13:03 
	// Создать новые виды начислений и назначений начислений для оплаты больничных листов, № 16969
	// {
	Категории.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаБольничногоЛистаОтТарифногоОклада);
	// }
...
Функция КатегорииПособийПоУходуЗаРебенком() Экспорт
	...
	// 4D:ERP для Беларуси, Яна, 20.06.2017 16:30:13 
	// Документ "Отпуск по уходу за ребенком", № 14900, 14877,15145  
	// {
	Категории.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПособиеПоУходуЗаРебенкомДоТрехЛетНаВторогоРебенка);  	
	Категории.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПособиеПоУходуЗаРебенкомДо3Лет50ПроцентовБПМ); 		
	Категории.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПособиеПоУходуЗаРебенкомДоТрехНаРебенкаИнвалида);
	Категории.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПособиеНаВичИнфицРебенка);
	Категории.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПособиеНаРебенкаДо18ЛетНаРебенкаИнвалида);
	Категории.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПособиеНаРебенкаСтарше3ЛетКромеРебенкаИнвалида);
	Категории.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПособиеНаРебенкаСтарше3ЛетНаРебенкаИнвалида);
	Категории.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПособиеНаРебенкаСтарше3Лет);
	Категории.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ПособиеНаРебенкаДо3ЛетНаРебенкаИнвалида);	
	// }
	// 4D
...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.1.2.237";
	Обработчик.Процедура = "ПланыВидовРасчета.Начисления.ЗаполнитьПоказетелиНачисленияОтпускаПострадавшимВАварииЧАЭС";
	Обработчик.РежимВыполнения = ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.ОсновнойРежимВыполненияОбновления();
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("7b2e483c-670e-4945-a8a4-e6103b8af703");
...
Процедура ИзменитьКодДоходаСтраховыеВзносыДляПособияПоУходуЗаРебенкомДоПолутораЛет() Экспорт 
	...
	Запрос.УстановитьПараметр("КодДоходаСтраховыеВзносы", Справочники.ВидыДоходовПоСтраховымВзносам.ПособияИзФСЗН);
	...
	Пока Выборка.Следующий() Цикл 
		...
		НачислениеОбъект = Выборка.Ссылка.ПолучитьОбъект();
		НачислениеОбъект.КодДоходаСтраховыеВзносы = Справочники.ВидыДоходовПоСтраховымВзносам.ПособияИзФСЗН;
		НачислениеОбъект.ОбменДанными.Загрузка = Истина;
		НачислениеОбъект.Записать();
...
Процедура ЗаполнитьВидыВремениВидовРасчета() Экспорт
	...
	// - для всех начислений, у которых заполнено ОбозначениеВТабелеУчетаРабочегоВремени - добавляем единственную строчку с этим видом времени,
	// - для начислений, в формулах которых используется ОтработаноЧасовВПределахНормыВремени
	// * заменяем показатель на ВремяВЧасах
	// * если ОбозначениеВТабелеУчетаРабочегоВремени - ничего не делаем
	// * если что-то другое, то дополняем таблицу видов времени еще и всеми ночными и всеми вечерними часами (сейчас так работает показатль ОтработаноЧасовВПределахНормыВремени)
...
Процедура ЗаполнитьПоказетелиНачисленияОтпускаПострадавшимВАварииЧАЭС(ПараметрыОбновления = Неопределено) Экспорт
	...
	ПоказательКалендарныеДни = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ПоказателиРасчетаЗарплаты.КалендарныеДни");
	
	Запрос = Новый Запрос;
	Запрос.УстановитьПараметр("ВидОтпуска", ВидОтпуска);
	Запрос.УстановитьПараметр("ПоказательКалендарныеДни", ПоказательКалендарныеДни);
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	Начисления.Ссылка КАК Ссылка
	|ИЗ
	...
	|			И (НачисленияПоказатели.Показатель = &ПоказательКалендарныеДни)
	|ГДЕ
	...
	Пока Выборка.Следующий() Цикл
		...
		СтрокаПоказателя.Показатель = ПоказательКалендарныеДни;
...
// 4D:ERP для Беларуси, Яна, 06.07.2017 12:54:38 
// Ошибка - "Поле объекта не обнаружено (имя таблицы), № 15324 
// {
Функция КатегорииОтпуска() Экспорт
...
Функция КатегорииКомандировки() Экспорт
...
Функция КатегорииНеявокДляБольничных() Экспорт
